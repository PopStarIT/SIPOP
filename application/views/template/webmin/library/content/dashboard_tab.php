						...
						foreach($dashboard_tab as $tab) { 
							...
							if(isset($tab['content'])){
								...
								foreach($tab['content'] as $tab_content){
									...
									if(!isset($tab_content['menu_tile'])){
										$tab_content['menu_tile']='tile-primary';
							          }
									...
									if($permision){
										if (!isset($tab_content['menu_bg'])) {
                                            $tab_content['menu_bg'] = 'bg-success';
                                        }
									...
									// echo "<div class=\"col-xl-3 col-lg-6 col-md-6 \">";
                                    // echo "<div class=\"card title3 " . $tab_content['menu_bg'] . " \" >";
                                    // echo "<a href=\"javascript:add_tab(" . $tab_content['method_id'] . ", '" . $tab_content['menu_name'] . "' , '" . $data_method[$tab_content['method_id']]['link'] . "','" . $tab_content['menu_icon'] . "');\" >";
                                    // echo "<div class=\"card-body\">";
                                    // echo "<div class=\"card-body-icon\">";
                                    // echo "<i class=\"" . $tab_content['menu_icon'] . "\"></i>";
                                    // echo "</div>";
                                    // echo "<h5 class=\"card-title2\">" . $tab_content['menu_name'] . "</h5>";
                                    // echo "</div>";
                                    // echo "</a>";
                                    // echo "</div>";
                                    // echo "</div>";
									...
									//	echo "<div class=\"col-xl-3 col-lg-6 col-md-6\">";	
									//	//echo "<div class=\"col-xl-2 col-lg-8 col-md-8\">";	
									//	echo "<a href=\"javascript:add_tab(". $tab_content['method_id'] .", '". $tab_content['menu_name'] ."' , '". $data_method[$tab_content['method_id']]['link'] ."','". $tab_content['menu_icon'] ."');\" class=\"tile tile-primary tile-valign\">";	
									//	//echo "<a href=\"javascript:add_tab(". $tab_content['method_id'] .", '". $tab_content['menu_name'] ."' , '". $data_method[$tab_content['method_id']]['link'] ."','". $tab_content['menu_icon'] ."');\" class=\"tile ".$tab_content['menu_tile']." tile-valign\">";	
									//	echo "<span class=\"". $tab_content['menu_icon'] ."\"></span>";	
									//	echo "<div class=\"informer informer-default\">". $tab_content['menu_name'] ."</div>";	
									//	echo "<div class=\"informer informer-default dir-br\">". $tab_content['menu_name'] ."</div>";	
									//	echo "</a>";	
