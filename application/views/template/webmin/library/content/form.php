...
?>
			  ...
			  //alert(baseurl+'loader');
				$.ajax({
					...
					success: function(data) {
						...
						//		 var targetId = "<?php echo $form_param ?>";
						//		// var $el = $("#<?php //echo $form_id . "_" . $form_param ?>");
						//			
						//		if (targetId === "mdl_shipment_code" ) {
						//		  $(newOption).attr('data-harga', data[key].fabric_shipment_detail_id);
						//		}
		...
		case 'file_photo_edit':
		?>
			<div class="form-group">
				<?php if ($form_label) { ?>
					<label for="<?php echo $form_param ?>" class="label_<?php echo $form_id . "_" . $form_param ?>"><?php echo $form_label ?></label>
				<?php } ?>
				<input class="form-control <?php echo $form_param ?>" id="<?php echo $form_id ?>_<?php echo $form_param ?>" name="<?php echo $form_param ?>" type="file" onchange="pictureadd_edit()" accept="image/x-png,image/gif,image/jpeg" />
		...
		?>
			<div class="form-group">
				<?php if ($form_label) { ?>
					<label for="<?php echo $form_param ?>" class="label_<?php echo $form_id . "_" . $form_param ?>"><?php echo $form_label ?></label>
				<?php } ?>
				<input class="form-control <?php echo $form_param ?>" id="<?php echo $form_id ?>_<?php echo $form_param ?>" name="<?php echo $form_param ?>" type="file" onchange="picture_trims_1()" accept="image/x-png,image/gif,image/jpeg" />
		...
		?>
			<div class="form-group">
				<?php if ($form_label) { ?>
					<label for="<?php echo $form_param ?>" class="label_<?php echo $form_id . "_" . $form_param ?>"><?php echo $form_label ?></label>
				<?php } ?>
				<input class="form-control <?php echo $form_param ?>" id="<?php echo $form_id ?>_<?php echo $form_param ?>" name="<?php echo $form_param ?>" type="file" onchange="picture_trims_2()" accept="image/x-png,image/gif,image/jpeg" />
				...
				$(document).ready(function() {
					...
					$.ajax({
						...
						success: function(data) {
							...
							$("#<?php echo $form_id . "_" . $form_param ?>").selectpicker({
								liveSearch: true
							}).ajaxSelectPicker(options_<?php echo $form_id . "_" . $form_param ?>);
						}
					});
				});
		...
		?>
			<div class="form-group">
				...
				<div class="input-group">
					...
					<input class="form-control <?php echo $form_param ?>" id="<?php echo $form_id ?>_<?php echo $form_param ?>" name="<?php echo $form_param ?>" type="text" value="<?php echo $form_value ?>" />
				</div>
			</div>
		...
		?>
			<div class="form-group">
				<?php if ($form_label) { ?>
					<label for="<?php echo $form_param ?>" class="label_<?php echo $form_id . "_" . $form_param ?>"><?php echo $form_label ?></label>
				<?php } ?>
				<input class="form-control <?php echo $form_param ?>" id="<?php echo $form_id ?>_<?php echo $form_param ?>" name="<?php echo $form_param ?>" type="number" placeholder="<?php echo $form_label ?>" value="<?php echo $form_value ?>" />
		...
		case 'select_pop_custom':
		?>
			<div class="form-group form-inline row" style="margin-bottom:2px">
				<label for="<?php echo $form_param ?>" class="col-form-label label_<?php echo $form_id . "_" . $form_param ?>"><?php echo $form_label ?></label>
				<div class="col-sm-<?php echo $form_param_key_2 ?>">
					<select class="form-control" id="<?php echo $form_id . "_" . $form_param ?>" name="<?php echo $form_param ?>" style="width:300px;">
					</select>
				</div>
			</div>
		...
		?>
			...
			<script type="text/javascript">
				...
				function change_<?php echo $form_id . "_" . $form_param ?>(param_id) {
					//	alert("sfdh");
					//alert(param_id);
					//console.log(<?php echo $form_id . "_" . $form_param ?>);
					// print_r(param_id)
					//alert("<?php echo $form_param ?>");
					//	alert('<?php echo $form_param_key_1 ?>');
					$.ajax({
						...
						method: 'post',
						success: function(data) {
							console.log('<?php echo $form_param ?>');
							//alert("<?php echo $form_param ?>");
							if (data) {
								$.each(data, function(key, value) {
									//alert(key);
