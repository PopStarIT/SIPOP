			...
			<?php if(isset($dashboard_table['nav_button'])) { ?>
				...
				//		}
				          ...
				          foreach($dashboard_table['nav_button'] as $dt_nav_button) {
							...
							//==================== Untuk membuat button notifikasi tambahan =============
				              echo "<button type=\"button\" class=\"btn btn-default mb-1\" onclick=\"savexxxxx_<?php echo $methodid ?>()\">";
							  echo "<i class=\"fa fa-bell\"><input id=\"button_notif\" style=\"background-color: red; width:20px; height:20px; border-radius:100%; text-align: center; border-color: red; font:6px; font-weight: bold;\" value=\"4\" readonly></i> ";
							  echo"</button>";
							  
							  // echo "<a class=\"nav-link top-nav\" data-toggle=\"dropdown\" href=\"#\" role=\"button\" aria-haspopup=\"true\" aria-expanded=\"false\"><i class=\"ti-bell\"></i><span class=\"badge badge-danger notification-status\">3 </span></a>";
