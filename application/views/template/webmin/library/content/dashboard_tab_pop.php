					...
					foreach ($dashboard_tab as $tab) {
						...
						if (isset($tab['content'])) {
							...
							foreach ($tab['content'] as $tab_content) {
								...
								// 	echo "<a href=\"javascript:add_tab(". $tab_content['method_id'] .", '". $tab_content['menu_name'] ."' , '". $data_method[$tab_content['method_id']]['link'] ."','". $tab_content['menu_icon'] ."');\" class=\"tile tile-success tile-valign\">";	
								// 	//disini adanya background icon -primary
								...
								if ($permision) {
									echo "<div class=\"col-xl-2 col-lg-8 col-md-8\" style=\"display: flex; justify-content: center; align-items: center; flex-direction: column;\">";

									echo "<a href=\"javascript:add_tab(" . $tab_content['method_id'] . ", '" . $tab_content['menu_name'] . "' , '" . $data_method[$tab_content['method_id']]['link'] . "','" . $tab_content['menu_icon'] . "');\" class=\"tile tile- tile-valign\" style=\"display: flex; justify-content: center; align-items: center; border: none; width: 50px; height: 50px; box-shadow: 0 10px 10px rgba(0, 0, 0, 0.2); color: white;background-color:#4682B4;\">";
