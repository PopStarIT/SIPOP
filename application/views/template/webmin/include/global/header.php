<!-- <nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row main-navbar">  -->
 <nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row main-navbar">
	...
	<div class="text-left navbar-brand-wrapper">
		<a class="navbar-brand brand-logo" href="<?php echo base_url() ?>"><img src="<?php echo BASEDIR . "assets/" . $path_template ."/" ?>images/logo-dark.png" alt="" ></a>
	...
	<ul class="nav navbar-nav mr-auto">
		...
		<!-- <li style="margin:auto;padding-left:50px;color:#000;">
		...
		<li class="nav-item dropdown mr-30">
			...
			<a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
			   ...
			   if ($username=='administrator'){
				?>
				 <img src="<?php echo BASEDIR ."assets/". $path_template ."/" ?>images/img_admin.jpg" alt="avatar">
			   <?php
			   }else{
				?>
