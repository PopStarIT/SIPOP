...
<body onload='window.print();'>
 ...
 //  $link='./'.$_GET['link'];
   ...
   <?php 
	...
	<br />
	 <table border="1"  height="450px" class="table1" width="100%">
		<tr>
		<td width="220px" class="depan">
		<center>
		<img src=<?php echo site_url('./assets/img/id_card/bg/logo_4.png'); ?>  alt='Avatar' alt='' >
		<br />
		<br />
		<br />
		<img src=<?php echo site_url($link); ?> width='110px' height='140px' alt='' style='border: 2px solid black;border-radius:5%;'> 
		</center>
		</td>
		
		<td  width="230px" class="belakang">
		 <div class="container">
