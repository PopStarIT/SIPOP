...
<body>
   <div class="container2">
     <div class="gambardepan_coba" id='gbr_depan'>
	 <!--	 <img id="rotasigambarid_cobaxx" src=<?php //echo site_url('assets/img/id_card/bg/depan/karyawan_depan.png'); ?> width='215px' height='325px' alt='' > -->
	     <div class='satu' id='satu' >
	      <img id="rotasigambarid_coba" src=<?php echo site_url('assets/img/id_card/patrick.png'); ?> width='108px' height='120px' alt='' style='border: 2px solid grey;border-radius:50%;position: absolute; margin-top:20%; margin-left:25%;'> 
		  </div>
	    </div>
		
	<div class="gambarbelakang" id='gambarbelakang'>
	 <!--	 <img id="rotasigambarid_cobaxx" src=<?php //echo site_url('assets/img/id_card/bg/depan/karyawan_depan.png'); ?> width='215px' height='325px' alt='' > -->
