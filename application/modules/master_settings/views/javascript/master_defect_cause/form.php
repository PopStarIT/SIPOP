    ...
    function edit_<?php echo $methodid ?>(id) {
        ...
        $.ajax({
            ...
            data: {
                ...
                param: 'data_master_defect_cause',
                param_pop: 'db_pop',
                id: id
            },
            dataType: 'json',
            ...
            success: function(data) {
                ...
                if (data && data.length > 0) {
                    ...
                    $('#form_<?php echo $methodid ?>_defect_cause').val(data[0].defect_cause);
                    $('#form_<?php echo $methodid ?>_defect_cause_related').val(data[0].defect_cause_related);
                    $('#form_<?php echo $methodid ?>_color').val(data[0].color);
        ...
        if (check_submit == 0) {
            swal({
                ...
                if (result.value) {
                    ...
                    page_loading("show", 'Delete Master Defect Cause', 'Please Wait...');
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            check_submit = 0;
                            if (data.valid) {
                                show_success("show", 'Delete Master Defect Cause', data.message);
        ...
        if (check_submit == 0) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    check_submit = 0;
                    if (data.valid) {
                        show_success("show", '<?php echo 'Master Defect Cause' ?>', data.message, function() {
                            // location.reload();
                            clearDetailFormOut();
                        });
                    } else {
