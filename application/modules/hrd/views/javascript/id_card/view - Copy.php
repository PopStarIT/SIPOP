<script type="text/javascript">  
      ...
      var idsOfSelectedRows_<?php echo $methodid ?>_id_card = [],updateIdsOfSelectedRows_<?php echo $methodid ?>_id_card = function(id, isSelected) {
			//alert(id);
	...
	//	 //alert(valueSelected);
	//	  $.ajax({
	//			url: baseurl +'<?php echo $class_uri ?>/template_idcard',
	//			data: data_send,
	//			dataType: 'json',
	//			method: 'post',
