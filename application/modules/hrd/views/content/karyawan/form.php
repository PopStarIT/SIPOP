<div class="row">
	<div class="col-xl-12">     
												...
												<div class="row">
													...
													<div class="col-xl-12">
														...
														//echo base_url();
												 				...
												 				?>
														<!--<img src="<?php // base_url('assets/img/profile/default.jpeg'); ?>" alt="" height="170px" width="150px" class="rouded-circle img-thumbnail mt-2 gbrphoto"  id="gambar">-->
		...
		//$this->ecc_library->form('select','Order Type',"form_".$methodid,'purchase_order_type_id','','','purchase_order_type_purchase');
                                                     $this->ecc_library->form('text','NIP (Nomor Induk Pegawai)',"form_".$methodid,'nik','','','');
