 ...
 //  $link='./'.$_GET['link'];
   ...
   <div class="container2">
     <div class="gambardepan">
	   <div class='satu'>
	      <img id="rotasigambarid" src=<?php echo site_url($link); ?> width='108px' height='120px' alt='' style='border: 2px solid grey;border-radius:50%;position: absolute; margin-top:20%; margin-left:25%;'> 
	    </div>
	   <div class='depan_barcode'>
	    		<center>
		               <!--  <img alt='testing' src=<?php //echo site_url('./assets/barcode.php?codetype=code128&size=30&text='.$nik.'&print=true ') ?> /> -->
			 <img alt='testing' src=<?php echo site_url('./assets/barcode.php?codetype=code128&size=30&text='.$nik) ?> /> 
		               </center>
	   </div>
	   <div class='depan_text1'>
	    ...
	    <div class='depan_text1_dept'>
		  ...
		  <p class="depan_text1_lain"> <?php echo strtoupper($divisi);?></p>
	   </div>
	   <div class='depan_text1_nik'>
		 <p class="depan_text1_nama"> NIK </p>
		 <p class="depan_text1_titik1" > :</p>
		 <p class="depan_text1_lain" ><?php echo strtoupper($nik);?></p>
	   </div>
	 </div>
	  ...
	  <div class="gambarbelakang">
		 ...
		 <div class='belakang2'>
		  ...
		  <p style="margin:2px;">2. Kartu pengenal ini milik PT.POPSTAR. Jika ditemukan, mohon dikembalikan ke alamat yang tercantum dibawah ini.</p>
		   <p style="margin:2px;color:red;text-align:left;wid">This ID Card belongs to PT.POPSTAR. if found please return to the address indecated below.</p>
