											   ...
											   <div class="col-xl-3 col-lg-6 col-md-6">
												...
												<div class="att att-absen dir-att" id="ket_<?php echo $methodid ?>_P3"><?php echo $jumlah_P3 ?></div>
											     ...
											     <div class="col-xl-12 col-lg-12 col-md-12">
										           <a href="javascript:add_tab('781057','Report','<?php echo $data_method['781057']['link'] ?>','fa fa-file-text')" class="tile tile-info tile-valign" >
...
<script type="text/javascript">
 ...
 // sementara di komentar dahulu karena belum 	
