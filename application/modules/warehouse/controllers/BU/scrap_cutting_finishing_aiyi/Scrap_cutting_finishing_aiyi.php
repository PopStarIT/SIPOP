...
Class Scrap_cutting_finishing_aiyi extends CI_Controller { 
	...
	function work_order_scrap_table() {
		$view = 'view_work_order_scrap_cutting_finishing';
	...
	function index(){
		...
		$component['view_load'] = 'scrap_cutting_finishing_aiyi/view';
		$component['view_load_form'] = 'scrap_cutting_finishing_aiyi/form';
		$component['load_js'][] = 'scrap_cutting_finishing_aiyi/view';
		$component['load_js'][] = 'scrap_cutting_finishing_aiyi/form';
		
		$component['page_title'] = "Scrap Cutting Finishing";
		
		$dashboard_table = array();
		
		$nav_button = array();
		$nav_button[] = array('method_id' => 50389,'title' => 'Add', 'icon' => 'fa fa-plus', 'load' => 'scrap_cutting_finishing_aiyi/function_add');
		$nav_button[] = array('method_id' => 50390,'title' => 'Edit', 'icon' => 'fa fa-pencil', 'load' => 'scrap_cutting_finishing_aiyi/function_edit');
		$nav_button[] = array('method_id' => 50408,'title' => 'Supply', 'icon' => 'fa fa-pencil', 'load' => 'scrap_cutting_finishing_aiyi/function_supply');
		$nav_button[] = array('method_id' => 50393,'title' => 'Approve', 'icon' => 'fa fa-pencil', 'load' => 'scrap_cutting_finishing_aiyi/function_approve');
		$nav_button[] = array('method_id' => 50392,'title' => 'Delete', 'icon' => 'fa fa-trash-o', 'load' => 'scrap_cutting_finishing_aiyi/function_delete');
		$nav_button[] = array('method_id' => 50399,'title' => 'Print', 'icon' => 'fa fa-print', 'load' => 'scrap_cutting_finishing_aiyi/function_print');
		$nav_button[] = array('method_id' => 50400,'title' => 'Cancel Approve', 'icon' => 'fa fa-pencil', 'load' => 'scrap_cutting_finishing_aiyi/function_cancel_approve');
	...
	function post_add_edit(){
		...
		if(count($_POST) > 0){
			if($work_order_scrap_id){
				...
				$this->rpc_service->setSP("dbo.sp_work_order_scrap_cutting_finishing_add");
			}
	...
	function post_add_edit_detail(){
		...
		if(count($_POST) > 0){
			if($work_order_scrap_detail_id){
				...
				$this->rpc_service->setSP("dbo.sp_work_order_scrap_cutting_finishing_detail_add");
			}
	...
	function loaddata_material(){
		...
		if($work_order_scrap_detail_id){
			...
			$this->rpc_service_portal->addField('work_order_scrap_detail_id',$work_order_scrap_detail_id);	
		} else {
			$sp = "dbo.sp_stock_move_item_scrap_cutting_finishing";	
			$this->rpc_service_portal->setSP($sp);
		}
		
		$this->rpc_service_portal->addField('work_order_scrap_date',$work_order_scrap_date);
