...
Class Production_cutting_aiyi extends CI_Controller { 
	...
	function work_order_production_table() {
		$view = 'view_work_order_production_cutting';
	...
	function index(){
		...
		$component['view_load'] = 'production_cutting_aiyi/view';
		$component['view_load_form'] = 'production_cutting_aiyi/form';
		$component['load_js'][] = 'production_cutting_aiyi/view';
		$component['load_js'][] = 'production_cutting_aiyi/form';
		
		$component['page_title'] = "Production Cutting";
		
		$dashboard_table = array();
		
		$nav_button = array();
		$nav_button[] = array('method_id' => 50323,'title' => 'Add', 'icon' => 'fa fa-plus', 'load' => 'production_cutting_aiyi/function_add');
		$nav_button[] = array('method_id' => 50324,'title' => 'Edit', 'icon' => 'fa fa-pencil', 'load' => 'production_cutting_aiyi/function_edit');
		$nav_button[] = array('method_id' => 50342,'title' => 'Supply', 'icon' => 'fa fa-pencil', 'load' => 'production_cutting_aiyi/function_supply');
		$nav_button[] = array('method_id' => 50327,'title' => 'Approve', 'icon' => 'fa fa-pencil', 'load' => 'production_cutting_aiyi/function_approve');
		$nav_button[] = array('method_id' => 50326,'title' => 'Delete', 'icon' => 'fa fa-trash-o', 'load' => 'production_cutting_aiyi/function_delete');
		$nav_button[] = array('method_id' => 50333,'title' => 'Print', 'icon' => 'fa fa-print', 'load' => 'production_cutting_aiyi/function_print');
		$nav_button[] = array('method_id' => 50334,'title' => 'Cancel Approve', 'icon' => 'fa fa-pencil', 'load' => 'production_cutting_aiyi/function_cancel_approve');
	...
	function approve(){
		...
		if(count($_POST) > 0){
			...
			if($work_order_production_id){
				$this->rpc_service->setSP("dbo.sp_work_order_production_cutting_approve");
	...
	function post_add_edit(){
		...
		if(count($_POST) > 0){
			if($work_order_production_id){
				...
				$this->rpc_service->setSP("dbo.sp_work_order_production_cutting_add");
			}
	...
	function post_add_edit_detail(){
		...
		if(count($_POST) > 0){
			if($work_order_production_detail_id){
				...
				$this->rpc_service->setSP("dbo.sp_work_order_production_cutting_detail_add");
			}
	...
	function loaddata_material(){
		...
		if($work_order_production_detail_id){
			$sp = "dbo.sp_stock_move_item_production_cutting_detail";	
			...
			$sp = "dbo.sp_stock_move_item_production_cutting";	
			$this->rpc_service_portal->setSP($sp);
		}
	...
	function loaddata_transfer_item(){
		...
		$view = 'view_stock_move_item_production_cutting2';
