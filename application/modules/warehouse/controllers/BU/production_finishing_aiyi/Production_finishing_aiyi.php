...
Class Production_finishing_aiyi extends CI_Controller { 
	...
	function work_order_production_table() {
		$view = 'view_work_order_production_finishing';
	...
	function index(){
		...
		$component['view_load'] = 'production_finishing_aiyi/view';
		$component['view_load_form'] = 'production_finishing_aiyi/form';
		$component['load_js'][] = 'production_finishing_aiyi/view';
		$component['load_js'][] = 'production_finishing_aiyi/form';
		
		$component['page_title'] = "Production Finishing";
		
		$dashboard_table = array();
		
		$nav_button = array();
		$nav_button[] = array('method_id' => 50345,'title' => 'Add', 'icon' => 'fa fa-plus', 'load' => 'production_finishing_aiyi/function_add');
		$nav_button[] = array('method_id' => 50346,'title' => 'Edit', 'icon' => 'fa fa-pencil', 'load' => 'production_finishing_aiyi/function_edit');
		$nav_button[] = array('method_id' => 50364,'title' => 'Supply', 'icon' => 'fa fa-pencil', 'load' => 'production_finishing_aiyi/function_supply');
		$nav_button[] = array('method_id' => 50349,'title' => 'Approve', 'icon' => 'fa fa-pencil', 'load' => 'production_finishing_aiyi/function_approve');
		$nav_button[] = array('method_id' => 50348,'title' => 'Delete', 'icon' => 'fa fa-trash-o', 'load' => 'production_finishing_aiyi/function_delete');
		$nav_button[] = array('method_id' => 50355,'title' => 'Print', 'icon' => 'fa fa-print', 'load' => 'production_finishing_aiyi/function_print');
		$nav_button[] = array('method_id' => 50356,'title' => 'Cancel Approve', 'icon' => 'fa fa-pencil', 'load' => 'production_finishing_aiyi/function_cancel_approve');
	...
	function approve(){
		...
		if(count($_POST) > 0){
			...
			if($work_order_production_id){
				$this->rpc_service->setSP("dbo.sp_work_order_production_finishing_approve");
	...
	function post_add_edit(){
		...
		if(count($_POST) > 0){
			if($work_order_production_id){
				...
				$this->rpc_service->setSP("dbo.sp_work_order_production_finishing_add");
			}
	...
	function post_add_edit_detail(){
		...
		if(count($_POST) > 0){
			if($work_order_production_detail_id){
				...
				$this->rpc_service->setSP("dbo.sp_work_order_production_finishing_detail_add");
			}
	...
	function loaddata_material(){
		...
		if($work_order_production_detail_id){
			$sp = "dbo.sp_stock_move_item_production_finishing_detail";	
			...
			$sp = "dbo.sp_stock_move_item_production_finishing";	
			$this->rpc_service_portal->setSP($sp);
		}
	...
	function loaddata_transfer_item(){
		...
		$view = 'view_stock_move_item_production_finishing2';
