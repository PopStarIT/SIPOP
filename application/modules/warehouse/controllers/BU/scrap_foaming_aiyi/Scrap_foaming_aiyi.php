...
Class Scrap_foaming_aiyi extends CI_Controller { 
	...
	function work_order_scrap_table() {
		$view = 'view_work_order_scrap_foaming';
		...
		$get_field['r3']['title'] = 'Scrap Foaming No';
		$get_field['r4']['title'] = 'Scrap Foaming Date';
		$get_field['r5']['title'] = 'Plan No';
		$get_field['r6']['title'] = 'Plan Date';
		$get_field['r7']['title'] = 'Scrap Foaming Status';
		return $get_field;
	}
	...
	function index(){
		...
		$component['view_load'] = 'scrap_foaming_aiyi/view';
		$component['view_load_form'] = 'scrap_foaming_aiyi/form';
		$component['load_js'][] = 'scrap_foaming_aiyi/view';
		$component['load_js'][] = 'scrap_foaming_aiyi/form';
		
		$component['page_title'] = "Scrap Foaming";
		
		$dashboard_table = array();
		
		$nav_button = array();
		$nav_button[] = array('method_id' => 50367,'title' => 'Add', 'icon' => 'fa fa-plus', 'load' => 'scrap_foaming_aiyi/function_add');
		$nav_button[] = array('method_id' => 50368,'title' => 'Edit', 'icon' => 'fa fa-pencil', 'load' => 'scrap_foaming_aiyi/function_edit');
		$nav_button[] = array('method_id' => 50386,'title' => 'Supply', 'icon' => 'fa fa-pencil', 'load' => 'scrap_foaming_aiyi/function_supply');
		$nav_button[] = array('method_id' => 50371,'title' => 'Approve', 'icon' => 'fa fa-pencil', 'load' => 'scrap_foaming_aiyi/function_approve');
		$nav_button[] = array('method_id' => 50370,'title' => 'Delete', 'icon' => 'fa fa-trash-o', 'load' => 'scrap_foaming_aiyi/function_delete');
		$nav_button[] = array('method_id' => 50377,'title' => 'Print', 'icon' => 'fa fa-print', 'load' => 'scrap_foaming_aiyi/function_print');
		$nav_button[] = array('method_id' => 50378,'title' => 'Cancel Approve', 'icon' => 'fa fa-pencil', 'load' => 'scrap_foaming_aiyi/function_cancel_approve');
