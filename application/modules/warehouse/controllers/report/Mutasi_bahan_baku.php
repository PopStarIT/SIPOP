...
Class Mutasi_bahan_baku extends CI_Controller { 
	...
	function index(){
		...
		$component['view_load'] = 'report/mutasi_bahan_baku/view';
		$component['load_js'][] = 'report/mutasi_bahan_baku/view';
		
		$component['page_title'] = "Mutasi Bahan Baku dan Bahan Penolong Warehouse 1";
