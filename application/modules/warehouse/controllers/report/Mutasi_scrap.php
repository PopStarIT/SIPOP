...
Class Mutasi_scrap extends CI_Controller { 
	...
	function index(){
		...
		$component['view_load'] = 'report/mutasi_scrap/view';
		$component['load_js'][] = 'report/mutasi_scrap/view';
		
		$component['page_title'] = "Mutasi Scrap Warehouse";
		$dashboard_table = array();
		
		
		$field = $this->mutasi_scrap_table();
	...
	function loaddata(){
		...
		$sp = "dbo.sp_rpt_mutasi_scrap_warehouse";		
		if($print == 1){
