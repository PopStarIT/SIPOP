									...
									<div class="card">
										...
										<div class="tab-content">
											...
											<div class="tab-pane fade" id="content_<?php echo $methodid; ?>_incoming" role="tabpanel" aria-labelledby="tab_<?php echo $methodid; ?>_incoming">
											 ...
											 <div class="tab-pane fade" id="content_<?php echo $methodid; ?>_fixed_asset" role="tabpanel" aria-labelledby="tab_<?php echo $methodid; ?>_fixed_asset">
												<div class="row">
												   <div class="col-xl-12">
													  <form class="ui grid ecc_form" id="form_<?php echo $methodid ?>_fixed_asset">
														 <div class="form-group">
															<div class="col-xl-12">
															   <?php 	
																  $this->ecc_library->form('select','Fixed Asset :',"form_".$methodid,'item_id_fixed_asset','','','get_item_fixed_asset');	
															   ?>
															</div>
														 </div>  
													  </form>
													  <button type="button" class="btn btn-default" onclick="javascript:print_<?php echo $methodid ?>_fixed_asset('xlsx');">
														<i class="fa fa-search"></i> Print Xlsx
													  </button>
												   </div>
												</div>
												...
												<div class="row mb-10 ml-10">
													<div class="col-xl-12">
														<?php 
															$extra_field = array();
															$extra_field[] = array('field' => 'item_id','form_id' => 'form_'. $methodid .'_item_id_fixed_asset');
															$extra_param = array('methodid'=> $methodid,'footer_data'=> true,'extra_param' => $extra_field);
															$this->ecc_library->jqgrid($methodid."_fixed_asset", $dashboard_table['field_fixed_asset'], $dashboard_table['field_fixed_asset_loaddata'],$extra_param); 
														?>
													</div>
												</div>
											 </div>
