								...
								<div class="col-xl-12 mb-10 ml-10">
									<form class="ui grid ecc_form" id="form_<?php echo $methodid ?>" action="javascript:post_<?php echo $methodid ?>()">
										...
										<div class="row">
											<div class="col-xl-6">
												<?php 
													$this->ecc_library->form('text','Request Foaming No',"form_".$methodid,'request_no','','','');
													$this->ecc_library->form('date','Request Foaming Date',"form_".$methodid,'request_date','','','');	
							...
							<div class="row">
								<div class="col-xl-12">
								  <div class="col-xl-12 d-flex justify-content-end">
							           <button type="button" class="btn btn-warning" onclick="javascript:modal_cek_stock_<?php echo $methodid ?>()">
								        <i class="fa fa-list"></i>Cek stock
								      </button>
								      </div> 
												...
												<div class="row">
													<div class="col-xl-4">
														<?php
															...
															$this->ecc_library->form('hidden','',"form_".$methodid."_detail",'request_no','','','');
...
<div class="tab_custom_ecc modal fade" id="modal_cek_stock"  role="dialog" aria-labelledby="exampleModalLabel">
    <div class="modal-dialog modal-lg" role="document">
       <div class="modal-content">
	      <div class="modal-header">
	        <h5 class="modal-title" id="exampleModalLabel">.:: Cek Data Stock</h5>
		  ...
		  <div class="col-xl-12">
			...
			<div class="col-xl-4">
			  <?php
			    $this->ecc_library->form('hidden', 'req_no', "form_" . $methodid."_cek_stock", 'request_no', '');
				$this->ecc_library->form('hidden', 'req_id', "form_" . $methodid."_cek_stock", 'request_id', '');
				$this->ecc_library->form('hidden', 'req_detail_id', "form_" . $methodid."_cek_stock", 'request_detail_id', '');
				$this->ecc_library->form('hidden', 'date_start', "form_" . $methodid."_cek_stock", 'date_start', '');
				$this->ecc_library->form('hidden', 'date_end', "form_"  . $methodid."_cek_stock", 'date_end', '');
			  ?>
			</div>
		   </div>
		   ...
		   <div class="col-xl-12 mb-30">
		   	<div class="col-xl-12 table-responsive">
		    	<table id="table_<?php echo $methodid ?>_cek_stock"></table>
				<div id="ptable_<?php echo $methodid ?>_cek_stock"></div>
		   	</div>
		   </div>
		  </div>
	   </div>
