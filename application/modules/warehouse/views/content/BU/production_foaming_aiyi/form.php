												...
												<div class="row">
													<div class="col-xl-12">
														<?php
															...
															$this->ecc_library->form('hidden','',"form_".$methodid."_detail",'work_order_production_date','','','');
															$this->ecc_library->form('hidden','',"form_".$methodid."_detail",'work_order_production_detail_id','','','');
															$this->ecc_library->form('select','Finish Good / Semi Finish Good',"form_".$methodid,'item_id','','','manufacture_item');	
														?>
													</div>
													<div class="col-xl-12">
														<?php
