					...
					<div class="tab-content">
								...
								<div class="col-xl-12 mb-10 ml-10">
									<form class="ui grid ecc_form" id="form_<?php echo $methodid ?>" action="javascript:post_<?php echo $methodid ?>()">
										<?php 
											...
											$this->ecc_library->form('hidden','',"form_".$methodid,'incoming_id','');
										?>
										
										<div class="row">
											<div class="col-xl-6">
												<?php 
													$this->ecc_library->form('text','Outgoing Injection No',"form_".$methodid,'incoming_no','','','');
													$this->ecc_library->form('date','Outgoing Injection Date',"form_".$methodid,'incoming_date','','','');													
												?>
											</div>
						...
						<div class="tab_custom_ecc tab-pane fade" id="content_<?php echo $methodid; ?>_detail" role="tabpanel" aria-labelledby="tab_<?php echo $methodid; ?>_detail">
												...
												<div class="row">
													<div class="col-xl-4">
														<?php
															...
															$this->ecc_library->form('hidden','',"form_".$methodid."_detail",'incoming_id','','','');
															$this->ecc_library->form('hidden','',"form_".$methodid."_detail",'incoming_detail_id','','','');
															$this->ecc_library->form('hidden','',"form_".$methodid."_detail",'incoming_index','','','');
													...
													<div class="col-xl-4 ">
														<?php
															$this->ecc_library->form('text','Qty Outgoing',"form_".$methodid."_detail",'quantity_incoming','','','');
														?>
													</div>
							...
							<div class="row">
								<div class="col-xl-12">
									<?php 
										$extra_param = array('methodid'=> $methodid,'extra_param' => array(0 => array('field' => 'incoming_id','form_id' => 'form_'. $methodid .'_detail_incoming_id')));
							...
							<div class="row panel_<?php echo $methodid ?>_panel_supply">
								<div class="col-xl-12">
									<div class="row">
										<div class="col-xl-6">
											<?php 
												$this->ecc_library->form('readonly','incoming No',"form_".$methodid."_supply",'incoming_no','','','');
												$this->ecc_library->form('readonly','incoming Date',"form_".$methodid."_supply",'incoming_date','','','');
											?>
										</div>
									...
									<div class="row">
										<div class="col-xl-12 mb-30">
											...
											<div class="row">
												<div class="col-xl-12">
													<?php 
														$extra_param = array('methodid'=> $methodid,'onclick'=> 'click_transfer_'.$methodid,'extra_param' => array(0 => array('field' => 'incoming_id','form_id' => 'form_'. $methodid .'_supply_incoming_id')));
										...
										<div class="col-xl-8 mb-30">
											...
											<div class="row">
												<div class="col-xl-12">
													<?php 
														$extra_field = array();
														$extra_field[] = array('field' => 'incoming_detail_id','form_id' => 'form_'. $methodid .'_supply_incoming_detail_id');
														$extra_field[] = array('field' => 'incoming_supply_id','form_id' => 'form_'. $methodid .'incoming_supply_id');
										...
										<div class="col-xl-4 mb-30">
											<form class="ui grid ecc_form" id="form_<?php echo $methodid ?>_supply" action="javascript:post_<?php echo $methodid ?>_supply()">
												<?php 
													...
													$this->ecc_library->form('hidden','',"form_".$methodid."_supply",'incoming_id','');
													$this->ecc_library->form('hidden','',"form_".$methodid."_supply",'stock_move_id','');
													$this->ecc_library->form('hidden','',"form_".$methodid."_supply",'incoming_detail_id','');
													$this->ecc_library->form('hidden','',"form_".$methodid."_supply",'incoming_supply_id','');
