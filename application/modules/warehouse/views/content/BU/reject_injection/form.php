					...
					<div class="tab-content">
								...
								<div class="col-xl-12 mb-10 ml-10">
									<form class="ui grid ecc_form" id="form_<?php echo $methodid ?>" action="javascript:post_<?php echo $methodid ?>()">
										<?php 
											...
											$this->ecc_library->form('hidden','',"form_".$methodid,'reject_injection_id','');
										?>
										
										<div class="row">
											<div class="col-xl-6">
												<?php 
													$this->ecc_library->form('text','Reject Injection No',"form_".$methodid,'reject_injection_no','','','');
													$this->ecc_library->form('date','Reject Injection Date',"form_".$methodid,'reject_injection_date','','','');													
												?>
											</div>
											
											<div class="col-xl-5">
												<?php 
													$this->ecc_library->form('text','Reject Injection Info',"form_".$methodid,'reject_injection_info','','','');
												?>
											</div>
						...
						<div class="tab_custom_ecc tab-pane fade" id="content_<?php echo $methodid; ?>_detail" role="tabpanel" aria-labelledby="tab_<?php echo $methodid; ?>_detail">
												...
												<div class="row">
													<div class="col-xl-4">
														<?php
															...
															$this->ecc_library->form('hidden','',"form_".$methodid."_detail",'reject_injection_id','','','');
															$this->ecc_library->form('hidden','',"form_".$methodid."_detail",'reject_injection_detail_id','','','');
															$this->ecc_library->form('hidden','',"form_".$methodid."_detail",'reject_injection_index','','','');
													...
													<div class="col-xl-4 ">
														<?php
															$this->ecc_library->form('text','Qty Reject Injection',"form_".$methodid."_detail",'quantity_reject_injection','','','');
														?>
													</div>
													
													<div class="col-xl-4">
														<?php
															$this->ecc_library->form('select','Reject Injection Item',"form_".$methodid."_detail",'reject_injection_item_id','','','item_reject');
														?>
													</div>
												</div>
											</div>
							...
							<div class="row">
								<div class="col-xl-12">
									<?php 
										$extra_param = array('methodid'=> $methodid,'extra_param' => array(0 => array('field' => 'reject_injection_id','form_id' => 'form_'. $methodid .'_detail_reject_injection_id')));
							...
							<div class="row panel_<?php echo $methodid ?>_panel_supply">
								<div class="col-xl-12">
									<div class="row">
										<div class="col-xl-6">
											<?php 
												$this->ecc_library->form('readonly','Reject Injection No',"form_".$methodid."_supply",'reject_injection_no','','','');
												$this->ecc_library->form('readonly','Reject Injection Date',"form_".$methodid."_supply",'reject_injection_date','','','');
										...
										<div class="col-xl-6">
											<?php 
												$this->ecc_library->form('readonly','Reject Injection Info',"form_".$methodid."_supply",'reject_injection_info','','','');
											?>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-xl-12 mb-30">
											...
											<div class="row">
												<div class="col-xl-12">
													<?php 
														$extra_param = array('methodid'=> $methodid,'onclick'=> 'click_transfer_'.$methodid,'extra_param' => array(0 => array('field' => 'reject_injection_id','form_id' => 'form_'. $methodid .'_supply_reject_injection_id')));
										...
										<div class="col-xl-8 mb-30">
											...
											<div class="row">
												<div class="col-xl-12">
													<?php 
														$extra_field = array();
														$extra_field[] = array('field' => 'reject_injection_detail_id','form_id' => 'form_'. $methodid .'_supply_reject_injection_detail_id');
														$extra_field[] = array('field' => 'reject_injection_supply_id','form_id' => 'form_'. $methodid .'reject_injection_supply_id');
										...
										<div class="col-xl-4 mb-30">
											<form class="ui grid ecc_form" id="form_<?php echo $methodid ?>_supply" action="javascript:post_<?php echo $methodid ?>_supply()">
												<?php 
													...
													$this->ecc_library->form('hidden','',"form_".$methodid."_supply",'reject_injection_id','');
													$this->ecc_library->form('hidden','',"form_".$methodid."_supply",'stock_move_id','');
													$this->ecc_library->form('hidden','',"form_".$methodid."_supply",'reject_injection_detail_id','');
													$this->ecc_library->form('hidden','',"form_".$methodid."_supply",'reject_injection_supply_id','');
