								...
								<div class="col-xl-12 mb-10 ml-10">
									<form class="ui grid ecc_form" id="form_<?php echo $methodid ?>" action="javascript:post_<?php echo $methodid ?>()">
										...
										<div class="row">
											<div class="col-xl-6">
												<?php 
													$this->ecc_library->form('text','Outgoing Assembly No',"form_".$methodid,'incoming_no','','','');
													$this->ecc_library->form('date','Outgoing Assembly Date',"form_".$methodid,'incoming_date','','','');													
												?>
											</div>
