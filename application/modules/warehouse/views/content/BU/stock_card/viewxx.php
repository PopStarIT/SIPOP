										...
										<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
											...
											<div class="col-xl-20">
														<div class="input_header_<?php echo $methodid ?> input_header_<?php echo $methodid ?>_10">
															<?php $this->ecc_library->form('select','Item :',"form_".$methodid,'item_id_incoming','','','get_item_detail'); ?>
														</div>
													</div>
												<form class="form-inline" id="form_<?php echo $methodid ?>">
													<div class="form-group">
														...
														<div class="input-group">
															...
															<input class="form-control" id="form_<?php echo $methodid ?>_date_start"  name="date_start" type="text" value="<?php echo date("Y-m-d", strtotime( date( "Y-m-d", strtotime( date("Y-m-d") ) ) . "-1 day" ) ) ?>" />
														</div>
