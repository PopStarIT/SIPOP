								...
								<div class="col-xl-12 mb-10 ml-10">
									<form class="ui grid ecc_form" id="form_<?php echo $methodid ?>" action="javascript:post_<?php echo $methodid ?>()">
										<?php 
											...
											$this->ecc_library->form('hidden','',"form_".$methodid,'stock_adjusment_assembly_id','');
										?>
										
										<div class="row">
											<div class="col-xl-6">
												<?php 
													$this->ecc_library->form('text','Stock Adjusment assembly No',"form_".$methodid,'stock_adjusment_assembly_no','','','');
													$this->ecc_library->form('date','Stock Adjusment assembly Date',"form_".$methodid,'stock_adjusment_assembly_date','','','');
											...
											<div class="col-xl-6">
												<?php 
													$this->ecc_library->form('text','Stock Adjusment assembly Memo',"form_".$methodid,'stock_adjusment_assembly_memo','','','');
												?>
											</div>
						...
						<div class="tab_custom_ecc tab-pane fade" id="content_<?php echo $methodid; ?>_detail" role="tabpanel" aria-labelledby="tab_<?php echo $methodid; ?>_detail">
												...
												<div class="row">
													<div class="col-xl-6">
														<?php
															...
															$this->ecc_library->form('hidden','',"form_".$methodid."_detail",'stock_adjusment_assembly_id','','','');
															$this->ecc_library->form('hidden','',"form_".$methodid."_detail",'stock_adjusment_assembly_date','','','');
														?>
													</div>
												</div>
											</div>
							...
							<div class="row">
								<div class="col-xl-12">
									<h3>List Detail</h3>
									<?php 
										$extra_param = array('methodid'=> $methodid,'extra_param' => array(0 => array('field' => 'stock_adjusment_assembly_id','form_id' => 'form_'. $methodid .'_detail_stock_adjusment_assembly_id')));
