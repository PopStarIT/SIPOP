					...
					<div class="tab-content">
								...
								<div class="col-xl-12 mb-10 ml-10">
									<form class="ui grid ecc_form" id="form_<?php echo $methodid ?>" action="javascript:post_<?php echo $methodid ?>()">
										<?php 
											...
											$this->ecc_library->form('hidden','',"form_".$methodid,'reject_assembly_id','');
										?>
										
										<div class="row">
											<div class="col-xl-6">
												<?php 
													$this->ecc_library->form('text','Reject Assembly No',"form_".$methodid,'reject_assembly_no','','','');
													$this->ecc_library->form('date','Reject Assembly Date',"form_".$methodid,'reject_assembly_date','','','');													
												?>
											</div>
											
											<div class="col-xl-5">
												<?php 
													$this->ecc_library->form('text','Reject Assembly Info',"form_".$methodid,'reject_assembly_info','','','');
												?>
											</div>
						...
						<div class="tab_custom_ecc tab-pane fade" id="content_<?php echo $methodid; ?>_detail" role="tabpanel" aria-labelledby="tab_<?php echo $methodid; ?>_detail">
												...
												<div class="row">
													<div class="col-xl-4">
														<?php
															...
															$this->ecc_library->form('hidden','',"form_".$methodid."_detail",'reject_assembly_id','','','');
															$this->ecc_library->form('hidden','',"form_".$methodid."_detail",'reject_assembly_detail_id','','','');
															$this->ecc_library->form('hidden','',"form_".$methodid."_detail",'reject_assembly_index','','','');
													...
													<div class="col-xl-4 ">
														<?php
															$this->ecc_library->form('text','Qty Reject Assembly',"form_".$methodid."_detail",'quantity_reject_assembly','','','');
														?>
													</div>
													
													<div class="col-xl-4">
														<?php
															$this->ecc_library->form('select','Reject Assembly Item',"form_".$methodid."_detail",'reject_assembly_item_id','','','item_reject');
														?>
													</div>
												</div>
											</div>
							...
							<div class="row">
								<div class="col-xl-12">
									<?php 
										$extra_param = array('methodid'=> $methodid,'extra_param' => array(0 => array('field' => 'reject_assembly_id','form_id' => 'form_'. $methodid .'_detail_reject_assembly_id')));
							...
							<div class="row panel_<?php echo $methodid ?>_panel_supply">
								<div class="col-xl-12">
									<div class="row">
										<div class="col-xl-6">
											<?php 
												$this->ecc_library->form('readonly','Reject Assembly No',"form_".$methodid."_supply",'reject_assembly_no','','','');
												$this->ecc_library->form('readonly','Reject Assembly Date',"form_".$methodid."_supply",'reject_assembly_date','','','');
										...
										<div class="col-xl-6">
											<?php 
												$this->ecc_library->form('readonly','Reject Assembly Info',"form_".$methodid."_supply",'reject_assembly_info','','','');
											?>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-xl-12 mb-30">
											...
											<div class="row">
												<div class="col-xl-12">
													<?php 
														$extra_param = array('methodid'=> $methodid,'onclick'=> 'click_transfer_'.$methodid,'extra_param' => array(0 => array('field' => 'reject_assembly_id','form_id' => 'form_'. $methodid .'_supply_reject_assembly_id')));
										...
										<div class="col-xl-8 mb-30">
											...
											<div class="row">
												<div class="col-xl-12">
													<?php 
														$extra_field = array();
														$extra_field[] = array('field' => 'reject_assembly_detail_id','form_id' => 'form_'. $methodid .'_supply_reject_assembly_detail_id');
														$extra_field[] = array('field' => 'reject_assembly_supply_id','form_id' => 'form_'. $methodid .'reject_assembly_supply_id');
										...
										<div class="col-xl-4 mb-30">
											<form class="ui grid ecc_form" id="form_<?php echo $methodid ?>_supply" action="javascript:post_<?php echo $methodid ?>_supply()">
												<?php 
													...
													$this->ecc_library->form('hidden','',"form_".$methodid."_supply",'reject_assembly_id','');
													$this->ecc_library->form('hidden','',"form_".$methodid."_supply",'stock_move_id','');
													$this->ecc_library->form('hidden','',"form_".$methodid."_supply",'reject_assembly_detail_id','');
													$this->ecc_library->form('hidden','',"form_".$methodid."_supply",'reject_assembly_supply_id','');
