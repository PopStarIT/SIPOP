											...
											<div class="card-body">
												<form class="form-inline" id="form_<?php echo $methodid ?>">
													<div class="form-group">
														<label for="inputPassword6">Periode :   </label>
														<div class="input-group">
															<div class="input-group-prepend">
																<span class="input-group-text"><i class="fa fa-calendar"></i></span>
															</div>
															<input class="form-control" id="form_<?php echo $methodid ?>_date_start"  name="date_start" type="text" value="<?php echo date("Y-m-d", strtotime( date( "Y-m-d", strtotime( date("Y-m-d") ) ) . "-1 week" ) ) ?>" />
														</div>
														...
														&nbsp &nbsp
														<button type="button" class="btn btn-default" id="btn_<?php echo $methodid ?>_print_xls">
															<i class="fa fa-print"></i> Print Excelx
														</button>
													</div>									
												</form>
											</div>
