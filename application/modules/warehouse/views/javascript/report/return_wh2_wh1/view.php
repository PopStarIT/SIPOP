	...
	$(function () {
        ...
        $("#table_<?php echo $methodid ?>").jqGrid({
			...
			colModel:[
				...
				{name:'r3',index:'r3', width:120,align:'center'},  
				{name:'r4',index:'r4', width:200}, 
				...
				{name:'r7',index:'r7', width:150,align:'right',formatter:'formatNumerics'},
				...
				//{name:'r9',index:'r9', width:100,align:'center'},  
