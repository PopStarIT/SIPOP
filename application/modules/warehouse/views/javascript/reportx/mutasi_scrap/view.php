<script type="text/javascript">  
	$(function () {
        ...
        $("#table_<?php echo $methodid ?>").jqGrid({
			...
			, 'SAT'
			, 'SALDO AWAL FOAMING'
			, 'SALDO AWAL CUTTING-FINISHING'
			, 'PEMASUKAN FOAMING'
			, 'PEMASUKAN CUTTING-FINISHING'
			, 'PENGELUARAN FOAMING'
			, 'PENGELUARAN CUTTING-FINISHING'
			, 'ADJUSMENT FOAMING'
			, 'ADJUSMENT CUTTING-FINISHING'
			, 'SALDO AKHIR FOAMING'
			, 'SALDO AKHIR CUTTING-FINISHING'
			, 'STOCK OPNAME FOAMING'
			, 'STOCK OPNAME CUTTING-FINISHING'
			, 'SELISIH FOAMING'
			, 'SELISIH CUTTING-FINISHING'
			, 'KETERANGAN SO FOAMING'
			, 'KETERANGAN SO CUTTING-FINISHING'],
			colModel:[
