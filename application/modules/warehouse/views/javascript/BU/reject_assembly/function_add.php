<script type="text/javascript">  
	function nav_button_<?php echo $function ?>(){
		...
		$('#form_<?php echo $methodid ?>_reject_assembly_id').val('');
		getnexttransno(71, 'form_<?php echo $methodid ?>_reject_assembly_no');
		$('#form_<?php echo $methodid ?>_reject_assembly_date').val('<?php echo date('Y-m-d') ?>');
		$('#form_<?php echo $methodid ?>_reject_assembly_info').val('');
		
		$('#form_<?php echo $methodid ?>_detail_reject_assembly_id').val('');
