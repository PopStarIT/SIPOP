<script type="text/javascript">  
	function nav_button_<?php echo $function ?>(){
		...
		$('#form_<?php echo $methodid ?>_reject_injection_id').val('');
		getnexttransno(70, 'form_<?php echo $methodid ?>_reject_injection_no');
		$('#form_<?php echo $methodid ?>_reject_injection_date').val('<?php echo date('Y-m-d') ?>');
		$('#form_<?php echo $methodid ?>_reject_injection_info').val('');
		
		$('#form_<?php echo $methodid ?>_detail_reject_injection_id').val('');
