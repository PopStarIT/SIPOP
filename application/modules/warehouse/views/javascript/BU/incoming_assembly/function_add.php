<script type="text/javascript">  
	function nav_button_<?php echo $function ?>(){
		...
		$('#form_<?php echo $methodid ?>_incoming_id').val('');
		getnexttransno(79, 'form_<?php echo $methodid ?>_incoming_no');
		$('#form_<?php echo $methodid ?>_incoming_date').val('<?php echo date('Y-m-d') ?>');
		$('#form_<?php echo $methodid ?>_incoming_info').val('');
		
		$('#form_<?php echo $methodid ?>_detail_incoming_id').val('');
