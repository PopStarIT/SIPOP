<script type="text/javascript">  
	function nav_button_<?php echo $function ?>(){
		...
		$('#form_<?php echo $methodid ?>_stock_opname_assembly_id').val('');		
		getnexttransno(75, 'form_<?php echo $methodid ?>_stock_opname_assembly_no');
		$('#form_<?php echo $methodid ?>_stock_opname_assembly_date').val('<?php echo date('Y-m-d') ?>');
		$('#form_<?php echo $methodid ?>_stock_opname_assembly_memo').val('');
		
		$('#form_<?php echo $methodid ?>_detail_stock_opname_assembly_id').val('');
		$('#form_<?php echo $methodid ?>_detail_stock_opname_assembly_detail_id').val('');
