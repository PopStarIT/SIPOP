<script type="text/javascript">
	...
	function edit_<?php echo $methodid?>(id){
		$.ajax({
			...
			data: {
				...
				,param: 'data_work_order_production_foaming'
				,id : id
			},
			dataType: 'json',
			method: 'post',
			success: function(data){
				...
				$('#form_<?php echo $methodid ?>_detail_work_order_production_date').val(data[0].work_order_production_date);
			...
			$.ajax({
				...
				success: function(data){
					...
					if(data.valid){
						...
						work_order_production_date = $('#form_<?php echo $methodid ?>_work_order_production_date').val();
						...
						if(new_work_order_production == 1){
							...
							$('#form_<?php echo $methodid ?>_detail_work_order_production_date').val(work_order_production_date);
	...
	$(function () {
		...
		$("#table_<?php echo $methodid ?>_material").jqGrid({
			...
			postData:{
				'q':'1'
				,'<?php echo $this->security->get_csrf_token_name() ?>': '<?php echo $this->security->get_csrf_hash() ?>'
				, work_order_production_date : function (){
						return $('#form_<?php echo $methodid ?>_detail_work_order_production_date').val();	
					}
				, work_order_production_detail_id : function (){
						return $('#form_<?php echo $methodid ?>_detail_work_order_production_detail_id').val();	
					}
			},
	...
	function edit_detail_<?php echo $methodid ?>(id){
		...
		$.ajax({
			...
			data: {
				'<?php echo $this->security->get_csrf_token_name() ?>':'<?php echo $this->security->get_csrf_hash() ?>'
				,param: 'data_work_order_production_foaming_detail'
				,id : id
			},
			dataType: 'json',
			method: 'post',
