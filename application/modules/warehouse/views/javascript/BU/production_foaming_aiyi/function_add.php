<script type="text/javascript">  
	function nav_button_<?php echo $function ?>(){
		...
		work_order_production_plan_id = 0;
		work_order_production_work_process_id = 0;
		work_order_production_id = 0;
		...
		$('#form_<?php echo $methodid ?>_work_order_production_id').val('');
		getnexttransno(23, 'form_<?php echo $methodid ?>_work_order_production_no');
		$('#form_<?php echo $methodid ?>_work_order_production_date').val('<?php echo date('Y-m-d') ?>');
		
		$('#form_<?php echo $methodid ?>_detail_work_order_production_id').val('');
