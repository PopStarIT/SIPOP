<script type="text/javascript">  
	function nav_button_<?php echo $function ?>(){
		...
		$('#form_<?php echo $methodid ?>_stock_opname_injection_id').val('');		
		getnexttransno(74, 'form_<?php echo $methodid ?>_stock_opname_injection_no');
		$('#form_<?php echo $methodid ?>_stock_opname_injection_date').val('<?php echo date('Y-m-d') ?>');
		$('#form_<?php echo $methodid ?>_stock_opname_injection_memo').val('');
		
		$('#form_<?php echo $methodid ?>_detail_stock_opname_injection_id').val('');
		$('#form_<?php echo $methodid ?>_detail_stock_opname_injection_detail_id').val('');
