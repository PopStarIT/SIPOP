<script type="text/javascript">  
	function nav_button_<?php echo $function ?>(){
		...
		$('#form_<?php echo $methodid ?>_reject_id').val('');
		getnexttransno(17, 'form_<?php echo $methodid ?>_reject_no');
		$('#form_<?php echo $methodid ?>_reject_date').val('<?php echo date('Y-m-d') ?>');
		$('#form_<?php echo $methodid ?>_reject_info').val('');
		
		$('#form_<?php echo $methodid ?>_detail_reject_id').val('');
