<script type="text/javascript">
	...
	function edit_<?php echo $methodid?>(id){
		$.ajax({
			...
			success: function(data){
				...
				$('#form_<?php echo $methodid ?>_request_info').val(data[0].request_info);
	...
	function edit_detail_<?php echo $methodid ?>(id){
		...
		$.ajax({
			...
			data: {
				'<?php echo $this->security->get_csrf_token_name() ?>':'<?php echo $this->security->get_csrf_hash() ?>'
				,param: 'data_request_assembly2_detail'
				,id : id
			},
			dataType: 'json',
			method: 'post',
	...
	function supply_<?php echo $methodid?>(id){
		$.ajax({
			...
			success: function(data){
				...
				$('#form_<?php echo $methodid ?>_supply_request_info').val(data[0].request_info);
