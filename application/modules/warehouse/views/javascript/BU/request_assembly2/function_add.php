<script type="text/javascript">  
	function nav_button_<?php echo $function ?>(){
		...
		$('#form_<?php echo $methodid ?>_request_id').val('');
		getnexttransno(67, 'form_<?php echo $methodid ?>_request_no');
		$('#form_<?php echo $methodid ?>_request_date').val('<?php echo date('Y-m-d') ?>');
		$('#form_<?php echo $methodid ?>_request_info').val('');
		
		$('#form_<?php echo $methodid ?>_detail_request_id').val('');
