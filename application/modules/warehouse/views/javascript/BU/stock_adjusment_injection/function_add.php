<script type="text/javascript">  
	function nav_button_<?php echo $function ?>(){
		...
		stock_adjusment_injection_id = 0;
		...
		$('#form_<?php echo $methodid ?>_stock_adjusment_injection_id').val('');		
		getnexttransno(76, 'form_<?php echo $methodid ?>_stock_adjusment_injection_no');
		$('#form_<?php echo $methodid ?>_stock_adjusment_injection_date').val('<?php echo date('Y-m-d') ?>');
		$('#form_<?php echo $methodid ?>_stock_adjusment_injection_memo').val('');
		
		$('#form_<?php echo $methodid ?>_detail_stock_adjusment_injection_id').val('');
		$('#form_<?php echo $methodid ?>_detail_stock_adjusment_injection_detail_id').val('');
