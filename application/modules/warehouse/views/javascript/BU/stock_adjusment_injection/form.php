<script type="text/javascript">
	var new_stock_adjusment_injection = 1;
	var stock_adjusment_injection_id = 0;
	
	var stock_adjusment_injection_quantity = 0;
	...
	function edit_<?php echo $methodid?>(id){
		...
		$.ajax({
			...
			data: {
				...
				,param: 'data_stock_adjusment_injection'
				,id : id
			},
			dataType: 'json',
			method: 'post',
			success: function(data){
				...
				new_stock_adjusment_injection = 0;
				stock_adjusment_injection_id = data[0].stock_adjusment_injection_id;
								
				$('#form_<?php echo $methodid ?>_stock_adjusment_injection_id').val(data[0].stock_adjusment_injection_id);
				$('#form_<?php echo $methodid ?>_stock_adjusment_injection_no').val(data[0].stock_adjusment_injection_no);
				$('#form_<?php echo $methodid ?>_stock_adjusment_injection_date').val(data[0].stock_adjusment_injection_date);
				$('#form_<?php echo $methodid ?>_stock_adjusment_injection_memo').val(data[0].stock_adjusment_injection_memo);
				
				$('#form_<?php echo $methodid ?>_detail_stock_adjusment_injection_id').val(data[0].stock_adjusment_injection_id);
				$('#form_<?php echo $methodid ?>_detail_stock_adjusment_injection_date').val(data[0].stock_adjusment_injection_date);
			...
			$.ajax({
				...
				success: function(data){
					...
					if(data.valid){
						...
						stock_adjusment_injection_plan_id = $('#form_<?php echo $methodid ?>_work_order_plan_id').val();
						stock_adjusment_injection_work_process_id = $('#form_<?php echo $methodid ?>_work_process_id').val();
						
						if(new_stock_adjusment_injection == 1){
							new_stock_adjusment_injection = 0;
							$("#tab_<?php echo $methodid; ?>_detail").attr("data-toggle","tab");
							$("#tab_<?php echo $methodid; ?>_detail").removeClass( "tab_disabled");
							$("#tab_<?php echo $methodid; ?>_detail").click();
							stock_adjusment_injection_id = data.stock_adjusment_injection_id;
							
							$('#form_<?php echo $methodid ?>_stock_adjusment_injection_id').val(stock_adjusment_injection_id);
							$('#form_<?php echo $methodid ?>_detail_stock_adjusment_injection_id').val(stock_adjusment_injection_id);
							$('#form_<?php echo $methodid ?>_detail_work_order_plan_id').val(stock_adjusment_injection_plan_id);
							$('#form_<?php echo $methodid ?>_detail_work_process_id').val(stock_adjusment_injection_work_process_id);
							...
							new_stock_adjusment_injection = 1;
							$('#panel_content_<?php echo $methodid ?>').show();
							$('#panel_content_form_<?php echo $methodid ?>').hide();
							$("#table_<?php echo $methodid ?>").trigger('reloadGrid');
						}
	...
	$(function () {
		...
		$("#table_<?php echo $methodid ?>_detail").jqGrid({
			...
			postData:{
					'q':'1'
					,'<?php echo $this->security->get_csrf_token_name() ?>': '<?php echo $this->security->get_csrf_hash() ?>'
					, stock_adjusment_injection_date : function (){
						return $('#form_<?php echo $methodid ?>_detail_stock_adjusment_injection_date').val();	
					}
					, stock_adjusment_injection_id : function (){
						return $('#form_<?php echo $methodid ?>_detail_stock_adjusment_injection_id').val();	
					}
	...
	function add_<?php echo $methodid ?>(){
		...
		if(check_submit == 0) {
			...
			if (myArray.length == 0 ){
				...
				var data = {
					'<?php echo $this->security->get_csrf_token_name() ?>':'<?php echo $this->security->get_csrf_hash() ?>',                             
					stock_adjusment_injection_list : myArray,
					stock_adjusment_injection_id : $('#form_<?php echo $methodid ?>_detail_stock_adjusment_injection_id').val()
				}
