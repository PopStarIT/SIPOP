<script type="text/javascript">  
	$(function () {
        ...
        $("#table_<?php echo $methodid ?>").jqGrid({
			...
			datatype: "json",
			colNames:['KODE BARANG','NAMA BARANG', 'KATEGORI', 'SAT',  'PEMASUKAN', 'PENGELUARAN', 'SALDO HARMONICS', 'SALDO PPB', 'TOTAL', 'PEMILIK'],
			colModel:[
				{name:'r1',index:'r1', width:150},
				{name:'r2',index:'r2', width:200},
				{name:'r15',index:'r15', width:200},
				{name:'r3',index:'r3', width:75,align:'center'},  
				//{name:'r4',index:'r4', width:80,align:'right',formatter:'formatNumerics'},  
				{name:'r5',index:'r5', width:100,align:'right',formatter:'formatNumerics'},  
				...
				{name:'r12',index:'r12', width:100,align:'right',formatter:'formatNumerics'}, 
				...
				{name:'r13',index:'r13', width:150,align:'right',formatter:'formatNumerics'}, 
				{name:'r14',index:'r14', width:100,align:'right',formatter:'formatNumerics'},
				{name:'r16',index:'r16', width:200},
			],
			 iconSet: "fontAwesome",
            iconSet: "fontAwesome",
            idPrefix: "g1_",
		...
		$("#table_<?php echo $methodid ?>").jqGrid('setGroupHeaders', 
			...
			{startColumnName: 'r1', numberOfColumns: 4, titleText: '<em><center>ITEM</center></em>'}
		] });
