				...
				<div class="ui grid form">
					<div class="row field">
						<div class="twelve wide column">
						 <!-- Sementara belum dibuatkan proses save karena harus input data ke sistem ecc-->
							<button type="button" class="btn btn-success" onclick="savex_<?php echo $methodid ?>()">
								<i class="fa fa-save"></i> Save (error)
							</button>
