				...
				<div class="tab tab-border">
					...
					<div class="tab-content">
								...
								<div class="col-xl-12 mb-10 ml-10">
									<form class="ui grid ecc_form" id="form_<?php echo $methodid ?>" action="javascript:post_<?php echo $methodid ?>()">
										<?php 
											...
											$this->ecc_library->form('hidden','',"form_".$methodid,'supp_trans_id','');
											$this->ecc_library->form('hidden','',"form_".$methodid,'supp_trans_type_id','');
										?>
										
										<div class="row">
											<div class="col-xl-4">
												<?php 
													$this->ecc_library->form('text','Supplier Invoice No',"form_".$methodid,'supp_trans_no','','','');
													$this->ecc_library->form('date','Supplier Invoice Date',"form_".$methodid,'supp_trans_date','','','');
													$this->ecc_library->form('date','Supplier Invoice Due Date',"form_".$methodid,'supp_trans_due_date','','','');
												?>
											</div>
						...
						<div class="tab_custom_ecc tab-pane fade" id="content_<?php echo $methodid; ?>_detail" role="tabpanel" aria-labelledby="tab_<?php echo $methodid; ?>_detail">
							...
							<?php
								$this->ecc_library->form('hidden','',"form_".$methodid."_detail",'supp_trans_id','','','');
								$this->ecc_library->form('hidden','',"form_".$methodid."_detail",'supp_trans_detail_id','','','');
							...
							<div class="row mb-10" >
								<div class="col-xl-12">
									<?php 
										...
										$extra_field[] = array('field' => 'supp_trans_detail_id','form_id' => 'form_'. $methodid .'_detail_supp_trans_detail_id');
							...
							<div class="row">
								<div class="col-xl-12">
									<?php 
										$extra_param = array('methodid'=> $methodid,'extra_param' => array(0 => array('field' => 'supp_trans_id','form_id' => 'form_'. $methodid .'_detail_supp_trans_id')));
												...
												<div class="row">
													<div class="col-xl-4">
														<?php
															...
															$this->ecc_library->form('hidden','',"form_".$methodid."_detail_gl",'supp_trans_id','','','');
															$this->ecc_library->form('hidden','',"form_".$methodid."_detail_gl",'supp_trans_detail_id','','','');
							...
							<div class="row">
								<div class="col-xl-12">
									<?php 
										$extra_param = array('methodid'=> $methodid,'extra_param' => array(0 => array('field' => 'supp_trans_id','form_id' => 'form_'. $methodid .'_detail_gl_supp_trans_id')));
