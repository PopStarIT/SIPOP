...
class Master_task_assignment_detail_task extends CI_Controller
{
    ...
    function index()
    {
        ...
        $component['view_load'] = 'master_task_assignment_detail_task/view';
        $component['view_load_form'] = 'master_task_assignment_detail_task/form';
        $component['load_js'][] = 'master_task_assignment_detail_task/view';
        $component['load_js'][] = 'master_task_assignment_detail_task/form';
