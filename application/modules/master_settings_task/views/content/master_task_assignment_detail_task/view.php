                                ...
                                <div class="card">
                                    ...
                                    ?>
                                        ...
                                        <div id="panel_content_<?php echo $methodid ?>">
                                            ...
                                            $this->ecc_library->jqgrid((string)$methodid, $dashboard_table['field'], $dashboard_table['field_loaddata'], $extra_param);
                                            ?>
                                        </div>
                                    <?php
                                    } else {
                                    ?>
                                        <div id="panel_content_<?php echo $methodid ?>">
                                            ...
                                            $this->ecc_library->jqgrid((string)$methodid, $dashboard_table['field_operator'], $dashboard_table['field_loaddata_operator'], $extra_param);
                                            ?>
                                        </div>
                                    <?php
                                    }
