			...
			<div class="card-body" style="padding: 1.25rem !important">
				...
				<div class="tab tab-border">
					<ul class="nav nav-tabs form_tab_<?php echo $methodid ?>" role="tablist">
						<li class="nav-item">
							<a class="nav-link active show" id="tab_<?php echo $methodid; ?>_header_2" data-toggle="tab" href="#content_<?php echo $methodid; ?>_header" role="tab" aria-controls="content_<?php echo $methodid; ?>_header" aria-selected="true">
								Header
							</a>	
						</li>
						
						<li class="nav-item">
							<a class="nav-link" id="tab_<?php echo $methodid; ?>_detail_2" data-toggle="tab" href="#content_<?php echo $methodid; ?>_detail" role="tab" aria-controls="content_<?php echo $methodid; ?>_detail" aria-selected="true">
								Detail
							</a>	
						</li>
					</ul>
						...
						<div class="tab_custom_ecc tab-pane fade active show" id="content_<?php echo $methodid; ?>_header" role="tabpanel" aria-labelledby="tab_<?php echo $methodid; ?>_header">
							<div class="row">
								<div class="col-xl-12 mb-10 ml-10">
									<form class="ui grid ecc_form" id="form_<?php echo $methodid ?>_exp_subcon" action="javascript:post_<?php echo $methodid ?>_exp_subcon()">
										<?php 
										...
										<div class="row">
											<div class="col-xl-4">
												<?php 
													$this->ecc_library->form('text','Document No',"form_".$methodid."_exp_subcon",'grn_no','','','');
													$this->ecc_library->form('date','Good Receive Date',"form_".$methodid."_exp_subcon",'grn_date','','','');					
													$this->ecc_library->form('select','Warehouse',"form_".$methodid."_exp_subcon",'warehouse_id','','','warehouse');	
												?>
											</div>
											
											<div class="col-xl-4">
												<?php 
													$this->ecc_library->form('text','Delivery No',"form_".$methodid."_exp_subcon",'no_surat_jalan','','','');
													$this->ecc_library->form('date','Delivery Date',"form_".$methodid."_exp_subcon",'tgl_surat_jalan','','','');		
												?>
											</div>
																						
											<div class="col-xl-3">
												<?php 
													$this->ecc_library->form('select','Supplier',"form_".$methodid."_exp_subcon",'partner_id','','','supplier');	
                                                    $this->ecc_library->form('select','Performa Invoice',"form_".$methodid."_exp_subcon2",'sales_performa_id','','','performa_invoice');													
												?>
									...
									<div class="ui grid form">
										<div class="row field">
											<div class="twelve wide column">
												<button type="button" class="btn btn-success" onclick="save_<?php echo $methodid ?>_exp_subcon()">
