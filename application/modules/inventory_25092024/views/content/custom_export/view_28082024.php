						...
						<div class="col-xl-12">
							<div id="accordion">
								<div class="card">
									...
									<!-- form ini khusus untuk export yang dilakukan di subcon -->
									<div id="panel_content_form_<?php echo $methodid ?>_2" style="display:none">
										<?php
											if(isset($view_load_form_2)){
												$this->load->view('content/'.$view_load_form_2);
											}
										?>
									</div>
								</div>
