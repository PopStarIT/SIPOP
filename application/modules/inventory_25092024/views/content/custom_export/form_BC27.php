			...
			<div class="card-body" style="padding: 1.25rem !exportant">
				...
				<div class="tab tab-border">
					<ul class="nav nav-tabs form_tab_<?php echo $methodid ?>" role="tablist">
						...
						<li class="nav-item ">
							<a class="nav-link" id="tab_<?php echo $methodid; ?>_pkb" data-toggle="tab" href="#content_<?php echo $methodid; ?>_pkb" role="tab" aria-controls="content_<?php echo $methodid; ?>_pkb" aria-selected="true">
										...
										<div class="row">
											<div class="col-xl-6">
												...
												<div class="row">
													...
													<div class="col-xl-12">
														<div class="input_header_<?php echo $methodid ?> input_header_<?php echo $methodid ?>_8 input_header_<?php echo $methodid ?>_9 input_header_<?php echo $methodid ?>_10 input_header_<?php echo $methodid ?>_11">
										...
										<div class="row">
											<div class="col-xl-6">
												<div class="row">
													...
													<div class="col-xl-12">
														<?php $this->ecc_library->form('text','Cif',"form_".$methodid."_detail",'fob','','',''); ?>
													</div>
