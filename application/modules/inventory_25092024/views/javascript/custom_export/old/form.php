<script type="text/javascript">
	...
	function save_<?php echo $methodid ?>_exp_subcon(){
		$('#form_<?php echo $methodid ?>_exp_subcon').submit();
	}
	...
	function post_<?php echo $methodid ?>_exp_subcon(){
		if(check_submit == 0) {
			//check_submit = 1;
		//	page_loading("show",'Save <?php echo $page_title ?>','Please Wait...');
			var data = $("#form_<?php echo $methodid ?>_exp_subcon").serialize();
			console.log(data);
			alert("ok");
		}
	}
