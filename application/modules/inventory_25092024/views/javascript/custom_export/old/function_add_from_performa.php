<script type="text/javascript">  
	function nav_button_<?php echo $function ?>(){
		...
		custom_export_<?php echo $custom_type_id ?>_bc_out_type_id = 2;
		...
		setTimeout(function(){ 
			...
			$("#table_<?php echo $methodid ?>_sales_performa").setGridWidth($('.grid_container_<?php echo $methodid; ?>_sales_performa').width() - 20,true).trigger('resize');
