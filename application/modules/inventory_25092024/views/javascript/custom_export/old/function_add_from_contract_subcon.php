<script type="text/javascript">  
	function nav_button_<?php echo $function ?>(){
		...
		custom_export_<?php echo $custom_type_id ?>_bc_out_type_id = 4;
		...
		$('#panel_<?php echo $methodid ?>_4').show();
		...
		setTimeout(function(){ 
			...
			$("#table_<?php echo $methodid ?>_contract_subcon").setGridWidth($('.grid_container_<?php echo $methodid; ?>_contract_subcon').width() - 20,true).trigger('resize');
