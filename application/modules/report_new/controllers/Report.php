...
Class Report extends CI_Controller { 
	...
	function index(){
		...
		if($this->session->userdata('type_fasilitas_kode') == 'KB' || $this->session->userdata('type_fasilitas_kode') == ''){
			/* KB **/
			$tab_external_report_content[] = array('method_id' => 461, 'menu_name' => 'Pabean Pemasukan', 'menu_icon' => 'fa fa-file-text-o');
			$tab_external_report_content[] = array('method_id' => 462, 'menu_name' => 'Pabean Pengeluaran', 'menu_icon' => 'fa fa-file-text-o');
			$tab_external_report_content[] = array('method_id' => 463, 'menu_name' => 'WIP', 'menu_icon' => 'fa fa-file-text-o');
			$tab_external_report_content[] = array('method_id' => 464, 'menu_name' => 'Mutasi Bahan Baku & Bahan Penolong', 'menu_icon' => 'fa fa-file-text-o');
			$tab_external_report_content[] = array('method_id' => 465, 'menu_name' => 'Mutasi Scrap & Sisa', 'menu_icon' => 'fa fa-file-text-o');
			$tab_external_report_content[] = array('method_id' => 466, 'menu_name' => 'Mutasi Barang Jadi', 'menu_icon' => 'fa fa-file-text-o');
			$tab_external_report_content[] = array('method_id' => 467, 'menu_name' => 'Mutasi Mesin & Sparepart', 'menu_icon' => 'fa fa-file-text-o');
			
            //$tab_external_report_content[] = array('method_id' => 1027, 'menu_name' => 'Pabean Pengeluaran Summary', 'menu_icon' => 'fa fa-file-text-o');
			
			$tab_internal_report_content[] = array('method_id' => 867, 'menu_name' => 'Pengeluaran Ke Produksi', 'menu_icon' => 'fa fa-file-text-o');
			$tab_internal_report_content[] = array('method_id' => 869, 'menu_name' => 'Penerimaan Barang Jadi', 'menu_icon' => 'fa fa-file-text-o');
			$tab_internal_report_content[] = array('method_id' => 871, 'menu_name' => 'Penerimaan Reject', 'menu_icon' => 'fa fa-file-text-o');
			$tab_internal_report_content[] = array('method_id' => 873, 'menu_name' => 'Penerimaan Scrap', 'menu_icon' => 'fa fa-file-text-o');
		...
		$tab_internal_report_content[] = array('method_id' => 665, 'menu_name' => 'Tracing Sumber Pemasukan Barang per Dokumen', 'menu_icon' => 'fa fa-file-text-o');
		$tab_internal_report_content[] = array('method_id' => 667, 'menu_name' => 'Tracing Pengeluaran Barang per Dokumen', 'menu_icon' => 'fa fa-file-text-o');
