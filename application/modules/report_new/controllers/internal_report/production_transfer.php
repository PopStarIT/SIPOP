...
Class Production_transfer extends CI_Controller { 
	...
	function production_transfer_table(){
		$field = array();
		$field['r1'] = array('sc' => 'r1','ctype' => 'text', 'bypassvalue' => '', 'title' => 'NO REQUEST');
		$field['r2'] = array('sc' => 'r2','ctype' => 'text', 'bypassvalue' => '', 'title' => 'TGL REQUEST');
		$field['r3'] = array('sc' => 'r3','ctype' => 'text', 'bypassvalue' => '', 'title' => 'KODE BARANG');
		$field['r4'] = array('sc' => 'r4','ctype' => 'text', 'bypassvalue' => '', 'title' => 'NAMA BARANG');
		$field['r5'] = array('sc' => 'r5','ctype' => 'int', 'bypassvalue' => '', 'title' => 'JUMLAH', 'data_type' => 'decimal', 'decimal_digit' => 4);
		$field['r6'] = array('sc' => 'r6','ctype' => 'text', 'bypassvalue' => '', 'title' => 'SAT');
		$field['r7'] = array('sc' => 'r7','ctype' => 'text', 'bypassvalue' => '', 'title' => 'KODE PLAN');
		$field['r8'] = array('sc' => 'r8','ctype' => 'text', 'bypassvalue' => '', 'title' => 'KODE FG');
		$field['r9'] = array('sc' => 'r9','ctype' => 'text', 'bypassvalue' => '', 'title' => 'NAMA FG');
		$field['r10'] = array('sc' => 'r10','ctype' => 'text', 'bypassvalue' => '', 'title' => 'SAT');
	...
	function index(){
		...
		$component['view_load'] = 'internal_report/production_transfer/view';
		$component['load_js'][] = 'internal_report/production_transfer/view';
		
		$component['page_title'] = "Pengeluaran Ke Produksi";
		$dashboard_table = array();
	
		$field = $this->production_transfer_table();
	...
	function loaddata(){
		...
		$sp = "dbo.sp_rpt_production_transfer";		
		if($print == 1){
