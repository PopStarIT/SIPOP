	...
	$(function () {
        ...
        $("#table_<?php echo $methodid ?>").jqGrid({
			...
			colModel:[
				...
				{name:'r11',index:'r4', width:80,align:'right',formatter:'formatNumerics'},  
				{name:'r12',index:'r5', width:80,align:'right',formatter:'formatNumerics'},  
				{name:'r13',index:'r6', width:80,align:'right',formatter:'formatNumerics'},  
				{name:'r14',index:'r7', width:80,align:'right',formatter:'formatNumerics'},
				{name:'r15',index:'r8', width:100,align:'right',formatter:'formatNumerics'},
				{name:'r16',index:'r9', width:100,align:'right',formatter:'formatNumerics'},  
				{name:'r17',index:'r10', width:70,align:'right',formatter:'formatNumerics'},
				{name:'r18',index:'r11', width:80}
			],
			 iconSet: "fontAwesome",
            iconSet: "fontAwesome",
            idPrefix: "g1_",
