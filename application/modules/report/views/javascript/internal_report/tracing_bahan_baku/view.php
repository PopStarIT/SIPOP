<script type="text/javascript">  
	$(function () {
        ...
        $("#table_<?php echo $methodid ?>").jqGrid({
			...
			datatype: "json",
			colNames:['KATEGORI','KODE','NAMA', 'SAT', 'SALDO AWAL', 'PEMASUKAN', 'PENGELUARAN', 'PENYESUAIAN', 'SALDO AKHIR', 'DOC FROM', 'NO BC', 'TGL BC','QUANTITY'],
			//colNames:['KODE','NAMA', 'SAT', 'SALDO AWAL', 'PEMASUKAN', 'PENGELUARAN', 'PENYESUAIAN', 'SALDO AKHIR', 'STOCK OPNAME', 'SELISIH', 'KETERANGAN'],
			colModel:[
				{name:'r2',index:'r2', width:150,search: false},
				{name:'r3',index:'r3', width:120,search: false},
				{name:'r4',index:'r4', width:250,align:'left',search: false},  
				{name:'r5',index:'r5', width:50,align:'center',search: false},  
				{name:'r6',index:'r6', width:150,align:'right',search: false},  
				{name:'r7',index:'r7', width:150,align:'right',formatter:'formatNumerics',search: false},  
				{name:'r8',index:'r8', width:150,align:'right',formatter:'formatNumerics',search: false},
				{name:'r9',index:'r9', width:100,align:'center',formatter:'formatNumerics',search: false},
				{name:'r10',index:'r10', width:150,align:'right',formatter:'formatNumerics',search: false},  
				{name:'r11',index:'r11', width:70,align:'center',search: false},
				{name:'r12',index:'r12', width:80,align:'center',search: false},
				{name:'r13',index:'r13', width:80,search: false},
				{name:'r14',index:'r14', width:150,search: false},
				//{name:'r15',index:'r15', width:150,search: false},
			],
			 iconSet: "fontAwesome",
            iconSet: "fontAwesome",
            idPrefix: "g1_",
	...
	//		{startColumnName: 'r2', numberOfColumns: 2, titleText: '<em><center>ITEM</center></em>'}
	//	] });
	...
	function search_<?php echo $methodid ?>(){
		...
		kode_barang = $('#form_<?php echo $methodid ?>_item_kode_barang').val();
		//alert(kode_barang);
