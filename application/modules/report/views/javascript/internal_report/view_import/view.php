<script type="text/javascript">  
	...
	$(function () {
		...
		$("#table_<?php echo $methodid ?>_view_import").jqGrid({
			...
			colModel:[
				...
				{name:'r2',index:'r2', width:220,align:'center',cellattr: function(rowId, tv, rawObject, cm, rdata) {if (rdata.rspan==0) { return  (' style="display: none"');}else if (rdata.rspan>1) { return  (' rowspan="' + rdata.rspan +'"   style=" vertical-align:top"'); }}},
				...
				{name:'r4',index:'r4', width:110,align:'center',cellattr: function(rowId, tv, rawObject, cm, rdata) {if (rdata.rspan==0) { return  (' style="display: none"');}else if (rdata.rspan>1) { return  (' rowspan="' + rdata.rspan +'"   style=" vertical-align:top"'); }}},
				{name:'r5',index:'r5', width:200,cellattr: function(rowId, tv, rawObject, cm, rdata) {if (rdata.rspan==0) { return  (' style="display: none"');}else if (rdata.rspan>1) { return  (' rowspan="' + rdata.rspan +'"   style=" vertical-align:top"'); }}},  
				...
				{name:'r8',index:'r8', width:300,acellattr: function(rowId, tv, rawObject, cm, rdata) {if (rdata.rspan==0) { return  (' style="display: none"');}else if (rdata.rspan>1) { return  (' rowspan="' + rdata.rspan +'"   style=" vertical-align:top"'); }}},
				...
				{name:'r13',index:'r13', width:80,acellattr: function(rowId, tv, rawObject, cm, rdata) {if (rdata.rspan==0) { return  (' style="display: none"');}else if (rdata.rspan>1) { return  (' rowspan="' + rdata.rspan +'"   style=" vertical-align:top"'); }}},
			...
			rowNum:10,
			rowList:[10,20,30],
			pager: '#ptable_<?php echo $methodid ?>_view_import',
            sortname: "r1",
            sortorder: "asc",
			shrinkToFit:false,
			autowidth: true,
			...
			viewrecords : true,
			caption:"Dokumen Import" ,
			gridview:true
		}); 
		$("#table_<?php echo $methodid ?>_view_import").jqGrid("setColProp", "rn", {hidedlg: false});
		$("#table_<?php echo $methodid ?>_view_import").jqGrid('navGrid','#ptable_<?php echo $methodid ?>_view_import',{edit:false,add:false,del:false,view:false, search: false});  
		$("#table_<?php echo $methodid ?>_view_import").jqGrid('filterToolbar',{stringResult: true,searchOnEnter : false, defaultSearch: 'cn', ignoreCase: false});  
