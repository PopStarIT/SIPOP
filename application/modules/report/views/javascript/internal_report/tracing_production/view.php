<script type="text/javascript">  
	$(function () {
        ...
        $("#table_<?php echo $methodid ?>").jqGrid({
			...
			datatype: "json",
			colNames:['Production No','Production Date','Plan No', 'Plan Date','Doc BC', 'No BC', 'Tgl BC','Status',  'Create By'],
			//colNames:['KODE','NAMA', 'SAT', 'SALDO AWAL', 'PEMASUKAN', 'PENGELUARAN', 'PENYESUAIAN', 'SALDO AKHIR', 'STOCK OPNAME', 'SELISIH', 'KETERANGAN'],
			colModel:[
				{name:'r4',index:'r4', width:300},
				{name:'r5',index:'r5', width:150,align:'center'},
				{name:'r6',index:'r6', width:300,align:'left'},  
				{name:'r7',index:'r7', width:200,align:'center'},  
				{name:'r8',index:'r8', width:100,align:'center'},  
				{name:'r9',index:'r9', width:120,align:'center'},  
				{name:'r10',index:'r10', width:100,align:'left'},
				{name:'r11',index:'r11', width:100,align:'center',},
				{name:'r12',index:'r12', width:80,align:'left'},  
