<script type="text/javascript">  
	$(function () {
        ...
        $("#table_<?php echo $methodid ?>").jqGrid({
			...
			datatype: "json",
			colNames:['BRG JADI','BAHAN BAKU', 'SALDO AWAL', 'PEMASUKAN', 'QTY SUPPLY', 'SISA', 'SATUAN', 'DOC BC', 'NO BC', 'TGL BC', 'KETERANGAN'],
			colModel:[
				...
				{name:'r7',index:'r7', width:80,align:'center'},
				{name:'r8',index:'r8', width:100,align:'center'},
				{name:'r9',index:'r9', width:100,align:'center'},  
				{name:'r10',index:'r10', width:100,align:'center'},
				{name:'r11',index:'r11', width:120,align:'center'}
			],
			 iconSet: "fontAwesome",
            iconSet: "fontAwesome",
            idPrefix: "g1_",
