<script type="text/javascript">  
	$(function () {
		...
		$("#table_<?php echo $methodid ?>").jqGrid({
			...
			colModel:[
				...
				{name:'r4',index:'r4', width:150,align:'right',formatter:'formatNumerics'},  
				...
				{name:'r10',index:'r10', width:150,align:'right',formatter:'formatNumerics'},
				{name:'r11',index:'r11', width:150,align:'right',formatter:'formatNumerics'},
			],
			 iconSet: "fontAwesome",
            iconSet: "fontAwesome",
            idPrefix: "g1_",
	...
	function print_<?php echo $methodid ?>(format){
	 ...
	 // alert(format);
      window.open(baseurl+'<?php echo $class_uri ?>/print_summary_bahan_baku?'+'date_start=' +date_start+ '&date_end='+date_end+ '&format='+format, '_BLANK');
	}
