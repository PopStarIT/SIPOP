									...
									<div class="card">
										<div class="card-header" id="headingOne">
										 ...
										 <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
										  &nbsp &nbsp
											<div class="card-body">
											 <form class="ui grid ecc_form" id="form_<?php echo $methodid ?>">
											    ...
											    <div class="col-xl-8">
												 <?php 
					                                $this->ecc_library->form2('select_pop_line','Kode Barang',"form_".$methodid,'item_kode_barang','','','get_item_detail','4');	
			                                     ?>
												 </div>
