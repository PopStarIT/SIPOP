			...
			<div class="col-xl-12">
				<div class="card card-statistics"> 
					<div class="card-body">
											...
											<!--	 <div class="col-xl-4 mb-4">
			                                      ...
			                                      ?>							  
													...
													<div class="form-group">
														...
														&nbsp &nbsp
														<button type="button" class="btn btn-default" onclick="javascript:print_excel_<?php echo $methodid ?>('xlsx');">
						...
						<div class="row">
							<div class="col-xl-12">
								<table id="table_<?php echo $methodid ?>_view_ekspor"></table>
								<div id="ptable_<?php echo $methodid ?>_view_ekspor"></div>                                                     
							</div>
						</div>
					</div>
				</div>
