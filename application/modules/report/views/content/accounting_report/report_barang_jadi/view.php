											...
											<div class="card-body">
												<form class="form-inline" id="form_<?php echo $methodid ?>">
													<div class="form-group">
														...
														&nbsp &nbsp
														<button type="button" class="btn btn-default" onclick="javascript:print2_<?php echo $methodid ?>('xlsx');">
															<i class="fa fa-search"></i> Print Xlsx
														</button>
														
														&nbsp &nbsp
														<!--<button type="button" class="btn btn-default" onclick="javascript:print_new_<?php echo $methodid ?>('xlsx');">
															<i class="fa fa-search"></i> Print Xlsx Lain
														</button> -->
													</div>									
												</form>
											</div>
