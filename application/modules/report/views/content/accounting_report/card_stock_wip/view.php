										...
										<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
											<div class="card-body">
												<form class="form-inline" id="form_<?php echo $methodid ?>">
												 ...
												 <!-- <input class="form-control" id="form_<?php //echo $methodid ?>_keterangan"  name="keterangan" type="hidden" value="card_bahan_baku" /> --> 
												 ...
												 <!-- <input class="form-control" id="form_<?php //echo $methodid ?>_date_start"  name="date_start" type="text" value="2021-01-01" /> --> 
														</div>
													...
													<!--		<input class="form-control" id="form_<?php //echo $methodid ?>_date_end"  name="date_end" type="text" value="2021-12-31" /> -->
														...
														&nbsp &nbsp
														<button type="button" class="btn btn-default" onclick="javascript:print_perkode_<?php echo $methodid ?>('xlsx');">
															<i class="fa fa-search"></i> Print Perkode
														</button>
													</div>									
												</form>
											</div>
