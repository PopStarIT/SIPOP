...
class Card_stock_bahan_baku extends CI_Controller
{
	...
	function index()
	{
		...
		$component['view_load'] = 'accounting_report/card_stock_bahan_baku/view';
		$component['load_js'][] = 'accounting_report/card_stock_bahan_baku/view';

		$component['page_title'] = "Card Stock Bahan Baku";
