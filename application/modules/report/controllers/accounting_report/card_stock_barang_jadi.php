...
class Card_stock_barang_jadi extends CI_Controller
{
	...
	function index()
	{
		...
		$component['view_load'] = 'accounting_report/card_stock_barang_jadi/view';
		$component['load_js'][] = 'accounting_report/card_stock_barang_jadi/view';

		$component['page_title'] = "Card Stock Barang Jadi";
	...
	function index_old()
	{
		...
		$nav_button = array();
		// $nav_button[] = array('method_id' => 7811333, 'title' => 'Add', 'icon' => 'fa fa-plus', 'load' => 'accounting_report/card_stock_bahan_baku/function_add');
		// $nav_button[] = array('method_id' => 7811334, 'title' => 'Edit', 'icon' => 'fa fa-pencil', 'load' => 'accounting_report/card_stock_bahan_baku/function_edit');

		// $nav_button[] = array('method_id' => 7811335, 'title' => 'Delete', 'icon' => 'fa fa-trash-o', 'load' => 'accounting_report/card_stock_bahan_baku/function_delete');
	...
	function print_transfer_excel()
	{
		...
		//$sp = "dbo.sp_rpt_penerimaan_barang_jadi";	
		$sp = "dbo.sp_mutasi_card_stock_barang_jadi";
		//$this->rpc_service->setSP($sp);
	...
	function print_excel_perkode()
	{
		...
		LEFT JOIN dbo.view_mst_item_category_ecc e ON d.item_category_id = e.item_category_id
	    Left Join dbo.prm_custom_item_type f ON e.custom_item_type_id = f.custom_item_type_id 
		where a.receive_date >='$date_start' and a.receive_date <='$date_end' and f.custom_item_type_id = 2");
		} else {
