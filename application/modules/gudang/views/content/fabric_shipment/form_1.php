			...
			<div class="card-body" style="padding: 1.25rem !important">
				...
				<div class="tab tab-border">
					...
					<div class="tab-content">
					  ...
					  <div class="tab_custom_ecc tab-pane fade" id="content_<?php echo $methodid; ?>_shipment_receive" role="tabpanel" aria-labelledby="tab_<?php echo $methodid; ?>_shipment_receive">
						 <div class="row panel_<?php echo $methodid ?>_shipment_receive">
							<div class="col-xl-12">
