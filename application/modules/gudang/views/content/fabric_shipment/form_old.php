			...
			<div class="card-body" style="padding: 1.25rem !important">
				...
				<div class="tab tab-border">
					<ul class="nav nav-tabs form_tab_<?php echo $methodid ?>" role="tablist">
						...
						<li class="nav-item">
							<a class="nav-link" id="tab_<?php echo $methodid; ?>_import_excel_shipment" data-toggle="tab" href="#content_<?php echo $methodid; ?>_import_excel_shipment" role="tab" aria-controls="content_<?php echo $methodid; ?>_import_excel_shipment" aria-selected="true">
								Import Excel 
							</a>	
						</li>
					</ul>
										    ...
										    <div class="col-xl-4">
											   <?php
											     $this->ecc_library->form('hidden','',"form_".$methodid."_detail",$this->security->get_csrf_token_name(),$this->security->get_csrf_hash());
												  ...
												  $this->ecc_library->form('text','',"form_".$methodid."_detail",'fabric_shipment_detail_id','','','');
								  ...
								  <div class="row">
								    <div class="col-xl-12">
								      <div class="row">
								         <div class="col-xl-3">
							          		<?php
							          		$this->ecc_library->form2('select_pop','Item Codex',"form_".$methodid."_detail",'item_idx','','','get_list_item_barangx','4',array('extra_param' => array(0 => array('field' => 'purchase_order_warehouse_id' ),1 => array('field' => 'item_fabric_idx' ))));
							        		?>
							        		 </div>
							          	 <div class="col-xl-3">
							          		<?php
								     ...
								     <div class="col-xl-12">
								       <div class="col-xl-4">
												<label> &nbsp </label>
												<div class="input-group">
													<div class="button_<?php echo $methodid ?>_import_shipment_new" style="display:none">
														<button type="submit" class="btn btn-success">
															<i class="fa fa-plus"></i> ADD
														</button>
													</div>
													
													<div class="button_<?php echo $methodid ?>_import_shipment_edit" style="display:none">
														<button type="submit" class="btn btn-success">
															<i class="fa fa-check"></i> SAVE
														</button>
														
														<a class="btn btn-danger" onclick="javascript:cancel_import_shipment_<?php echo $methodid ?>()">
															<i class="fa fa-times"></i> CANCEL
														</a>
													</div>
												</div>
