...
<!-- sebelumnya menggunakan aria-hidden="true dan tabindex="-1"" -->
<div class="tab_custom_ecc modal fade" id="modal_fabric_shipment"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" tabindex="-1">
		    ...
		    <div class="col-xl-3">
			    <form class="ui grid ecc_form" id="form_<?php echo $methodid ?>_mdl_barcode" action="javascript:generate_barcode_<?php echo $methodid ?>()" >
			       <div class="button_<?php echo $methodid ?>_generate_barcode" >
					  <button type="submit" class="btn btn-success">
					  	<i class="fa fa-plus"></i> Cetak Barcode
					  </button>
					</div>
				</form>
			  </div>
