								...
								<div class="col-xl-12">
										...
										<div class="col-xl-12">
											...
											<div class="row g-3">
												<div class="col-12 col-md-6">
													<div class="card text-center border-primary">
														...
														<div class="card-body">
															<h2 class="card-title mb-0" id="lot_number_<?php echo $methodid ?>">0</h2>
														</div>
													</div>
												</div>
											...
											<div class="row align-items-center mb-4">
                                             ...
                                             <div class="col-auto d-flex gap-2">
                                                 ...
                                                 <button type="button" class="btn btn-success" onclick="javascript:modal_add_receive_<?php echo $methodid ?>()">Add</button>
                                             </div>
                                           </div>
									...
									<!-- 		<div class="row align-items-end mb-4">
												...
												<div class="col-md-2 text-end">
													<button type="button" class="btn btn-info w-100 w-sm-auto" onclick="javascript:modal_view_<?php //echo $methodid ?>()">View Data</button>
												</div>
									...
									<!-- <div class="row panel_<?php //echo $methodid 
																?>_panel_fabric_shipment mb-10"> -->
										...
										<div class="col-xl-12">
											<div class="row">
												<div class="col-xl-4">
													...
													// $this->ecc_library->form('text', 'grn_id', "form_" . $methodid . "_other_scan", 'grn_id', '', '', '');
													// $this->ecc_library->form2('select_pop','Purchase Order No:',"form_".$methodid."_detil_scan",'purchase_order_warehouse_id','','','data_list_po_warehouse','6');
													?>
													<!--	<div class="form-group">
														<label for="fabric_barcode">Barcode Scan</label>
														<div class="input-group">
															...
															<input type="text" class="form-control fabric_barcode" id="form_<?php //echo $methodid 
																															?>_other_scan_fabric_barcode" name="fabric_barcode" onkeypress="scan_receive_other_<?php //echo $methodid 
			   ...
			   <div class="col-xl-12 mb-2">
				<div class="row">
			     <div class="col-xl-6">
				  ...
				  <div class="col-xl-6">
						<?php
						$this->ecc_library->form2('select_pop','Item Code',"form_".$methodid."_mdl_add_receive",'shipment_code','','','get_receive_code','4',array('extra_param' => array(0 => array('field' => 'po_no' ))));
...
<div class="tab_custom_ecc modal fade" id="modal_add_receive" role="dialog" aria-labelledby="exampleModalLabel" tabindex="-1">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
			...
			<div class="col-xl-12">
				<div class="row">
					<div class="col-xl-4">
						<?php
                        $this->ecc_library->form2('select_pop','Purchase Order No:',"form_".$methodid."_add_receive",'purchase_order_warehouse_id','','','data_list_po_warehouse','6');
						?>
					</div>
					 <div class="col-xl-3">
						<?php
						$this->ecc_library->form2('select_pop','Item Code',"form_".$methodid."_add_receive",'shipment_code','','','get_shipment_code','4',array('extra_param' => array(0 => array('field' => 'purchase_order_warehouse_id' ))));
												
						?>
					</div>
					  <div class="col-xl-2">
					<?php
					  $this->ecc_library->form('select','Unit Weight',"form_".$methodid."_add_receive",'unit_weight','','','uom');
					?>
					</div>
					 <div class="col-xl-2">
					<?php
					  $this->ecc_library->form('select','Unit Quantity',"form_".$methodid."_add_receive",'unit_qty','','','uom');
					?>
					</div>
				</div>
			...
			<div class="col-xl-12">
				<div class="row">
					<div class="col-xl-4">
						<?php
                        $this->ecc_library->form2('text','colour',"form_".$methodid."_add_receive",'colour','','','');
						?>
					</div>
					 <div class="col-xl-3">
					<?php
					 $this->ecc_library->form2('text','Lot',"form_".$methodid."_add_receive",'lot','','','');
					?>
					</div>
					  <div class="col-xl-2">
					<?php
					 $this->ecc_library->form2('text','Bale',"form_".$methodid."_add_receive",'bale','','','');
					?>
					</div>
					 <div class="col-xl-2">
					<?php
					 $this->ecc_library->form2('text','Roll',"form_".$methodid."_add_receive",'roll','','','');
					?>
					</div>
				</div>
			</div>
			...
			<div class="col-xl-12">
				<div class="row">
					<div class="col-xl-4">
						<?php
                        $this->ecc_library->form2('text','weight',"form_".$methodid."_add_receive",'weight','','','');
						?>
					</div>
					 <div class="col-xl-3">
					<?php
					 $this->ecc_library->form2('text','qty',"form_".$methodid."_add_receive",'qty','','','');
					?>
					</div>
					  <div class="col-xl-4">
					<?php
					 $this->ecc_library->form2('text','barcode',"form_".$methodid."_add_receive",'barcode','','','');
					?>
					</div>
			 ...
			 <div class="col-xl-12">
			   ...
			   <div class="col-xl-4">
				<label> &nbsp </label>
				<div class="input-group">
					<div class="button_<?php echo $methodid ?>_add_receive">
						<button type="submit" class="btn btn-success">
							<i class="fa fa-plus"></i> ADD
						</button>
