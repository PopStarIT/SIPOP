							...
							<div class="row panel_<?php echo $methodid ?>_panel_detail_scan">
								<div class="col-xl-12">
												...
												<div class="col-xl-4">
													...
													<div class="form-group">
														...
														<div class="input-group">
															...
															<!-- <input  type="hidden" class="form-control fabric_barcode" id="form_<?php //echo $methodid ?>il_scan_fabric_barcode2"  name="fabric_barcode2" autocomplete='off'/> -->
									...
									<!-- <div class="row panel_<?php //echo $methodid 
																?>_panel_custom_order mb-10" >
								             <div class="col-xl-12">
								             	<?php
													//      		$extra_field = array();
													//      		$extra_field[] = array('field' => 'partner_id','form_id' => 'form_'. $methodid .'_detail_partner_id');
													//      		$extra_field[] = array('field' => 'bc_in_header_id','form_id' => 'form_'. $methodid .'_detail_scan_bc_in_header_id');
													//      		$extra_field[] = array('field' => 'fabric_warehouse_receive_detail_id','form_id' => 'form_'. $methodid .'_detail_scan_fabric_warehouse_receive_detail_id');
									...
									<div class="row panel_<?php echo $methodid ?>_panel_custom_order mb-10">
										<div class="col-xl-10">
											<?php
											$extra_field = array();
											$extra_field[] = array('field' => 'partner_id', 'form_id' => 'form_' . $methodid . '_detail_scan_partner_id');
											$extra_field[] = array('field' => 'bc_in_header_id', 'form_id' => 'form_' . $methodid . '_detail_scan_bc_in_header_id');
											$extra_field[] = array('field' => 'fabric_warehouse_receive_detail_id', 'form_id' => 'form_' . $methodid . '_detail_scan_fabric_warehouse_receive_detail_id');
											$extra_param = array('methodid' => $methodid, 'beforeclick' => 'beforeclick_' . $methodid . "_custom", 'extra_param' => $extra_field);
											//	$this->ecc_library->jqgrid($methodid."_custom", $dashboard_table['field_custom_item'], $dashboard_table['field_custom_item_loaddata'],$extra_param); 
										...
										<div class="col-xl-2">
											...
											<div class="form-group" id="group_in_barcode" style="display:none">
												...
												<div class="input-group">
													...
													<!-- <input  type="hidden" class="form-control fabric_barcode" id="form_<?php //echo $methodid 
																															?>_detail_scan_fabric_barcode2"  name="fabric_barcode2" autocomplete='off'/> -->
									...
									<div class="row panel_<?php echo $methodid ?>_panel_receive_detail mb-10">
										<div class="col-xl-10">
											...
											$this->ecc_library->jqgrid2($methodid . "_receive_scan", $dashboard_table['field_receive_scan'], $dashboard_table['field_loaddata_scan'], $extra_param);
											?>
										</div>
									</div>
									...
									<!--   <div class="row">  
										    <div class="col-xl-12 grid_container_<?php //echo $methodid 
																					?>_detail_receive" >
										      <table id="table_<?php //echo $methodid 
																?>_detail_receive"></table>
										      <div id="ptable_<?php //echo $methodid 
																?>_detail_receive"></div>
											</div> -->
						...
						<div class="tab_custom_ecc tab-pane fade" id="content_<?php echo $methodid; ?>_other_scan" role="tabpanel" aria-labelledby="tab_<?php echo $methodid; ?>_other_scan">
							<div class="row panel_<?php echo $methodid ?>_panel_other_scan">
								<div class="col-xl-12">
									...
									<div class="row panel_<?php echo $methodid ?>_panel_custom_order_other mb-10">
										<div class="col-xl-10">
											<?php
											$extra_field = array();
											$extra_field[] = array('field' => 'partner_id', 'form_id' => 'form_' . $methodid . '_other_scan_partner_id');
											$extra_field[] = array('field' => 'bc_in_header_id', 'form_id' => 'form_' . $methodid . '_other_scan_bc_in_header_id');
											$extra_field[] = array('field' => 'bc_in_barang_id', 'form_id' => 'form_' . $methodid . '_other_scan_bc_in_barang_id');

											$extra_field[] = array('field' => 'fabric_warehouse_receive_detail_id', 'form_id' => 'form_' . $methodid . '_other_scan_fabric_warehouse_receive_detail_id');
											$extra_param = array('methodid' => $methodid, 'beforeclick' => 'beforeclick_' . $methodid . "_custom", 'extra_param' => $extra_field);
											//	$this->ecc_library->jqgrid($methodid."_custom", $dashboard_table['field_custom_item'], $dashboard_table['field_custom_item_loaddata'],$extra_param); 
											?>
										</div>
										...
										<div class="col-xl-2">
											...
											<div class="form-group" id="group_in_barcode" style="display:none">
												...
												<div class="input-group">
													...
													<input type="text" class="form-control fabric_barcode" id="form_<?php echo $methodid ?>_other_scan_insert_barcode" name="insert_barcode" onkeypress="scan_insert_barcode_<?php echo $methodid ?>(event)" autocomplete='off' />
