					...
					<div class="tab-content">
						<div class="tab_custom_ecc tab-pane fade active show" id="content_<?php echo $methodid; ?>_header" role="tabpanel" aria-labelledby="tab_<?php echo $methodid; ?>_header">
							<div class="row panel_<?php echo $methodid ?>_panel_header">
								...
								<!--	<div id="status_container" style="display:none; margin: 10px 0; padding: 10px; border: 1px solid #3c8dbc; background: #f0f9ff;"> -->
								...
								<div class="col-xl-12">
											...
											<div class="row g-3">
												<div class="col-12 col-md-4">
													<div class="card text-center border-danger">
														...
														<div class="card-body">
															<h2 class="card-title mb-0" id="lot_quantity_<?php echo $methodid ?>">0</h2>
														</div>
													</div>
												</div>
                                                 <div class="col-12 col-md-4">
                                   ...
                                   <div class="col-xl-12">
                                       <div class="form-check mb-10 ">
										  ...
										  &nbsp;&nbsp;&nbsp;
									 <!--	   <span id="total_diterima" style="font-size: 16px; color: #666; font-weight: bold;"><?php //echo $diterima; ?></span>
										   <span style="font-size: 16px; color: #666; ">To</span>
                                           <span id="total_receive" style="font-size: 16px; color: #666; font-weight: bold;"><?php//echo $total_receive; ?></span>  -->
                                      </div>
									 </div>
