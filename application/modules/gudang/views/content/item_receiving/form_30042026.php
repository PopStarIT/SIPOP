			...
			<div class="modal-body">
                ...
                <div class="col-xl-12">
			     <div class="row">
          		...
          		<!--    <button type="button" class="btn btn-info" style="margin: 10px 0; padding: 10px;" onclick="javascript:add_all_receive_<?php //echo $methodid ?>();">
					<i class="fa fa-plus"></i> receive All
				    </button> -->
					&nbsp;
				    <div class="col-xl-4" id="status_<?php echo $methodid ?>_receive_all" style="display:none; margin: 10px 0; padding: 10px; border: 1px solid #3c8dbc; background: #f0f9ff;">
