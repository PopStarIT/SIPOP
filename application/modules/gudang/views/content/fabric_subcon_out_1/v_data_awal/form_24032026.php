<style>
 .fabric_barcode {
    height: 50px;
    font-size: 1.2rem; /* Sebaiknya imbangi dengan ukuran font agar proporsional */
 }
									...
									<div class="row">
										...
										<div class="col-xl-12 mb-30">
										  ...
										  <div class="row">
										   <div class="col-xl-12">	
											<?php
											$extra_param = array('methodid' => $methodid, 'extra_param' => array(0 => array('field' => 'fabric_subcon_out_detail_id', 'form_id' => 'form_' . $methodid . '_supply_fabric_subcon_out_detail_id')));
