							...
							<div class="row">
								<div class="col-xl-12 mb-10 ml-10">
									...
									<div class="row ">
										<div class="col-xl-12">
											<?php 
												$extra_param = array('methodid'=> $methodid,'onclick'=> 'click_transfer_'.$methodid,'extra_param' => array(0 => array('field' => 'work_order_request_id','form_id' => 'form_'. $methodid .'_fabric_request_id')));
									...
									<div class="row">
										<div class="col-xl-12 mb-30">
									       <div class="form-group">
														...
														<!--	<input type="text" class="form-control fabric_barcode" id="form_<?php //echo $methodid ?>_supply_fabric_barcode" name="fabric_barcode" onkeypress="supply_fabric_barcode_<?php //echo $methodid ?>(event)" autocomplete='off' /> <input type="text" <input type="text" onfocus="this.value=''">-->
															<!-- onfocus="this.value=''"  dan  autofocus="autofocus"/> -->
															<input type="text" class="form-control fabric_barcode" id="form_<?php echo $methodid ?>_supply_fabric_barcode" name="fabric_barcode" tabindex="1"/>
										...
										<div class="col-xl-4 mb-30">
											<form class="ui grid ecc_form" id="form_<?php echo $methodid ?>_supply" action="javascript:post_<?php echo $methodid ?>_supply()">
												<?php 
													...
													$this->ecc_library->form('text','',"form_".$methodid."_supply",'work_order_request_id','');			
