<script type="text/javascript">  
	function nav_button_<?php echo $function ?>(){
		...
		$("#tab_<?php echo $methodid; ?>_other_scan").removeAttr("data-toggle");
		$("#tab_<?php echo $methodid; ?>_other_scan").addClass( "tab_disabled");
		...
		$('#form_<?php echo $methodid ?>_grn_type_id_ecc').val(grn_type_id);
		$('#form_<?php echo $methodid ?>_fabric_warehouse_receive_type_id').val(grn_warehouse_type_id);
		
        getnexttransno_sipop(710, 'form_<?php echo $methodid ?>_fabric_warehouse_receive_no');
