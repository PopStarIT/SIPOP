<script type="text/javascript">  
	...
	function nav_button_<?php echo $function ?>(){
		...
		$('#form_<?php echo $methodid ?>_fabric_transfer_edit').val('0');	
	...
	//	$('.form_title_<?php echo $methodid ?>').html('New <?php echo $page_title ?>');
		...
		$('#form_<?php echo $methodid ?>_fabric_transfer_id').val('');
		getnexttransno_item_transfer(722, 'form_<?php echo $methodid ?>_fabric_transfer_no');
		$('#form_<?php echo $methodid ?>_fabric_transfer_date').val('<?php echo date('Y-m-d') ?>');
				
		new_work_order_transfer = 1;
				
		$('#form_<?php echo $methodid ?>_fabric_request_id').html('');
		$('#form_<?php echo $methodid ?>_fabric_request_id').selectpicker('refresh');
