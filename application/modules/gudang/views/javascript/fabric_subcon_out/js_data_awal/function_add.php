<script type="text/javascript">  
	...
	//	$('.form_title_<?php echo $methodid ?>').html('New <?php echo $page_title ?>');
		...
		$('#form_<?php echo $methodid ?>_fabric_subcon_out_id').val('');
		//getnexttransno_item_transfer(746, 'form_<?php echo $methodid ?>_subcon_out_no');
		getnexttransno_sipop(746, 'form_<?php echo $methodid ?>_subcon_out_no');
