...
class Asset_gudang extends CI_Controller
{
	...
	{
		$view = 'view_data_assets_gudang_incoming';
		$get_field = $this->ecc_library->get_field_pop($view);
	...
	function outgoing_table()
	{
		...
		$view = 'view_data_assets_gudang_outgoing';
		$get_field = $this->ecc_library->get_field_pop($view);

		$get_field['r1']['hidden'] = true;
		$get_field['r14']['hidden'] = true;

		$get_field['r7']['footer'] = 'Total Outgoing :';
		$get_field['r8']['footer'] = 'sum';
	...
	function index()
	{
		...
		$component['view_load'] = 'assets_gudang/view';
		$component['load_js'][] = 'assets_gudang/view';

		$component['page_title'] = "Assets Gudang";
		...
		$dashboard_table['field_asset_loaddata'] = 'loaddata';
	...
	function loaddata_incoming()
	{
		...
		$extra_param = array();
		if ($item_id) {
			$extra_param['where']['0']['field'] = 'r19';
			$extra_param['where']['0']['data'] = $item_id;
		}
		$extra_param['methodid'] = $methodid;
		$extra_param['footer_data'] = true;
		$extra_param['sp_sum'] = 'dbo.sp_assets_gudang_incoming_sum';
	...
	function loaddata_outgoing()
	{
		...
		$extra_param['methodid'] = $methodid;
		$extra_param['footer_data'] = true;
		$extra_param['sp_sum'] = 'dbo.sp_assets_outgoing_gudang_sum';
