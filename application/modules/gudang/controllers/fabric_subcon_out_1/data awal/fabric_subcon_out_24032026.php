...
class Fabric_subcon_out extends CI_Controller
{
	...
	function index()
	{
		...
		$nav_button[] = array('method_id' => 7811415, 'title' => 'Supply', 'btn' => 'btn-primary', 'icon' => 'fa fa-pencil', 'load' => 'fabric_subcon_out/function_supply');
		...
		$field_detail_supply = $this->fabric_subcon_out_detail_supply_table();
		...
		$dashboard_table['field_fabric_subcon_out_detail_supply'] = $field_detail_supply;
		$dashboard_table['field_fabric_subcon_out_detail_supply_loaddata'] = 'loaddata_detail_supply';
