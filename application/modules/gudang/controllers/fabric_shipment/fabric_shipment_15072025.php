...
Class fabric_shipment extends CI_Controller { 
   ...
   { 
	...
	function fabric_shipment_detail_table() {
		...
		$get_field['r5']['title'] = 'Fabric Code';
		$get_field['r8']['title'] = 'Invoice Number';
		$get_field['r9']['title'] = 'Unit Weight';
		$get_field['r11']['title'] = 'Unit Quantity';
		$get_field['r13']['title'] = 'Made In';
		$get_field['r14']['title'] = 'Note';
		$get_field['r15']['title'] = 'Colour';
		$get_field['r16']['title'] = 'Bale';
