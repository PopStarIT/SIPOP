...
Class fabric_receive extends CI_Controller { 
   ...
   { 
	...
	function receive_table() {
		...
		$get_field['r2']['title'] = 'Receive No';
		$get_field['r3']['title'] = 'Receive Date';
		$get_field['r5']['title'] = 'Shipment No';
		$get_field['r6']['title'] = 'Shipment date';
		$get_field['r7']['title'] = 'Receive Status';
	...
	function fabric_list_table() {
		...
		$get_field['r16']['title'] = 'Fabric Code';
	...
	function index() {
		...
		$nav_button[] = array('method_id' => 781148,'title' => 'Add From Shipment','btn'=>'btn-success', 'icon' => 'fa fa-plus', 'load' => 'fabric_receive/function_add');
