	 ...
	 function post_add_edit_detil_shipment(){
	  ...
	  function post_add_edit_detil_shipment_excel(){
		 ...
		 if ($table_colour) {
		  ...
		  //=============cek apakah status sudah approve masih belum diaktifkan ======================
		//   $fabric_id['fabric_shipment_id'] = $shipment_id;
		//   $table_fabric = $this->main->getData_pop('dbo.dt_fabric_shipment', null, $fabric_id, null, $order_colour, $limit_colour, $offset_colour);
			            ...
			            foreach($object->getWorksheetIterator() as $worksheet)
			           {
			         	   ...
			         	   for($row=3; $row<=$highestRow; $row++){
							   ...
							   //========== Memasukan kode barang fabric ===========
			                     ...
			                     $item_barang = $this->main->getData_pop('dbo.view_item_ecc', null, $where_item, null, $order_colour, $limit_colour, $offset_colour);
