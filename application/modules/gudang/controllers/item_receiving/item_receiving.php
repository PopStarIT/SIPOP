<?php if (! defined('BASEPATH')) exit('No direct script access allowed');
  set_time_limit(1800); // 1800 detik = 30 menit
  ini_set('memory_limit', '512M');
class item_receiving extends CI_Controller
{
	...
	function receive_table()
	{
		$view = 'view_fabric_warehouse_receive_new';
		$get_field = $this->ecc_library->get_field_pop($view);

		$get_field['r1']['hidden'] = true;
		$get_field['r2']['hidden'] = true;

		$get_field['r4']['title'] = 'Receive No';
		$get_field['r5']['title'] = 'Receive Date';
		
		$get_field['r7']['align'] = 'center';

		//$get_field['r2']['width'] = 160;
	...
	function receive_scan_table()
	{
		...
		$view = 'view_fabric_warehouse_receive_detail_no_urut';
		$get_field = $this->ecc_library->get_field_pop($view);
		...
		$get_field['r6']['title'] = 'COLOUR';
		$get_field['r7']['title'] = 'LOT';
		$get_field['r8']['title'] = 'BALE';
		$get_field['r9']['title'] = 'ROLL';
		$get_field['r10']['title'] = 'QTY';
		$get_field['r11']['title'] = 'QTY RECEIVE';
		$get_field['r12']['title'] = 'UNIT';
		...
		$get_field['act']['formatter'] = 'formatOperations_list_receive_gudang';
		$get_field['act']['width'] = 300;
		return $get_field;
	}
	function other_receive_scan_table()
	{
		$view = 'view_fabric_warehouse_receive_detail_other';
		$get_field = $this->ecc_library->get_field_pop($view);
		...
		//$get_field['r5']['hidden'] = 'quantity ordered';
		$get_field['r5']['hidden'] = 'true';

		$get_field['r6']['title'] = 'quantity received';
		$get_field['r6']['editable'] = true;
		$get_field['r7']['title'] = 'quantity custom';
		//$get_field['r8']['title'] = 'quantity invoiced';
		$get_field['r8']['hidden'] = true;
		$get_field['r9']['title'] = 'conversion';
		$get_field['r10']['title'] = 'ex rate';
		...
		$get_field['act']['search'] = false;
		$get_field['act']['sortable'] = false;
		$get_field['act']['formatter'] = 'formatOperations_list_receive_gudang_other';
		$get_field['act']['width'] = 300;
		return $get_field;
	}

	function receive_scan_tablexx()
	{
		...
		$get_field['r7']['title'] = 'Shipment No';
		$get_field['r8']['title'] = 'Purchase Order';
		$get_field['r9']['title'] = 'Fabric Code';
		$get_field['r10']['title'] = 'colour';
		$get_field['r11']['title'] = 'lot';
		$get_field['r12']['title'] = 'bale';
		$get_field['r13']['title'] = 'roll';
		$get_field['r14']['title'] = 'kgs';
		$get_field['r15']['title'] = 'yds';
	...
	function detail_receive_table()
	{
		...
		$get_field['r8']['title'] = 'Receive No';
		$get_field['r9']['title'] = 'Purchase Order';
		$get_field['r10']['title'] = 'Fabric Code';
		$get_field['r12']['title'] = 'Item Fabric';
		$get_field['r13']['title'] = 'Lot';
		$get_field['r14']['title'] = 'Bale';
		$get_field['r15']['title'] = 'Roll';
		//$get_field['r16']['title'] = 'Quantity';
		//$get_field['r17']['title'] = 'Unit';
    ...
    function table_report_receive()
	{
		$view = 'view_fabric_shipment_report_receive';
		$get_field = $this->ecc_library->get_field_pop($view);
	...
	{
		//$view = 'view_fabric_shipment_list_receive_new';
		$view = 'view_fabric_shipment_list_receive_baru';
		$get_field = $this->ecc_library->get_field_pop($view);
		...
		$get_field['r5']['title'] = 'Colour';
		$get_field['r6']['title'] = 'Lot';
		$get_field['r7']['title'] = 'Bale';
		$get_field['r8']['title'] = 'Roll';
		$get_field['r9']['title'] = 'Weight';
		$get_field['r10']['title'] = 'QTY';
		$get_field['r11']['title'] = 'Weight Unit';
		$get_field['r12']['title'] = 'QTY Unit';
		$get_field['r14']['title'] = 'item code';
		$get_field['r15']['title'] = 'Barcode Number';
	...
	function fabric_list_other_table()
	{
		$view = 'view_fabric_shipment_list_receive_other_terbaru';
		$get_field = $this->ecc_library->get_field_pop($view);
		...
		$get_field['r3']['title'] = 'ITEM CODE';
		$get_field['r4']['title'] = 'ITEM NAME';
		$get_field['r5']['title'] = 'QUANTITY';
		$get_field['r6']['title'] = 'CONVERSION';
		$get_field['r7']['title'] = 'UNIT PRICE';
		$get_field['r8']['title'] = 'EX RATE';
		$get_field['r9']['title'] = 'UNIT';
		$get_field['r10']['title'] = 'UNIT RECEIVE';
		...
		$get_field['act']['search'] = false;
		$get_field['act']['sortable'] = false;
		$get_field['act']['formatter'] = 'formatOperations_list_receive_other';
		$get_field['act']['width'] = 300;
	...
	{
		$view = 'view_custom_import_item_warehouse';
		$get_field = $this->ecc_library->get_field_pop($view);
		...
		//$get_field['act']['formatter'] = 'select';
		$get_field['act']['width'] = 300;
	...
	function index()
	{
		...
		$component['view_load'] = 'item_receiving/view';
		$component['view_load_form'] = 'item_receiving/form';
		$component['load_js'][] = 'item_receiving/view';
		$component['load_js'][] = 'item_receiving/form';

		$component['page_title'] = "Goods Receipt";

		$dashboard_table = array();

		$nav_button = array();
		
		//$nav_button[] = array('method_id' => 7811462, 'title' => 'Add From Shipment', 'btn' => 'btn-success', 'icon' => 'fa fa-plus', 'load' => 'fabric_receive/function_add_from_shipment');
		$nav_button[] = array('method_id' => 7811462, 'title' => 'Add From Shipment', 'btn' => 'btn-success', 'icon' => 'fa fa-plus', 'load' => 'item_receiving/function_add_from_shipment');
		$nav_button[] = array('method_id' => 7811449, 'title' => 'Edit', 'btn' => 'btn-warning', 'icon' => 'fa fa-pencil', 'load' => 'item_receiving/function_edit');
		$nav_button[] = array('method_id' => 781150, 'title' => 'Delete', 'btn' => 'btn-danger', 'icon' => 'fa fa-trash-o', 'load' => 'item_receiving/function_delete');
		$nav_button[] = array('method_id' => 781154, 'title' => 'Approve', 'btn' => 'btn-info', 'icon' => 'fa fa-thumbs-up', 'load' => 'item_receiving/function_approve');
		$nav_button[] = array('method_id' => 781155, 'title' => 'Cancel Approve', 'btn' => 'btn-danger', 'icon' => 'fa fa-thumbs-down', 'load' => 'item_receiving/function_cancel_approve');
		$nav_button[] = array('method_id' => 7811473, 'title' => 'Cetak Report', 'btn' => 'btn-warning', 'icon' => 'fa fa-print', 'load' => 'item_receiving/function_print');
		


		$field = $this->receive_table();
		$field_receive_scan = $this->receive_scan_table();
		$field_detail_receive = $this->detail_receive_table();
		$field_fabric_list_table = $this->fabric_list_table();
		$field_custom_item = $this->good_receive_custom_table();

        $field_other_receive_scan = $this->other_receive_scan_table();
		$field_fabric_list_other_table = $this->fabric_list_other_table();
		
		$field_report_receive = $this->table_report_receive();
		...
		$dashboard_table['field_fabric_list_other_recive'] = $field_fabric_list_other_table;
		$dashboard_table['field_loaddata_list_other_recive'] = 'loaddata_other';
		$dashboard_table['field_other_receive_scan'] = $field_other_receive_scan;
		$dashboard_table['field_loaddata_other_scan'] = 'loaddata_detil_other_scan';
		
		$dashboard_table['field_report_receive_table'] = $field_report_receive;
		$dashboard_table['field_loaddata_report_receive_table'] = 'loaddata_report_receive';
		
		
		
		$dashboard_table['caption'] = '.:: Goods Receiving ::.';
	...
	function loaddata_report_receive()
	{
		...
		//$kode_kontainer2 = isset($_REQUEST['frm_nomor_kontainer']) ? $_REQUEST['frm_nomor_kontainer'] :'0';
		$kode_kontainer = isset($_REQUEST['kode_kontainer']) ? $_REQUEST['kode_kontainer'] :'0';
		//var_dump($fabric_warehouse_receive_id);die();
		
		$view = 'view_fabric_shipment_report_receive';
		//$view = 'view_fabric_shipment_list_receive_baru2';
		$field = $this->table_report_receive();
	...
	function loaddata_other()
	{
		...
		//$view = 'view_fabric_shipment_list_receive_other_new';
		$view = 'view_fabric_shipment_list_receive_other_terbaru';
		$field = $this->fabric_list_other_table();
	...
	function loaddata_detil_scan()
	{
		...
		//$kode_kontainer2 = isset($_REQUEST['frm_nomor_kontainer']) ? $_REQUEST['frm_nomor_kontainer'] :'0';
		$kode_kontainer = isset($_REQUEST['kode_kontainer']) ? $_REQUEST['kode_kontainer'] :'0';
		//$no_kontainer1 = isset($_REQUEST['no_kontainer1']) ? $_REQUEST['no_kontainer1'] :'0';
         
		//var_dump ($_REQUEST);die();
		//$view = 'view_fabric_warehouse_receive_detail_baru';
		$view = 'view_fabric_warehouse_receive_detail_no_urut';
		...
		$extra_param = array();
		 if($kode_kontainer != '0' &&  $kode_kontainer != 'AZ'){
		//	 var_dump('masuk');
			$extra_param['where']['1']['field'] = 'r16';
		    $extra_param['where']['1']['data'] = $kode_kontainer;
			
		    $extra_param['idx'] = 'r17';
		    $extra_param['sord'] = 'desc';
			
			// Paksa request seolah-olah jqGrid meminta hanya 10 baris
            //$_POST['limit'] = 10; 
           // $_POST['page'] = 1;
		   
	//		$use_limit = $this->input->post('use_limit');
	//		if ($use_limit == 0) {
    //             // Jika checkbox tidak dicentang, paksa limit 10
    //           $_POST['rows'] = 10;
    //           $_POST['page'] = 1;
    //         }else{
	//		   $_POST['rows'] = 10;
	...
	//	 }
		...
		$extra_param['methodid'] = $methodid;
		$loaddata = $this->ecc_library->get_field_data_pop_baru($view, $field, $extra_param);
	
		//$jml_receive= $this->main->getCountReceive($fabric_warehouse_receive_id);
		//$extra_param['total_receive'] =$jml_receive['total_receive'];
		//$extra_param['diterima'] =$jml_receive['diterima'];
		//$loaddata = $this->ecc_library->get_field_data_pop_receive($view, $field, $extra_param);
		//$loaddata['total_receive']  =isset($loaddata['rows'][0]['total_receive']) ? $loaddata['rows'][0]['total_receive'] : 0;
        // $total_diterima =isset($loaddata['rows'][0]['diterima']) ? $loaddata['rows'][0]['diterima'] : 0;
		//var_dump($loaddata);
		      
		echo $loaddata;
	}
	function loaddata_detil_other_scan()
	{
		$this->authentication->plainlayout();
		...
		$view = 'view_fabric_warehouse_receive_detail_other';
		$field = $this->other_receive_scan_table();
	...
	function loaddata_fabric_detail_receive()
	{
		$this->authentication->plainlayout();
	...
	function loaddata_custom_item()
	{
		...
		$fabric_warehouse_receive_detail_id = isset($_REQUEST['fabric_warehouse_receive_detail_id']) ? $_REQUEST['fabric_warehouse_receive_detail_id'] : '';
		...
		$extra_param = array();
		//$extra_param['methodidx'] = $methodid;
		//var_dump($grn_detail_id);die();
		if ($grn_detail_id) {
			//$view = 'view_grn_detail_custom';
			$view = 'view_grn_detail_custom_warehouse';
			$extra_param['where']['0']['field'] = 'r17';
    ...
    try {
		  $id_receive = isset($_POST['fabric_warehouse_receive_id']) ? $_POST['fabric_warehouse_receive_id'] : false;
          $user_id = $this->session->userdata('user_id');
          $ip_address = $this->input->ip_address();
		
       
        if (empty($id_receive)) throw new Exception("ID Receive tidak ditemukan.");

        // 1. Ambil semua detail yang SUDAH di-receive (status = 1) tapi BELUM di-approve
        // Kita cek dulu apakah ada datanya
        $check_detail = $this->db_pop->where('fabric_warehouse_receive_id', $id_receive)
                                     ->where('status_receive_detail', 1)
                                     ->get('dbo.dt_fabric_warehouse_receive_detail')
                                     ->num_rows();

        if ($check_detail == 0) {
            throw new Exception("Tidak ada detail barang yang siap untuk diapprove (Status Detail harus 1).");
        }

        // 2. Susun XML Header (Hanya kirim ID utama)
        $xml = "<param>";
        $xml .= "<field>";
        $xml .= "<fabric_warehouse_receive_id>$id_receive</fabric_warehouse_receive_id>";
        $xml .= "<data_by>$user_id</data_by>";
        $xml .= "<ip_address>$ip_address</ip_address>";
        $xml .= "</field>";
        $xml .= "</param>";

        // 3. Panggil Function Store Procedure Approve
        // Fungsi ini di database sudah kita optimalkan menggunakan CTE (Bulk Insert)
        $query = $this->db_pop->query("SELECT * FROM dbo.sp_fabric_receive_approve_sipop(?)", array($xml));
        
        if (!$query || !$query->row()) {
            throw new Exception("Database tidak merespon saat proses Approve.");
        }

        $res = $query->row();

        // 4. Cek Hasil Response dari Database
        if ($res->sts_no !== '0000') {
            $error_msg = (isset($res->sts_des) && $res->sts_des !== '') ? $res->sts_des : 'Error Unknown';
            throw new Exception("Gagal Approve: " . $error_msg);
        }

        $res_json = json_decode($res->result);
        $total_approved = isset($res_json->total_diApprove) ? $res_json->total_diApprove : 0;

        $this->db_pop->trans_commit();
        echo json_encode([
            'status' => 'success', 
            'message' => "Berhasil Approve $total_approved data.",
            'id' => $id_receive
        ]);
	...
	function approve_sebelumnya()
	{
        ...
        $data_by = $this->session->userdata('user_id');
        $ip_address = $this->input->ip_address();
	    ...
	    $xmlParam = $this->rpc_service->formatToXml_field($field);

          // 2. Mulai Transaksi di DB_POP
           $this->db_pop->trans_begin();

       try {
		
           $sql = "SELECT * FROM dbo.sp_fabric_receive_approve_sipop(?)";
           $query = $this->db_pop->query($sql, array($xmlParam));
        
           //if (!$query) {
           //     throw new Exception("Query Error: " . $this->db_pop->_error_message());
           //  }
		   
		   if (!$query) {
              // Gunakan db->error() untuk CI3 modern
               $error = $this->db_pop->error();
               throw new Exception("Query Error: " . $error['message']);
            }

             $row = $query->row();

             // 3. Cek hasil dari Function
           if ($row && $row->sts_no === '0000') {
                $this->db_pop->trans_commit(); // SIMPAN PERUBAHAN
            
              $res_json = json_decode($row->result);
                echo json_encode([
                  'status'  => 'success',
                  'message' => $res_json->total_diApprove . " data berhasil di Approve.",
                  'data'    => $res_json
                ]);
           } else {
               // Jika sts_no bukan 0000 (Gagal logis)
			   $this->db_pop->trans_rollback();

               // Cara tradisional yang aman untuk semua versi PHP
             	$message = (isset($row->sts_des) && $row->sts_des != '') ? $row->sts_des : 'Gagal memproses data.';
            ...
            // 4. Rollback Total jika terjadi error fatal / exception
              $this->db_pop->trans_rollback();
   ...
   function approve_old()
	{
		...
		if (count($_POST) > 0) {
			...
			if ($fabric_warehouse_receive_id) {
				$this->rpc_service->setSP("dbo.sp_fabric_receive_approve_baru");
				$this->rpc_service->addField('fabric_warehouse_receive_id', $fabric_warehouse_receive_id);
			}
           
		    $tanggal=date("Y-m-d H:i:s.u");
			$data=$this->main_sipop->cari_fabric_receive_header($fabric_warehouse_receive_id);
			$hasil=$this->main->getData_pop("dbo.remote_bc_in_header()",null,array("bc_in_header_id"=>$data[0]['bc_in_header_id']));
			//var_dump($hasil[0][);die();
			$data_gr_header =array('grn_no'=>$data[0]['fabric_warehouse_receive_no'] 
	                               ,'grn_date'=>$data[0]['fabric_warehouse_receive_date']
	                               ...
	                               ,'bc_in_header_id'  =>$data[0]['bc_in_header_id']
	                               ,'purchase_order_id' =>$data[0]['purchase_order_id']
	                               ,'no_surat_jalan' =>$data[0]['no_surat_jalan']
	                               ,'tgl_surat_jalan' =>$data[0]['tgl_surat_jalan']
	                               ,'currencies_id' =>$hasil[0]['currencies_id']
	                               ,'vendor_partner_id' =>$data[0]['vendor_partner_id']);
					    
			// $hasil= $this->main->insert3("dbo.dt_grn",$data_gr_header);
			// $id=$hasil['id_data'];
			// if ($hasil["pesan"]){
				$result = $this->rpc_service->resultJSON_pop();
			// }
			// var_dump($hasil['id_data'];);die();
	...
	function delete()
	{
		...
		if (count($_POST) > 0) {
			...
			if ($fabric_receive_id) {
				...
				$this->rpc_service->setSP("dbo.sp_fabric_receive_delete_combined_baru");
	...
	function post_add_edit_scan()
	{
		...
		$kode_kontainer = isset($_POST['kode_kontainer']) ? $_POST['kode_kontainer'] : '';
		...
		if (count($_POST) > 0) {
			...
			if ($q == 0) {
				...
				$this->rpc_service->setSP("dbo.sp_fabric_receive_scan_add_manual_baru");
				...
				$this->rpc_service->setSP("dbo.sp_fabric_receive_scan_insert_barcode");
				$this->rpc_service->addField('fabric_shipment_list_id', $fabric_shipment_list_id);
				$this->rpc_service->addField('code_barcode', $code_barcode);
			} elseif ($q == 3) {
				$this->rpc_service->setSP("dbo.sp_fabric_receive_scan_add_no_direct_baru");
				$this->rpc_service->addField('code_barcode', $code_barcode);
			} else {
				//$this->rpc_service->setSP("dbo.sp_fabric_receive_scan_add");
				$this->rpc_service->setSP("dbo.sp_fabric_receive_scan_add_combined_baru");
				$this->rpc_service->addField('code_barcode', $code_barcode);
				//var_dump($fabric_warehouse_receive_id);die();
			}
			...
			$this->rpc_service->addField('kode_kontainer', $kode_kontainer);
				...
				if (isset($result['valid'])) {
					if ($result['valid']) {
						if (isset($result['data'])) {
							...
							$return['purchase_order_no'] = $data_result['purchase_order_no'];
							$return['purchase_order_date'] = $data_result['purchase_order_date'];
							$return['total_lot'] = $data_result['total_lot'];
							$return['total_roll'] = $data_result['total_roll'];
							$return['total_diterima'] = $data_result['total_diterima'];
	...
	function post_add_edit_scan_15042026()
	 {
		$this->load->model('main');
		$this->authentication->plainlayout();
		$parameter = array();
		...
		//$code=0;
		//if (strlen($code_barcode) > 12){
		//	$code=1;
		//}

		//var_dump($q.' # '.$code_barcode.' - '.strlen($code_barcode)); die();
		//var_dump($code.' - '.strlen($code_barcode));
		$user_id = $this->session->userdata('user_id');
	...
	function post_add_edit_cadangan(){
		$this->load->model('main');
		$this->db_pop = $this->load->database('pop', TRUE);
	    $fabric_warehouse_receive_id = isset($_POST['fabric_warehouse_receive_id']) ? $_POST['fabric_warehouse_receive_id'] : '';
		$fabric_warehouse_receive_no = isset($_POST['fabric_warehouse_receive_no']) ? $_POST['fabric_warehouse_receive_no'] : '';
		$fabric_warehouse_receive_date = isset($_POST['fabric_warehouse_receive_date']) ? $_POST['fabric_warehouse_receive_date'] : '';
		$fabric_shipment_id = isset($_POST['fabric_shipment_id']) ? $_POST['fabric_shipment_id'] : '';

		$fabric_warehouse_receive_delivery_no = isset($_POST['fabric_warehouse_receive_delivery_no']) ? $_POST['fabric_warehouse_receive_delivery_no'] : '';
		$fabric_warehouse_receive_delivery_date = isset($_POST['fabric_warehouse_receive_delivery_date']) ? $_POST['fabric_warehouse_receive_delivery_date'] : '';

		$fabric_warehouse_receive_type_id = isset($_POST['fabric_warehouse_receive_type_id']) ? $_POST['fabric_warehouse_receive_type_id'] : '';
		$grn_type_id_ecc = isset($_POST['grn_type_id_ecc']) ? $_POST['grn_type_id_ecc'] : '';
		...
		$return['status_code'] = 501;
		$return['message'] = "Internal Server Error";
		//var_dump($fabric_warehouse_receive_id." partner_id=".$partner_id);
		//die();
		
			if ($fabric_warehouse_receive_id) {
				// $this->rpc_service->setSP("dbo.sp_fabric_receive_add_combined_baru_backup");
				$this->rpc_service->setSP("dbo.sp_fabric_receive_edit_baru");
				$this->rpc_service->addField('fabric_warehouse_receive_id', $fabric_warehouse_receive_id);
				$this->rpc_service->addField('grn_id', $grn_id);
				
			} else {
				
				//  $this->rpc_service->setSP("dbo.sp_fabric_receive_add_combined_baru");
		    $headerInfo = [
                 'fabric_warehouse_receive_no'   =>  $fabric_warehouse_receive_no,
                  'fabric_warehouse_receive_date' => $fabric_warehouse_receive_date,
                  'grn_no'                        => $grn_no,
                  'grn_date'                      => $fabric_warehouse_receive_date,
                  'fabric_shipment_id'            => $fabric_shipment_id, // Sesuaikan ID shipmentnya
                  'data_by'                       => $user_id,
                 // 'ip_address'                    => //$this->input->ip_address(),
                      // ... tambahkan field lain yang ada di extract_value fungsi SQL ...
             ];
        ...
        while ($statusProcessing) {
               // 1. Ambil data yang BELUM diproses saja
        //  $items = $this->db_pop->select("
        //         SELECT * FROM dbo.dt_fabric_shipment_list 
        //         WHERE is_processed = FALSE AND fabric_shipment_id = $fabric_shipment_id
        //        LIMIT $batchSize
        //    ");
			 $query_sumber = $this->db_pop->query("SELECT * FROM dbo.dt_fabric_shipment_list 
                  WHERE is_processed = FALSE AND fabric_shipment_id = $fabric_shipment_id
                 LIMIT $batchSize");
             $items = $query_sumber->result_array();

         if (count($items) > 0) {
			
			     // $xmlParam = $this->formatToXml($items);
				  $xmlParam = $this->formatToXml($headerInfo, $items);
                  // $xmlParam = formatToXml($items); // Fungsi pembantu untuk konversi ke XML
          $this->db_pop->trans_begin();
           try {
              // $this->db_pop->beginTransaction();

              // 2. Jalankan Fungsi Utama
			  $sql = "SELECT * FROM dbo.sp_fabric_receive_add_combined_baru_backup(?)";
			  $query1 = $this->db_pop->query($sql, array($xmlParam));
              //$result = $this->db->select("SELECT * FROM dbo.sp_fabric_receive_add_combined_baru(?)", [$xmlParam]);
              $result = $query1->result();
            //if ($result[0]->sts_no === '0000') {
			 if (!empty($result) && $result[0]->sts_no === '0000'){
                 // 3. Jika sukses, UPDATE flag di tabel sumber agar tidak diambil lagi di loop berikutnya
                $ids = array_column($items, 'fabric_shipment_list_id');
                $idString = implode(',', $ids);
                
           //     $this->db_pop->statement("
           //         UPDATE dbo.dt_fabric_shipment_list 
           //         SET is_processed = TRUE 
           //         WHERE fabric_shipment_list_id IN ($idString)
           //     ");
				
				$sql2 = "UPDATE dbo.dt_fabric_shipment_list 
                        SET is_processed = TRUE 
                        WHERE fabric_shipment_list_id IN ($idString)";
                 $this->db_pop->query($sql2);

                $this->db_pop->trans_commit();
                //$this->db_pop->commit();
                echo "Batch Berhasil. " . count($items) . " data diproses.\n";
				//$return['valid'] = true;
		        //$return['status_code'] = '001';
		        //$return['message'] = "Gagal di tengah jalan". $result[0]->sts_des;
				
             } else {
				$this->db_pop->trans_rollback(); 
                //$this->db_pop->rollBack();
                die("Gagal di tengah jalan: " . $result[0]->sts_des);
				$return['valid'] = false;
		        $return['status_code'] = '001';
		        $return['message'] = "Gagal di tengah jalan". $result[0]->sts_des;
             }
              ...
              die("Error System: " . $e->getMessage());
			    $return['valid'] = false;
		        $return['status_code'] = '001';
		        $return['message'] = "Error System: ". $e->getMessage();
        ...
        $statusProcessing = false; // Berhenti jika data is_processed=FALSE sudah habis
       // echo "Semua data selesai diproses.";
		$return['valid'] = true;
		$return['status_code'] = '00';
        $return['message'] = "Semua data selesai diproses.";
       }
      }
	...
	function post_add_edit(){
		...
		//die();
			...
			$this->rpc_service->addField('fabric_warehouse_receive_no', $fabric_warehouse_receive_no);
			$this->rpc_service->addField('fabric_warehouse_receive_date', $fabric_warehouse_receive_date);
			$this->rpc_service->addField('grn_no', $grn_no);
			$this->rpc_service->addField('grn_date', $fabric_warehouse_receive_date);
			$this->rpc_service->addField('fabric_shipment_id', $fabric_shipment_id);
			$this->rpc_service->addField('fabric_warehouse_receive_type_id', $fabric_warehouse_receive_type_id);
			$this->rpc_service->addField('grn_type_id', $grn_type_id_ecc);
			...
			$this->rpc_service->addField('no_surat_jalan', $fabric_warehouse_receive_delivery_no);
			$this->rpc_service->addField('tgl_surat_jalan', $fabric_warehouse_receive_delivery_date);
			...
			if (isset($result)) {
				if (isset($result['valid'])) {
					if ($result['valid']) {
						if (isset($result['data'])) {
							...
							$return['message'] = $result['des'];
							$return['fabric_shipment_id'] = $data_result['fabric_shipment_id'];
							$return['fabric_warehouse_receive_id'] = $data_result['fabric_warehouse_receive_id'];
							$return['bc_in_header_id'] = $data_result['bc_in_header_id'];
							$return['warehouse_id'] = $data_result['warehouse_id'];
							$return['purchase_performa_id'] = $data_result['purchase_performa_id'];
							$return['grn_id'] = $data_result['grn_id'];
						}
					} else {
						$return['status_code'] = $result['no'];
			  ...
			  echo json_encode($return);
			   ...
			   //  $this->rpc_service->setSP("dbo.sp_fabric_receive_add_combined_baru");
				 $fabric_shipment_id = $this->input->post('fabric_shipment_id');
                 $batchSize = 200; // Kecilkan batch agar dblink tidak timeout (misal 200)
			//	var_dump($fabric_shipment_id);die();
                 ...
                 'fabric_warehouse_receive_no'   => $fabric_warehouse_receive_no,
				  ...
				  'fabric_warehouse_receive_type_id' => $fabric_warehouse_receive_type_id,
				  'grn_type_id'                  => $grn_type_id_ecc,
				  'bc_in_header_id'               => $bc_in_header_id,
				  'warehouse_id'                  => $warehouse_id,
				  'partner_id'                    => $partner_id,
				  'no_surat_jalan'                => $fabric_warehouse_receive_delivery_no,
				  'tgl_surat_jalan'               => $fabric_warehouse_receive_delivery_date,
                  'data_by'                       => $user_id
          ...
          //$batchSize = 200;
          //   $statusProcessing = true;
               $query_sumber = $this->db_pop->query("select a.fabric_shipment_list_id,a.fabric_shipment_detail_id,a.item_id,a.fabric_shipment_list_colour,a.fabric_shipment_list_lot,a.fabric_shipment_list_quantity
	,a.fabric_shipment_list_code,a.uom_qty,a.purchase_order_detail_id,a.purchase_order_warehouse_detail,a.fabric_shipment_list_weight,a.uom_weight,COALESCE(a.receive_status,0) as receive_status
	,d.bc_in_header_id,d.bc_in_barang_id,e.subcon_in_detail_id,e.quantity_custom,e.conversion,e.unit_price,e.ex_rate,e.this_cmt,e.this_cmt_service,e.uom_id,c.purchase_order_no,a.is_processed
	from dbo.dt_fabric_shipment_list a
	left join dbo.dt_fabric_shipment_detail b ON a.fabric_shipment_detail_id = b.fabric_shipment_detail_id
	left join dbo.view_purchase_order_ecc c ON b.purchase_order_id = c.purchase_order_id
	left join dbo.view_custom_import_detail_ecc_gudang d ON a.purchase_order_detail_id = d.purchase_order_detail_id
	LEFT JOIN public.dt_bc_in_barang e ON d.bc_in_barang_id = e.bc_in_barang_id 
	 where a.is_processed = FALSE AND a.fabric_shipment_id = $fabric_shipment_id AND d.bc_in_header_id = $bc_in_header_id
	order by a.fabric_shipment_list_id LIMIT $batchSize");
             $items = $query_sumber->result_array();
    ...
    //                       
	//					  $ids = array_column($items, 'fabric_shipment_list_id');
	//				      $this->db_pop->where_in('fabric_shipment_list_id', $ids);
    //                      $this->db_pop->update('dbo.dt_fabric_shipment_list', ['is_processed' => TRUE]);
    //         
	//		             $this->db_pop->trans_commit();
	//	                 echo json_encode([
    //                         'status' => 'continue', 
    //                          'message' => count($items) . " data diproses...",
	...
	//					
	//					 $this->db_pop->trans_rollback();
    //                     echo json_encode(['status' => 'error', 'message' => $result[0]->sts_des]);
	//					
	//				}
	//			}
	//		}
              ...
              // 2. Jalankan Fungsi Utama
			//  $sql = "SELECT * FROM dbo.sp_fabric_receive_add_combined_baru(?)";
			 $sql = "SELECT * FROM dbo.sp_fabric_receive_add_terbaru(?)";
			  $query1 = $this->db_pop->query($sql, array($xmlParam));
              //$result = $this->db->select("SELECT * FROM dbo.sp_fabric_receive_add_combined_baru(?)", [$xmlParam]);
              $result = $query1->result();
			// var_dump( $result);die();
            //if ($result[0]->sts_no === '0000') {
			 if (!empty($result) && $result[0]->sts_no === '0000'){
                 ...
                 $ids = array_column($items, 'fabric_shipment_list_id');
                 // $this->db_pop->where_in('fabric_shipment_list_id', $ids);
                 // $this->db_pop->update('dbo.dt_fabric_shipment_list', ['is_processed' => 1]);
       ...
       // sleep(5); 
			...
			// Beritahu Javascript bahwa semua data sudah habis
        echo json_encode(['status' => 'done', 'message' => 'Semua data selesai diproses.']);
        $statusProcessing = false; // Berhenti jika data is_processed=FALSE sudah habis
	...
	function post_add_edit_receive_all_old()
	 {
		$this->load->model('main');
		$this->authentication->plainlayout();
		$parameter = array();
		...
		$field = ['fabric_warehouse_receive_id' => $fabric_warehouse_receive_id,'data_by' => $user_id ];
		$xmlParam = $this->rpc_service->formatToXml_field($field); 
		//var_dump($xmlParam);die();	
		$this->db_pop->trans_start(); // Memulai Transaksi
		
		$sql = "SELECT * FROM dbo.sp_fabric_receive_manual_all(?)";
	    $query1 = $this->db_pop->query($sql, array($xmlParam));
        $result = $query1->result();
	//	$result = [];
    //    $obj = new stdClass();
    //    $obj->sts_no = '0000';
	//	$obj->total_diupdate = '300';
   //     $result[0] = $obj;
		 ...
		 if (!empty($result) && $result[0]->sts_no === '0000'){
		        ...
		        echo json_encode([
                    'status' => 'sukses', 
                    'message' =>  $result[0]->total_diupdate. " data diproses...",
                    'processed' => $result[0]->total_diupdate
                ]);
	 ...
	 public function post_add_edit_receive_all()
      {
		    $this->db_pop->trans_begin();
      try {
          $id_receive = $this->input->post('fabric_warehouse_receive_id');
          $user_id = $this->session->userdata('user_id');

           // 1. Ambil semua detail yang statusnya 0 (Belum Receive)
           $details = $this->db_pop->where('fabric_warehouse_receive_id', $id_receive)
                                ->where('status_receive_detail', 0)
                                ->order_by('fabric_warehouse_receive_detail_id', 'ASC')
                                ->get('dbo.dt_fabric_warehouse_receive_detail')
                                ->result_array();

          if (empty($details)) throw new Exception("Tidak ada data untuk diproses.");

            $kode_kontainer = ['A','B','C','D','E','F','G','H','I','J','K','L','M','N','O','P'];
            $batch_size = 300;
            $total_processed = 0;

           // 2. Loop per 300 data (Chunking)
            $chunks = array_chunk($details, $batch_size);
            foreach ($chunks as $index => $batch) {
                 $current_kontainer = isset($kode_kontainer[$index]) ? $kode_kontainer[$index] : end($kode_kontainer);
            
            // Susun XML untuk Batch ini
            $xml = "<param>";
            $xml .= "<field>";
            $xml .= "<fabric_warehouse_receive_id>$id_receive</fabric_warehouse_receive_id>";
            $xml .= "<data_by>$user_id</data_by>";
            $xml .= "<ip_address>".$this->input->ip_address()."</ip_address>";
            $xml .= "</field>";
            $xml .= "<items>";
            foreach ($batch as $item) {
                // Tentukan qty (Logic dipindah ke PHP agar SQL lebih ringan)
                $qty = ($item['shipment_quantity'] > 0) ? $item['shipment_quantity'] : $item['shipment_weight'];
                
                $xml .= "<item>";
                $xml .= "<detail_id>".$item['fabric_warehouse_receive_detail_id']."</detail_id>";
                $xml .= "<kode_kontainer>$current_kontainer</kode_kontainer>";
                $xml .= "<qty_received>$qty</qty_received>";
                $xml .= "<shipment_list_id>".$item['fabric_shipment_list_id']."</shipment_list_id>";
                $xml .= "</item>";
              }
            $xml .= "</items>";
            $xml .= "</param>";

            // 3. Panggil Function DB
            $query = $this->db_pop->query("SELECT * FROM dbo.sp_fabric_receive_manual_all_sipop(?)", array($xml));
            $res = $query->row();

           if ($res->sts_no !== '0000') {
                // Pengganti operator ?? untuk PHP versi lama
              $error_message = (isset($res->sts_des) && $res->sts_des !== '') ? $res->sts_des : 'Error Unknown';
    
              throw new Exception("Gagal di Batch " . ($index + 1) . ": " . $error_message);
           }
            
            $res_json = json_decode($res->result);
            $total_processed += $res_json->total_diupdate;
        }

        $this->db_pop->trans_commit();
        echo json_encode(['status' => 'success', 'message' => "$total_processed data diproses."]);
	 ...
	 public function post_add_edit_receive_all_loading_lama()
     {
		 set_time_limit(300);
         $this->load->model('main');
		 $this->db_pop = $this->load->database('pop', TRUE);
        ...
        $ip_address = $this->input->ip_address();
           ...
           // 1. Buat parameter XML
        $field = [
           'fabric_warehouse_receive_id' => $id_receive,
            'data_by'    => $user_id,
           'ip_address' => $ip_address
         ];
       $xmlParam = $this->rpc_service->formatToXml_field($field);
       ...
       try {
           $sql = "SELECT * FROM dbo.sp_fabric_receive_manual_all_new(?)";
           $query = $this->db_pop->query($sql, array($xmlParam));
           ...
           if ($row && $row->sts_no === '0000') {
              ...
              $res_json = json_decode($row->result);
                echo json_encode([
                  'status'  => 'success',
                  'message' => $res_json->total_diupdate . " data berhasil di-receive.",
                  'data'    => $res_json
                ]);
           } else {
               // Jika sts_no bukan 0000 (Gagal logis)
...
private function formatToXml_old($items) {
    ...
    foreach ($items as $item) {
        ...
        foreach ($item as $key => $value) {
            // Mengamankan karakter khusus agar XML tidak rusak
            $safe_value = htmlspecialchars($value, ENT_XML1, 'UTF-8');
            $xml .= "<$key>$safe_value</$key>";
        }
        $xml .= '</field>';
    }
    ...
    return $xml;
       ...
       private function formatToXml($header, $items) {
          $xml = '<?xml version="1.0" encoding="UTF-8"?>';
          $xml .= '<param>';
          $xml .= '<field>';
          
          // 1. Masukkan data Header (Informasi Utama)
          foreach ($header as $key => $value) {
              $safe_value = htmlspecialchars($value, ENT_XML1, 'UTF-8');
              $xml .= "<$key>$safe_value</$key>";
          }
          
          // 2. Masukkan data Items (Detail Barcode/Kain)
          // Sesuai dengan cursor di fungsi SQL kamu
          foreach ($items as $item) {
              $xml .= '<item>';
              foreach ($item as $key => $value) {
                  $safe_value = htmlspecialchars($value, ENT_XML1, 'UTF-8');
	...
	function post_add_edit_17042026()
	{
		...
		if (count($_POST) > 0) {
			if ($fabric_warehouse_receive_id) {
				...
				//$this->rpc_service->setSP("dbo.sp_fabric_receive_add");
				//$this->rpc_service->setSP("dbo.sp_fabric_receive_add_combined");
				  $this->rpc_service->setSP("dbo.sp_fabric_receive_add_combined_baru");
			}
	...
	function add_edit_temp_receive()
	{
		...
		if ($fabric_warehouse_receive_detail_id != '') {
			if ($q == 1) {
				...
				$this->rpc_service->setSP("dbo.sp_fabric_receive_edit2");
	...
	function add_edit_temp_receive_other()
	{
		$this->load->model('main');
		$this->authentication->plainlayout();
		//$parameter = array();
		...
		if ($fabric_warehouse_receive_detail_id != '') {
			if ($q == 1) {
				...
				$this->rpc_service->setSP("dbo.sp_fabric_receive_edit2_other");
				$this->rpc_service->addField('note', $note);
				$this->rpc_service->addField('quantity_received', str_replace(',', '.', $quantity_received));
				$this->rpc_service->addField('fabric_warehouse_receive_detail_id', $fabric_warehouse_receive_detail_id);
			}
	...
	function cancel_receive_scan()
	{
		...
		if ($fabric_warehouse_receive_detail_id != '') {
			...
			$this->rpc_service->setSP("dbo.sp_fabric_cancel_receive_scan_baru");
			$this->rpc_service->addField('fabric_warehouse_receive_detail_id', $fabric_warehouse_receive_detail_id);
	...
	function cancel_receive_scan_other()
	{
		$this->load->model('main');
		$this->authentication->plainlayout();
		...
		if ($fabric_warehouse_receive_detail_id != '') {
			...
			$this->rpc_service->setSP("dbo.sp_fabric_cancel_receive_scan_other");
			$this->rpc_service->addField('fabric_warehouse_receive_detail_id', $fabric_warehouse_receive_detail_id);
	...
	function post_add_edit_receive()
	{
		$this->load->model('main');
		$this->authentication->plainlayout();
		$return = array();
		...
		$shipment_item_code = isset($_POST['shipment_item_code']) ? $_POST['shipment_item_code'] : '';
		$barcode = isset($_POST['barcode']) ? $_POST['barcode'] : '';
		$colour = isset($_POST['colour']) ? $_POST['colour'] : '';
		$purchase_order_id = isset($_POST['po_no']) ? $_POST['po_no'] : '';
		$item_code = isset($_POST['mdl_shipment_code']) ? $_POST['mdl_shipment_code'] : '';
		$item_id = isset($_POST['item_id']) ? $_POST['item_id'] : '';
		
		$list_quantity = isset($_POST['list_quantity']) ? $_POST['list_quantity'] : '';
		$list_weight = isset($_POST['list_weight']) ? $_POST['list_weight'] : '';
		$list_lot = isset($_POST['list_lot']) ? $_POST['list_lot'] : '';
		$list_roll = isset($_POST['list_roll']) ? $_POST['list_roll'] : '';
		$list_bale = isset($_POST['list_bale']) ? $_POST['list_bale'] : '';
		...
		//var_dump('hasil '.$purchase_order_detail_id.' DAN '.$purchase_order_id);die();
		
		$cek = $this->main->getData_pop("public.dt_mst_item", null, array("item_id" => $item_id));
		$item_base_id = $cek[0]['item_base_id'];
		$uom_id = $cek[0]['uom_id'];
						
		if ($fabric_shipment_list_id) {
			...
			'fabric_shipment_list_quantity' => $list_quantity,
			'uom_weight'=>75,
			'uom_qty'=>179,
			'item_id' => $item_id,
			'fabric_shipment_list_code' => $barcode,
			'receive_status'=> 0,
			'uom_received'=>$uom_id,
			'item_base_id'=>$item_base_id
		      ...
		      $data_receive_detail = array(
			         'item_id' =>$item_id,
			         'fabric_shipment_list_code' =>$barcode,
			         'shipment_weight' =>$list_weight, 
			         'shipment_quantity' =>$list_quantity,
			         'fabric_shipment_id' =>$fabric_shipment_id,
			         'fabric_shipment_detail_id' =>$fabric_shipment_detail_id,
			      );
		
			$where = array('fabric_shipment_list_id' => $fabric_shipment_list_id);
		    $this->main->update_pop('dbo.dt_fabric_shipment_list', $data_detail_shipment, $where);
			
			$where2 = array('fabric_shipment_list_id' => $fabric_shipment_list_id);
		    $this->main->update_pop('dbo.dt_fabric_warehouse_receive_detail', $data_receive_detail, $where2);
			...
			$hasil = $this->main->insert_pop2("dbo.dt_fabric_shipment_list", $data_detail_shipment);
			//$hasil['pesan'] = true;
			//$hasil['id_data'] =29321;
			if ($hasil['pesan']) {
				$fabric_shipment_list_id = $hasil['id_data'];
				
			//Mencari data di table receive
		   $dt_receive = $this->main->getData_pop("dbo.dt_fabric_warehouse_receive", null, array("fabric_shipment_id" => $fabric_shipment_id));
		   $fabric_warehouse_receive_id = $dt_receive[0]['fabric_warehouse_receive_id'];
		   $bc_in_header_id = $dt_receive[0]['bc_in_header_id'];
		   $grn_id = $dt_receive[0]['grn_id'];	
		   
		   // $dt_v_import = $this->main->getData_field_pop("dbo.view_custom_import_detail_ecc_gudang", null, array("purchase_order_detail_id" => $purchase_order_detail_id),$pilihan);
		  $table='dbo.view_custom_import_detail_ecc_gudang a';
		  $fields = ['a.bc_in_barang_id','a.purchase_performa_detail_id', 'a.subcon_in_detail_id','a.quantity','a.conversion',
		  'a.item_id','a.uom_id','a.unit_price','a.ex_rate','b.this_cmt','b.this_cmt_service'];
		  $dataJoin = [ 'public.dt_bc_in_barang b' => 'a.bc_in_barang_id = b.bc_in_barang_id'];
		  $where = ['a.purchase_order_detail_id' =>$purchase_order_detail_id];
		  
		  $v_import = $this->main->Get_Join_pop ($table, $fields, $dataJoin, $where);
		  //var_dump($v_import[0]->quantity);die();
				// untuk insert ke receive 
				$data_receive_detail = array(
			         'fabric_warehouse_receive_id' =>$fabric_warehouse_receive_id,
			         ...
			         'quantity_ordered' =>0,
			         'quantity_received' =>0,
			         'quantity_custom' =>$v_import[0]->quantity,
			         'conversion'=>$v_import[0]->conversion,
			         'ex_rate' =>$v_import[0]->ex_rate,
			         'purchase_order_detail_id' =>$purchase_order_detail_id,
			         'bc_in_barang_id' =>$v_import[0]->bc_in_barang_id,
			         'subcon_in_detail_id' =>$v_import[0]->subcon_in_detail_id,
			         'this_cmt' =>$v_import[0]->this_cmt,
			         'unit_price' =>$v_import[0]->unit_price,
			         'this_cmt_service' =>$v_import[0]->this_cmt_service, 
			         'uom_id' =>$v_import[0]->uom_id,
			         'purchase_order_warehouse_detail' =>null,
			         'fabric_receive_info' =>0,
			         'fabric_shipment_list_code' =>$barcode,
			         'bc_in_header_id' =>$bc_in_header_id,
			         'status_receive_detail' => 0,
			         'shipment_weight' =>$list_weight, 
			         'shipment_quantity' =>$list_quantity,
			         'uom_weight' =>75, 
			         'uom_quantity' =>179,
				...
				$hsl_detail = $this->main->insert_pop2("dbo.dt_fabric_warehouse_receive_detail", $data_receive_detail);
				if ($hsl_detail['pesan']) {
				$fabric_warehouse_receive_detail_id = $hsl_detail['id_data'];
				$return['fabric_warehouse_receive_detail_id'] = $fabric_warehouse_receive_detail_id;
				
				}
				//var_dump($fabric_warehouse_receive_detail_id. ' id list : '.$fabric_shipment_list_id );
				$return['fabric_shipment_list_id'] = $fabric_shipment_list_id;
				$return['valid'] = true;
	...
	function post_add_edit_detil_shipment()
	{
		...
		$fabric_shipment_detail_id = isset($_POST['fabric_shipment_detail_id']) ? $_POST['fabric_shipment_detail_id'] : '';
		$detil_shipment = isset($_POST['detil_shipment']) ? $_POST['detil_shipment'] : '';
	...
	function post_add_edit_detil_shipment_excel()
	{
		...
		$list_roll = isset($_POST['list_roll']) ? $_POST['list_roll'] : '';
		$list_weight = isset($_POST['list_weight']) ? $_POST['list_weight'] : '';
		$list_qty = isset($_POST['list_qty']) ? $_POST['list_qty'] : '';
		...
		$list_item_code = isset($_POST['list_item_code']) ? $_POST['list_item_code'] : '';
		...
		$data_detail_shipment = array(
			'fabric_shipment_list_colour' => $list_colour,
			'fabric_shipment_list_lot' => $list_lot,
			'fabric_shipment_list_bale' => $list_bale,
			'fabric_shipment_list_roll' => $list_roll,
			'fabric_shipment_list_weight' => $list_weight,
	...
	function cetak_report_receive()
	{
		$this->db_pop = $this->load->database('pop', TRUE);
		$fabric_warehouse_receive_id = (isset($_GET['fabric_warehouse_receive_id']) && !empty($_GET['fabric_warehouse_receive_id'])) ? $_GET['fabric_warehouse_receive_id'] :
		die('{"sts":"ERROR","desc":" Param Header Tidak Ditemukan"}');
		//var_dump ($purchase_order_id);
		$data = array();

		$q = $this->db_pop->query('select a.fabric_warehouse_receive_id,a.fabric_warehouse_receive_no,b.fabric_shipment_no from dbo.dt_fabric_warehouse_receive a
	    left join dbo.dt_fabric_shipment b ON a.fabric_shipment_id = b.fabric_shipment_id WHERE fabric_warehouse_receive_id= ' . $fabric_warehouse_receive_id . ' ');
	    $row = $q->row();
	   
	    $data['fabric_warehouse_receive_id'] =  $row->fabric_warehouse_receive_id;
	    $data['fabric_warehouse_receive_no'] =  $row->fabric_warehouse_receive_no;
	    $data['fabric_shipment_no'] =  $row->fabric_shipment_no;
		
		$this->load->view('draft/warehouse/report_receive', $data);
		...
		foreach ($cek_data_list->result() as $list) {
			...
			foreach ($cek_warna->result() as $warna) {
				...
				foreach ($q->result() as $r2) {
					...
					$isi_detail = array(
						$r2->fabric_shipment_list_colour,
						$r2->fabric_shipment_list_lot,
						$r2->fabric_shipment_list_bale,
						$r2->fabric_shipment_list_roll,
						number_format($r2->fabric_shipment_list_weight, 4),
						number_format($r2->fabric_shipment_list_quantity, 4),
						$r2->item_code,
						$r2->fabric_shipment_list_code
					);
	...
	function download_shipment_old()
	{
		...
		$isi_header = array(
			$fabric_shipment_detail_invoice_number,
			$fabric_shipment_date,
			$purchase_order_no,
			$item_fabric_code,
			$item_fabric_name,
			$fabric_shipment_no,
			$item_fabric_content,
			'',
			$fabric_shipment_detail_colour,
			$fabric_shipment_detail_bale,
			'',
			$fabric_shipment_detail_made_in,
			$value_total
		);
	...
	function cetak_barcode_receive()
	{
		$this->db_pop = $this->load->database('pop', TRUE);
	...
	function cetak_barcode_receive_other()
	{
		$this->db_pop = $this->load->database('pop', TRUE);
		$fabric_warehouse_receive_detail_id = (isset($_GET['fabric_warehouse_receive_detail_id']) && !empty($_GET['fabric_warehouse_receive_detail_id'])) ? $_GET['fabric_warehouse_receive_detail_id'] : die('{"sts":"ERROR","desc":" Param Header Tidak Ditemukan"}');
		$data['fabric_warehouse_receive_detail_id'] = $fabric_warehouse_receive_detail_id;

		// $this->load->view('draft/warehouse/draft_barcode',$data);
		$this->load->view('draft/warehouse/draft_cetak_barcode_receive_other', $data);
	}
	...
	function post_add_edit_scan_other()
	{
		$this->load->model('main');
		$this->authentication->plainlayout();
		$parameter = array();
		...
		if (count($_POST) > 0) {
			// Gabungkan bc_in_header_id dan bc_in_barang_id
			//str_pad($stringAsli, $panjangTarget, $karakterIsi, STR_PAD_LEFT);
			$str_bc_in_header=str_pad($bc_in_header_id, 4, '0', STR_PAD_LEFT);
			$str_bc_in_barang_id=str_pad($bc_in_barang_id, 4, '0', STR_PAD_LEFT);
			$str_fabric_warehouse_receive_id=str_pad($fabric_warehouse_receive_id, 4, '0', STR_PAD_LEFT);
			$fabric_shipment_list_code = $str_bc_in_header.$str_bc_in_barang_id.$str_fabric_warehouse_receive_id;

			if ($q == 0) {
				$this->rpc_service->setSP("dbo.sp_fabric_receive_scan_add_manual_other");
				$this->rpc_service->addField('bc_in_barang_id', $bc_in_barang_id);
				$this->rpc_service->addField('bc_in_header_id', $bc_in_header_id);
				$this->rpc_service->addField('fabric_shipment_list_code', $fabric_shipment_list_code); // Tambahkan ini
				$this->rpc_service->addField('fabric_warehouse_receive_id', $fabric_warehouse_receive_id);
				$this->rpc_service->addField('fabric_shipment_id', $fabric_shipment_id);
			} elseif ($q == 2) {
				$this->rpc_service->setSP("dbo.sp_fabric_receive_scan_insert_barcode");
			...
			if (isset($result)) {
				if (isset($result['valid']) && $result['valid']) {
					...
					$return['status_code'] = $result['no'];
					$return['message'] = $result['des'];
					$return['bc_in_barang_id'] = $data_result['bc_in_barang_id'];
					$return['bc_in_header_id'] = $data_result['bc_in_header_id'];
				} else {
					$return['status_code'] = $result['no'];
					$return['message'] = $result['des'];
