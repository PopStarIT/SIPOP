...
class item_receiving extends CI_Controller
{
	...
	function index()
	{
		...
		$nav_button[] = array('method_id' => 7811449, 'title' => 'Edit', 'btn' => 'btn-warning', 'icon' => 'fa fa-pencil', 'load' => 'fabric_receive/function_edit');
		$nav_button[] = array('method_id' => 781150, 'title' => 'Delete', 'btn' => 'btn-danger', 'icon' => 'fa fa-trash-o', 'load' => 'fabric_receive/function_delete');
		$nav_button[] = array('method_id' => 781154, 'title' => 'Approve', 'btn' => 'btn-info', 'icon' => 'fa fa-thumbs-up', 'load' => 'fabric_receive/function_approve');
	...
	function post_add_edit_receive_all()
	 {
		$this->load->model('main');
		$this->authentication->plainlayout();
		$parameter = array();
   ...
   //     $result[0] = $obj;
	 ...
	 public function post_add_edit_receive_all_new()
     {
		 set_time_limit(300);
         $this->load->model('main');
         $this->authentication->plainlayout();
