...
class Fabric_subcon_out extends CI_Controller
{
	...
	function fabric_subcon_out_detail_table()
	{
		...
		$view = 'view_fabric_subcon_out_detail_new';
		$get_field = $this->ecc_library->get_field_pop($view);
		...
		$get_field['r3']['title'] = 'PO Style';
		$get_field['r4']['title'] = 'Base Code';
        $get_field['r10']['title'] = 'Jumlah Roll';		
	...
	function fabric_subcon_out_supply_table()
	{
		//$view = 'view_work_order_request_list';
		//$get_field = $this->ecc_library->get_field($view);
		$view = 'view_fabric_subcon_out_supply_new';
		$get_field = $this->ecc_library->get_field_pop($view);
		...
		$get_field['r4']['title'] = 'Pusrchase Order';
		$get_field['r6']['title'] = 'Color';
		$get_field['r7']['title'] = 'Item Base';
		$get_field['r8']['title'] = 'Item Detail';
		$get_field['r9']['title'] = 'Item Name';
		$get_field['r10']['title'] = 'Qty Supply';
		$get_field['r12']['title'] = 'NO LOT';
		$get_field['r13']['title'] = 'NO BALE';
	...
	function post_add_edit()
	{
		...
		if (count($_POST) > 0) {
			...
			//$data_result['fabric_subcon_out_id']=7;
