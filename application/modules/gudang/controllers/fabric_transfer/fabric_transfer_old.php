...
class fabric_transfer extends CI_Controller
{
	...
	function index()
	{
		...
		$omponent['page_title'] = "Transfer Item";

		$dashboard_table = array();

		$nav_button = array();
		//$nav_button[] = array('method_id' => 7811377,'title' => 'Add', 'icon' => 'fa fa-plus', 'load' => 'fabric_transfer/function_add');
	...
	//	$nav_button[] = array('method_id' => 7811384, 'title' => 'Cancel Approve', 'btn' => 'btn-danger', 'icon' => 'fa fa-thumbs-down', 'load' => 'fabric_transfer/function_cancel_approve');
		...
		$dashboard_table['caption'] = '.:: Transfer Item ::.';
	...
	function post_add_edit_scan_other()
	{
		...
		if (count($_POST) > 0) {
			...
			$fabric_shipment_list_code = $bc_in_header_id . '-' . $bc_in_barang_id;
