<script type="text/javascript">
	var new_work_order_return = 1;
	var work_order_return_plan_id = 0;
	var work_order_return_work_process_id = 0;
	var work_order_return_id = 0;
	var work_order_return_bom_id = 0;
	var work_order_return_quantity = 0;
	var work_order_return_detail_id = 0;
	var work_order_return_supply_id = 0;
	...
	function edit_<?php echo $methodid?>(id){
		$.ajax({
			...
			data: {
				...
				,param: 'data_work_order_return'
				,id : id
			},
			dataType: 'json',
			method: 'post',
			success: function(data){
				work_order_return_id = data[0].work_order_return_id;
				new_work_order_return = 0;
				work_order_return_plan_id = data[0].work_order_plan_id;
				work_order_return_work_process_id = data[0].work_process_id;
									
				$('#form_<?php echo $methodid ?>_detail_quantity_return').val(0);
				
				$('#form_<?php echo $methodid ?>_work_order_return_id').val(work_order_return_id);
				...
				$('#form_<?php echo $methodid ?>_detail_work_order_return_id').val(work_order_return_id);
				$('#form_<?php echo $methodid ?>_detail_work_order_plan_id').val(work_order_return_plan_id);
				$('#form_<?php echo $methodid ?>_detail_work_process_id').val(work_order_return_work_process_id);
				$('#form_<?php echo $methodid ?>_detail_work_order_return_date').val(data[0].work_order_return_date);
				
				$("#tab_<?php echo $methodid; ?>_detail").attr("data-toggle","tab");
				$("#tab_<?php echo $methodid; ?>_detail").removeClass( "tab_disabled");
			
				change_form_<?php echo $methodid ?>_work_process_id(work_order_return_work_process_id);
				setTimeout(function(){ 
					change_form_<?php echo $methodid ?>_work_order_plan_id(work_order_return_plan_id);
				}, 500);
			...
			$.ajax({
				...
				success: function(data){
					...
					if(data.valid){
						...
						work_order_return_work_process_id = $('#form_<?php echo $methodid ?>_work_process_id').val();
						work_order_return_plan_id = $('#form_<?php echo $methodid ?>_work_order_plan_id').val();
						work_order_return_date = $('#form_<?php echo $methodid ?>_work_order_return_date').val();
									
						if(new_work_order_return == 1){
							new_work_order_return = 0;
							...
							$('#form_<?php echo $methodid ?>_detail_work_process_id').val(work_order_return_work_process_id);
							$('#form_<?php echo $methodid ?>_detail_work_order_plan_id').val(work_order_return_plan_id);
							$('#form_<?php echo $methodid ?>_detail_work_order_return_date').val(work_order_return_date);
	...
	$(function () {
		...
		$("#table_<?php echo $methodid ?>_material").jqGrid({
			...
			postData:{
				...
				, work_order_return_date : function (){
						return $('#form_<?php echo $methodid ?>_detail_work_order_return_date').val();	
					}
				, work_order_return_id : function (){
						return $('#form_<?php echo $methodid ?>_detail_work_order_return_id').val();	
					}
			},
	...
	var click_transfer_<?php echo $methodid ?> = function (id, isSelected) {
		...
		$('#form_<?php echo $methodid ?>_supply_work_order_return_supply_id').val('');
		...
		if (!isSelected) {
			$('#form_<?php echo $methodid ?>_supply_work_order_return_detail_id').val('');
		} else {
			var row = jQuery("#table_<?php echo $methodid ?>_supply").jqGrid('getRowData',id);
			work_order_return_detail_id = parseInt(unwrap_cell_value(row.r1).replace(/,/g, ''));
			$('#form_<?php echo $methodid ?>_supply_work_order_return_detail_id').val(work_order_return_detail_id);
		}
	...
	var click_item_<?php echo $methodid ?> = function (id, isSelected) {	
		if (!isSelected) {
			...
			work_order_return_supply_id = '';
			
			var row_supply = $("#table_<?php echo $methodid ?>_list_transfer").jqGrid('getRowData',id);
			if(unwrap_cell_value(row_supply.r1) == id){
				work_order_return_supply_id = parseInt(unwrap_cell_value(row_supply.r13).replace(/,/g, ''));
			...
			$('#form_<?php echo $methodid ?>_supply_work_order_return_supply_id').val(work_order_return_supply_id);
	...
	var click_supply_<?php echo $methodid ?> = function (id, isSelected) {
		if (!isSelected) {	
			...
			receive_date = unwrap_cell_value(row.r3);
			receive_no = unwrap_cell_value(row.r4);
			work_order_return_supply_id = parseInt(unwrap_cell_value(row.r13).replace(/,/g, ''));
			quantity_supply = parseFloat(unwrap_cell_value(row.r7).replace(/,/g, ''));
	...
	function supply_<?php echo $methodid?>(id){
		$.ajax({
			...
			success: function(data){
				...
				$('#form_<?php echo $methodid ?>_supply_work_order_return_id').val(work_order_return_id);
				$('#form_<?php echo $methodid ?>_supply_work_order_return_detail_id').val('');
				$('#form_<?php echo $methodid ?>_supply_work_order_return_no').val(data[0].work_order_return_no);
				$('#form_<?php echo $methodid ?>_supply_work_order_return_date').val(data[0].work_order_return_date);
			...
			swal({
				...
				if (result.value) {
					...
					$.ajax({
						...
						data: {'<?php echo $this->security->get_csrf_token_name() ?>':'<?php echo $this->security->get_csrf_hash() ?>',work_order_return_id:work_order_return_id},
						dataType: 'json',
						method: 'post',
						success: function(data){
							page_loading("hide");
