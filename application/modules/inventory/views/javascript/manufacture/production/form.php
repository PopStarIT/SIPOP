<script type="text/javascript">
	...
	var work_order_production_work_process_id = 0;
	var work_order_production_id = 0;
	var work_order_production_bom_id = 0;
	...
	function edit_<?php echo $methodid?>(id){
		$.ajax({
			...
			success: function(data){
				...
				work_order_production_work_process_id = data[0].work_process_id;
				...
				$('#form_<?php echo $methodid ?>_detail_work_process_id').val(work_order_production_work_process_id);
				...
				change_form_<?php echo $methodid ?>_work_process_id(work_order_production_work_process_id);
				setTimeout(function(){ 
			...
			$.ajax({
				...
				success: function(data){
					...
					if(data.valid){
						...
						work_order_production_work_process_id = $('#form_<?php echo $methodid ?>_work_process_id').val();
