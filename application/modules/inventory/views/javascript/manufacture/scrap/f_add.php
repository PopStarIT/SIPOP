<script type="text/javascript">  
	function nav_button_<?php echo $function ?>(){
		...
		work_order_scrap_plan_id = 0;
		work_order_scrap_work_process_id = 0;
		work_order_scrap_id = 0;
		...
		$('#form_<?php echo $methodid ?>_work_order_scrap_id').val('');
		getnexttransno(25, 'form_<?php echo $methodid ?>_work_order_scrap_no');
		$('#form_<?php echo $methodid ?>_work_order_scrap_date').val('<?php echo date('Y-m-d') ?>');
		
		$('#form_<?php echo $methodid ?>_detail_work_order_scrap_id').val('');
