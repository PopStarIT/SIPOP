<script type="text/javascript">  
	function nav_button_<?php echo $function ?>(){
		...
		if('<?php echo $custom_type_id ?>' == 6){
			getnexttransno_delivery(39, 'form_<?php echo $methodid ?>_no_surat_jalan',6);
		} else if('<?php echo $custom_type_id ?>' == 7){
			getnexttransno_delivery(514, 'form_<?php echo $methodid ?>_no_surat_jalan',7);
		} else if('<?php echo $custom_type_id ?>' == 8){
			getnexttransno_delivery(515, 'form_<?php echo $methodid ?>_no_surat_jalan',8);
		} else if('<?php echo $custom_type_id ?>' == 9){
			getnexttransno_delivery(516, 'form_<?php echo $methodid ?>_no_surat_jalan',9);
		} else if('<?php echo $custom_type_id ?>' == 10){
			getnexttransno_delivery(517, 'form_<?php echo $methodid ?>_no_surat_jalan',10);
		} else if('<?php echo $custom_type_id ?>' == 11){
			getnexttransno_delivery(518, 'form_<?php echo $methodid ?>_no_surat_jalan',11);
		} else if('<?php echo $custom_type_id ?>' == 12){
			getnexttransno_delivery(519, 'form_<?php echo $methodid ?>_no_surat_jalan',12);
		} else if('<?php echo $custom_type_id ?>' == 13){
			getnexttransno_delivery(39, 'form_<?php echo $methodid ?>_no_surat_jalan',13);
		} else {
			$('#form_<?php echo $methodid ?>_no_surat_jalan').val('');
		}
		//getnexttransno(39, 'form_<?php echo $methodid ?>_no_surat_jalan');
		$('#form_<?php echo $methodid ?>_tanggal_surat_jalan').val('<?php echo date('Y-m-d') ?>');
		//$('#form_<?php echo $methodid ?>_no_surat_jalan').val('');
		//$('#form_<?php echo $methodid ?>_tanggal_surat_jalan').val('');
		...
		$('#form_<?php echo $methodid ?>_detail_ppn_tarif').val(11);		
		...
		$('.button_<?php echo $methodid ?>_packaging_edit').hide();
		$('.button_<?php echo $methodid ?>_packaging_new').show();
		
		$('.button_<?php echo $methodid ?>_container_edit').hide();
		$('.button_<?php echo $methodid ?>_container_new').show();
