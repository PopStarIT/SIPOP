<script type="text/javascript">
	...
	// ============ Sementara belum digunakan jadi saya disable dahulu ==========
	$('#form_<?php echo $methodid ?>_warehouse_id_old').on('change', function (event, clickedIndex, newValue, oldValue) {
		let gudang_id= $('#form_<?php echo $methodid ?>_warehouse_id_old').val();
		//alert (gudang_id);
		if (gudang_id==2){
			//getnexttransno_sipop(509, 'form_<?php echo $methodid ?>_grn_no');
			getnexttransno_GRN_sipop(10, 'form_<?php echo $methodid ?>_grn_no','FBR');
		}else if (gudang_id==3){
			getnexttransno_GRN_sipop(10, 'form_<?php echo $methodid ?>_grn_no','ACC');
		}else if (gudang_id==5){
			getnexttransno_GRN_sipop(10, 'form_<?php echo $methodid ?>_grn_no','BJD');
		}else if (gudang_id==6){
			getnexttransno_GRN_sipop(10, 'form_<?php echo $methodid ?>_grn_no','SCP');
		}else if (gudang_id==7){
			getnexttransno_GRN_sipop(10, 'form_<?php echo $methodid ?>_grn_no','RBJ');
		}else if (gudang_id==8){
			getnexttransno_GRN_sipop(10, 'form_<?php echo $methodid ?>_grn_no','PRD');
		}else if (gudang_id==9){
			getnexttransno_GRN_sipop(10, 'form_<?php echo $methodid ?>_grn_no','MSN');
		}else{
	...
	$('#form_<?php echo $methodid ?>_warehouse_id_disable').on('change', function (event, clickedIndex, newValue, oldValue) {
		let gudang_id= $('#form_<?php echo $methodid ?>_warehouse_id').val();
		
		if (gudang_id==3){
			getnexttransno_sipop(509, 'form_<?php echo $methodid ?>_grn_no');
		 // $('#form_<?php echo $methodid ?>_grn_no').val('ACC-2025/09/2025-001');
		}else{
			getnexttransno(10, 'form_<?php echo $methodid ?>_grn_no');
		  //$('#form_<?php echo $methodid ?>_grn_no').val('GRN-2025/09/2025-001');
		}
