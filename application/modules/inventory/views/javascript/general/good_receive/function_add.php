<script type="text/javascript">  
	function nav_button_<?php echo $function ?>(){
		...
		// === yang ini ok tapi belum digunakan karena berdasarkan user login=====
		   //getnextno_good_receive(10, 'form_<?php echo $methodid ?>_grn_no','form_<?php echo $methodid ?>_app_trans_id','form_<?php echo $methodid ?>_app_trans_no','form_<?php echo $methodid ?>_app_trans_no_ecc');
		// =====================
		
		//getnexttransno_sipop(app_trans_id, text_input_id)
		//getnextno_txt(30, 'form_<?php echo $methodid ?>_grn_no');
		
		getnexttransno_GRN_sipop(10, 'form_<?php echo $methodid ?>_grn_no','FBR');
		//getnexttransno(10, 'form_<?php echo $methodid ?>_grn_no');
		//$('#form_<?php echo $methodid ?>_grn_no').val('');
		//console.log(getnexttransno(10, 'form_<?php echo $methodid ?>_grn_no');
