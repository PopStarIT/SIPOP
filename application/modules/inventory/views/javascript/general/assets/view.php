<script type="text/javascript">
	...
	//	if (stock_move_id != null){
	//      //show_error("show",'Error','Ooops, Masih dalam proses pengembangan' + stock_move_id);
	//	  var data_send={
    //              '<?php echo $this->security->get_csrf_token_name() ?>': '<?php echo $this->security->get_csrf_hash() ?>'
    ...
    //           $.ajax({
    //              type: "POST",
    //              url:baseurl + '<?php echo $class_uri ?>/print_excel_incoming_detail',
	//			  data: data_send,
    //              dataType : 'json',
    //              complete: function(){
    //              },
	...
	//	}else{
	//		show_error("show",'Error','Ooops, Masih dalam proses pengembangan ' + stock_move_id);
	//		//show_error("show",'Error','Ooops, Tidak ditemukan');
    //    }			
