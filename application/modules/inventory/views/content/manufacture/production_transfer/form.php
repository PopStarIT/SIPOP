										...
										<div class="col-xl-4 mb-30">
											<form class="ui grid ecc_form" id="form_<?php echo $methodid ?>_supply" action="javascript:post_<?php echo $methodid ?>_supply()">
												<?php 
													...
													$this->ecc_library->form('text','',"form_".$methodid."_supply",'stock_move_id','');	 //ini
		  ...
		  <div class="form_<?php echo $methodid ?>_scan">
			...
			<label for="fabric_barcode">Barcode Scan</label>
			  <div class="input-group">
				...
				<input type="text" class="form-control fabric_barcode" id="form_<?php echo $methodid ?>_add_transfer_barcode" name="add_transfer_barcode" placeholder="Scan.." />
			  </div>
		      </div>
		   </div>
		   </div>
		  ...
		  <!--  	<div class="col-xl-12 table-responsive"> -->
		     <div class="col-xl-12 ">
		      <?php
				...
				$extra_param = array('methodid' => $methodid, 'extra_param' => array(0 => array('field' => 'work_order_request_list_id', 'form_id' => 'form_' . $methodid . '_transfer_barcode_work_order_request_list_id')));
       ...
       <div class="modal-content">
		  ...
		  <div class="col-xl-12">
		   ...
		   <div class="card shadow-sm">
            <div class="card-body">
               <h5>Hasil Scan:</h5>
               <input type="text" id="result2" class="form-control text-center fs-4" readonly placeholder="Menunggu barcode...">
            </div>
          </div>
