								...
								<div class="col-xl-12 mb-10 ml-10">
									<form class="ui grid ecc_form" id="form_<?php echo $methodid ?>" action="javascript:post_<?php echo $methodid ?>()">
										...
										<div class="row">
											<div class="col-xl-6">
												<?php 
												// form($form_type = false, $form_label = false, $form_id = false, $form_param = false, $form_value = false, $form_default = false, $form_param_key_1 = false, $extra_data = array())
												...
												<div class="row">
													<div class="col-xl-4">
														<?php
															...
															$this->ecc_library->form('hidden','',"form_".$methodid."_detail",'work_order_request_index','','','');
													...
													<div class="col-xl-4">
														<?php
															$this->ecc_library->form('text','Qty Request',"form_".$methodid."_detail",'quantity_work_order_request','','','');
														?>
													</div>
								...
								<div class="col-xl-12">
								  <div class="row">
								    <div class="col-xl-2">
									 ...
									 <div class="col-xl-2">
										<?php
										// $this->ecc_library->form('readonly','Saldo Assets',"form_".$methodid."_detail",'saldo_assets','','','');
										?>
									</div>
								  </div>
								</div>
