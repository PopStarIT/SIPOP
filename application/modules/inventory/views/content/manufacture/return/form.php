								...
								<div class="col-xl-12 mb-10 ml-10">
									<form class="ui grid ecc_form" id="form_<?php echo $methodid ?>" action="javascript:post_<?php echo $methodid ?>()">
										...
										<div class="row">
											<div class="col-xl-6">
												<?php 
													$this->ecc_library->form('text','Return No',"form_".$methodid,'work_order_return_no','','','');
													$this->ecc_library->form('date','Return Date',"form_".$methodid,'work_order_return_date','','','');
								...
								<div class="col-xl-12">
									...
									<form class="ui grid ecc_form" id="form_<?php echo $methodid ?>_detail" action="javascript:add_<?php echo $methodid ?>()">
										<?php
											...
											$this->ecc_library->form('hidden','',"form_".$methodid."_detail",'work_order_return_id','','','');
											...
											$this->ecc_library->form('hidden','',"form_".$methodid."_detail",'work_order_return_date','','','');
										?>
										<div class="row">
											<div class="col-xl-12">
												<div class="row">
							...
							<div class="row panel_<?php echo $methodid ?>_panel_supply">
								<div class="col-xl-12">
									<div class="row">
										<div class="col-xl-6">
											<?php 
												$this->ecc_library->form('readonly','Return No',"form_".$methodid."_supply",'work_order_return_no','','','');
												$this->ecc_library->form('readonly','Return Date',"form_".$methodid."_supply",'work_order_return_date','','','');
											?>
										</div>
									...
									<div class="row">
										<div class="col-xl-12 mb-30">
											...
											<div class="row">
												<div class="col-xl-12">
													<?php 
														$extra_param = array('methodid'=> $methodid,'onclick'=> 'click_transfer_'.$methodid,'extra_param' => array(0 => array('field' => 'work_order_return_id','form_id' => 'form_'. $methodid .'_supply_work_order_return_id')));
										...
										<div class="col-xl-8 mb-30">
											...
											<div class="row">
												<div class="col-xl-12">
													<?php 
														$extra_field = array();
														$extra_field[] = array('field' => 'work_order_return_detail_id','form_id' => 'form_'. $methodid .'_supply_work_order_return_detail_id');
														$extra_field[] = array('field' => 'work_order_return_supply_id','form_id' => 'form_'. $methodid .'work_order_return_supply_id');
										...
										<div class="col-xl-4 mb-30">
											<form class="ui grid ecc_form" id="form_<?php echo $methodid ?>_supply" action="javascript:post_<?php echo $methodid ?>_supply()">
												<?php 
													...
													$this->ecc_library->form('hidden','',"form_".$methodid."_supply",'work_order_return_id','');
													$this->ecc_library->form('hidden','',"form_".$methodid."_supply",'stock_move_id','');
													$this->ecc_library->form('hidden','',"form_".$methodid."_supply",'work_order_return_detail_id','');
													$this->ecc_library->form('hidden','',"form_".$methodid."_supply",'work_order_return_supply_id','');
