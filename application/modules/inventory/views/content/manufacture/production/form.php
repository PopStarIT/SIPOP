					...
					<div class="tab-content">
								...
								<div class="col-xl-12 mb-10 ml-10">
									<form class="ui grid ecc_form" id="form_<?php echo $methodid ?>" action="javascript:post_<?php echo $methodid ?>()">
										<?php 
											...
											$this->ecc_library->form('hidden','',"form_".$methodid,'work_order_production_id','');
										?>
										
										<div class="row">
											<div class="col-xl-6">
												<?php 
													$this->ecc_library->form('text','Production No',"form_".$methodid,'work_order_production_no','','','');
													$this->ecc_library->form('date','Production Date',"form_".$methodid,'work_order_production_date','','','');
											...
											<div class="col-xl-5">
												<?php 
													...
													$this->ecc_library->form('select','Production Type',"form_".$methodid,'work_order_production_type_id','','','work_order_production_type');
												?>
											</div>
						...
						<div class="tab_custom_ecc tab-pane fade" id="content_<?php echo $methodid; ?>_detail" role="tabpanel" aria-labelledby="tab_<?php echo $methodid; ?>_detail">
												...
												<div class="row">
													<div class="col-xl-4">
														<?php
															...
															$this->ecc_library->form('hidden','',"form_".$methodid."_detail",'work_order_production_id','','','');
															$this->ecc_library->form('hidden','',"form_".$methodid."_detail",'work_order_production_detail_id','','','');
															$this->ecc_library->form('hidden','',"form_".$methodid."_detail",'work_order_production_index','','','');
															...
															$this->ecc_library->form('select','FG',"form_".$methodid."_detail",'work_order_detail_id','','','get_work_order_detail_item',
															array('extra_param' => array(0 => array('field' => 'work_order_plan_id' ),1 => array('field' => 'work_process_id' ))));
														?>
													</div>
													
													<div class="col-xl-4">
														<?php
															$this->ecc_library->form('select','FG / SFG',"form_".$methodid."_detail",'item_id','','','get_item_from_work_order_plan_process',array('extra_param' => array(0 => array('field' => 'work_order_plan_id' ),1 => array('field' => 'work_process_id' ),2 => array('field' => 'work_order_detail_id' ))));
														?>
													</div>
													...
													<div class="col-xl-4 ">
														<?php
															$this->ecc_library->form('text','Qty Production',"form_".$methodid."_detail",'quantity_production','','','');
														?>
													</div>
													
													<div class="col-xl-4 input_<?php echo $methodid ?>_reject">
														<?php
															$this->ecc_library->form('select','Reject Item',"form_".$methodid."_detail",'reject_item_id','','','item_reject');
														?>
													</div>
												</div>
											</div>
							...
							<div class="row">
								<div class="col-xl-12">
									<?php 
										$extra_param = array('methodid'=> $methodid,'extra_param' => array(0 => array('field' => 'work_order_production_id','form_id' => 'form_'. $methodid .'_detail_work_order_production_id')));
							...
							<div class="row panel_<?php echo $methodid ?>_panel_supply">
								<div class="col-xl-12">
									<div class="row">
										<div class="col-xl-6">
											<?php 
												$this->ecc_library->form('readonly','Production No',"form_".$methodid."_supply",'work_order_production_no','','','');
												$this->ecc_library->form('readonly','Production Date',"form_".$methodid."_supply",'work_order_production_date','','','');
										...
										<div class="col-xl-6">
											<?php 
												...
												$this->ecc_library->form('readonly','Production Type',"form_".$methodid."_supply",'work_order_production_type','','','');
											?>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-xl-12 mb-30">
											...
											<div class="row">
												<div class="col-xl-12">
													<?php 
														$extra_param = array('methodid'=> $methodid,'onclick'=> 'click_transfer_'.$methodid,'extra_param' => array(0 => array('field' => 'work_order_production_id','form_id' => 'form_'. $methodid .'_supply_work_order_production_id')));
										...
										<div class="col-xl-8 mb-30">
											...
											<div class="row">
												<div class="col-xl-12">
													<?php 
														$extra_field = array();
														$extra_field[] = array('field' => 'work_order_production_list_id','form_id' => 'form_'. $methodid .'_supply_work_order_production_list_id');
														$extra_field[] = array('field' => 'work_order_production_supply_id','form_id' => 'form_'. $methodid .'work_order_production_supply_id');
										...
										<div class="col-xl-4 mb-30">
											<form class="ui grid ecc_form" id="form_<?php echo $methodid ?>_supply" action="javascript:post_<?php echo $methodid ?>_supply()">
												<?php 
													...
													$this->ecc_library->form('hidden','',"form_".$methodid."_supply",'work_order_production_id','');
													$this->ecc_library->form('hidden','',"form_".$methodid."_supply",'stock_move_id','');
													$this->ecc_library->form('hidden','',"form_".$methodid."_supply",'work_order_production_list_id','');
													$this->ecc_library->form('hidden','',"form_".$methodid."_supply",'work_order_production_supply_id','');
