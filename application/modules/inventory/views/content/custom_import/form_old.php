										...
										<div class="row">
											<div class="col-xl-6">
												...
												<div class="row">
													...
													<div class="col-xl-12">
														<div class="input_header_<?php echo $methodid ?> input_header_<?php echo $methodid ?>_4 input_header_<?php echo $methodid ?>_5">
										...
										<div class="row">
											<div class="col-xl-6">
												<div class="row">
													...
													<div class="col-xl-12 input_header_<?php echo $methodid ?> input_header_<?php echo $methodid ?>_3  input_header_<?php echo $methodid ?>_4">
														<?php $this->ecc_library->form('text','Subcon Price',"form_".$methodid."_detail",'subcon_price','','',''); ?>
													</div>	
													<div class="col-xl-6 input_header_<?php echo $methodid ?>  input_header_<?php echo $methodid ?>_1  input_header_<?php echo $methodid ?>_2  input_header_<?php echo $methodid ?>_4">
