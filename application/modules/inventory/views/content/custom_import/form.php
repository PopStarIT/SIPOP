			...
			<div class="card-body" style="padding: 1.25rem !important">
				...
				<div class="tab tab-border">
					<ul class="nav nav-tabs form_tab_<?php echo $methodid ?>" role="tablist">
						...
						<li class="nav-item">
							<a class="nav-link input_header_<?php echo $methodid ?>  input_header_<?php echo $methodid ?>_3 " id="tab_<?php echo $methodid; ?>_packaging" data-toggle="tab" href="#content_<?php echo $methodid; ?>_packaging" role="tab" aria-controls="content_<?php echo $methodid; ?>_packaging" aria-selected="true">
								<i class="fa fa-umbrella"></i> Jaminan
							</a>	
						</li>
						<li class="nav-item">
							<a class="nav-link input_header_<?php echo $methodid ?>  input_header_<?php echo $methodid ?>_1 input_header_<?php echo $methodid ?>_2" id="tab_<?php echo $methodid; ?>_container" data-toggle="tab" href="#content_<?php echo $methodid; ?>_container" role="tab" aria-controls="content_<?php echo $methodid; ?>_container" aria-selected="true">
										...
										<div class="row">
												...
												<div class="row">
													...
													<div class="col-xl-6">
														<div class="input_header_<?php echo $methodid ?> input_header_<?php echo $methodid ?>_1 input_header_<?php echo $methodid ?>_2">
															<?php 
																$this->ecc_library->form('text','BL No',"form_".$methodid,'bl_no','','','');																	
															?>
														</div>
													</div>
													...
													<div class="col-xl-4">
														<div class="input_header_<?php echo $methodid ?> input_header_<?php echo $methodid ?>_1 input_header_<?php echo $methodid ?>_2">
															<?php 
																$this->ecc_library->form('date','BL Date',"form_".$methodid,'bl_date','','','');																	
															?>	
														</div>
													</div>
													<div class="input_header_<?php echo $methodid ?> input_header_<?php echo $methodid ?>_1 input_header_<?php echo $methodid ?>_2">
														<button type="button" class="btn custom-combo1 btn-default" onclick="get_bl_<?php echo $methodid ?>()">
															<i class="fa fa-flash"></i> Get BC.11
														</button>
													</div>
													...
													<div class="col-xl-12">
														<div class="input_header_<?php echo $methodid ?> input_header_<?php echo $methodid ?>_5 input_header_<?php echo $methodid ?>_4">
													...
													<div class="col-xl-12">
														<div class="input_header_<?php echo $methodid ?> input_header_<?php echo $methodid ?>_3">
													...
													<div class="col-xl-12">
														<div class="input_header_<?php echo $methodid ?> input_header_<?php echo $methodid ?>_3 input_header_<?php echo $methodid ?>_4 input_header_<?php echo $methodid ?>_5">
															<?php $this->ecc_library->form('text','Nama Penanda Tangan',"form_".$methodid,'nama_ttd_1','','',''); ?>
														</div>
													</div>
													<div class="col-xl-12">
														<div class="input_header_<?php echo $methodid ?> input_header_<?php echo $methodid ?>_3 input_header_<?php echo $methodid ?>_4 input_header_<?php echo $methodid ?>_5">
															<?php $this->ecc_library->form('text','Jabatan Penanda Tangan',"form_".$methodid,'jabatan_ttd_1','','',''); ?>	
														</div>
													</div>
													...
													<div class="col-xl-12">
														<div class="input_header_<?php echo $methodid ?> input_header_<?php echo $methodid ?>_1">
															<?php $this->ecc_library->form('text','Kota Tanda Tangan',"form_".$methodid,'kota_ttd_1','','',''); ?>
														</div>
													</div>
													-->
												</div>
											...
											<div class="col-xl-5">
												...
												<!--<div class="col-xl-6">
													...
													<div class="col-xl-12">
														<div class="input_header_<?php echo $methodid ?> input_header_<?php echo $methodid ?>_1 input_header_<?php echo $methodid ?>_2 input_header_<?php echo $methodid ?>_4">
													...
													<div class="col-xl-6">
														<div class="input_header_<?php echo $methodid ?> input_header_<?php echo $methodid ?>_2">
															<?php $this->ecc_library->form('date','Tanggal Tanda Tangan',"form_".$methodid,'tgl_ttd_1','','',''); ?>
														</div>
													</div>
													<div class="col-xl-12">
														<div class="input_header_<?php echo $methodid ?> input_header_<?php echo $methodid ?>_1">
															<?php $this->ecc_library->form('date','Tanggal Tanda Tangan',"form_".$methodid,'tgl_ttd_2','','',''); ?>
														</div>
													</div>
													-->	
												</div>	
										...
										<div class="row">
											<div class="col-xl-6">
												<div class="row">
													...
													<button type="button" class="btn custom-combo1 btn-default" onclick="get_tarif_<?php echo $methodid ?>()">
														<i class="fa fa-flash"></i> Get Tarif
													</button>
													...
													<div class="col-xl-6 input_header_<?php echo $methodid ?>  input_header_<?php echo $methodid ?>_1  input_header_<?php echo $methodid ?>_2 input_header_<?php echo $methodid ?>_3  input_header_<?php echo $methodid ?>_4">
													...
													<div class="col-xl-12 input_header_<?php echo $methodid ?>  input_header_<?php echo $methodid ?>_5">
											...
											<div class="col-xl-5">
												<div class="row">
													...
													<div class="col-xl-12 ">
														<?php $this->ecc_library->form('select','Tarif Fasilitas (PDRI)',"form_".$methodid."_detail",'skema_tarif_id','','','ceisa_tarif_fasilitas'); ?>
													</div>
													<div class="col-xl-6 ">
														<?php 
													...
													<div class="col-xl-12 input_header_<?php echo $methodid ?> input_header_<?php echo $methodid ?>_1 input_header_<?php echo $methodid ?>_2 input_header_<?php echo $methodid ?>_3 input_header_<?php echo $methodid ?>_4">
														<?php $this->ecc_library->form('text','Note (Merk Kemasan)',"form_".$methodid."_detail",'note','','',''); ?>
													</div>
													<!--
													<div class="col-xl-6">
