										...
										<div class="row">
											...
											<div class="col-xl-5">
												<?php 
													...
													$this->ecc_library->form('select','Production Plan',"form_".$methodid,'work_order_plan_id','','','production_plan');
										...
										<div class="row">
											<div class="col-xl-9">
												<div class="row">
													...
													<div class="col-xl-4">
														<?php
															$this->ecc_library->form('select','FG / SFG',"form_".$methodid."_detail",'item_id','','','get_item_from_work_order_plan_process',array('extra_param' => array(0 => array('field' => 'work_order_plan_id' ),2 => array('field' => 'work_order_detail_id' ))));
														?>
													</div>
