					...
					<div class="tab-content">
								...
								<div class="col-xl-12 mb-10 ml-10">
									<form class="ui grid ecc_form" id="form_<?php echo $methodid ?>" action="javascript:post_<?php echo $methodid ?>()">
										<?php 
											...
											$this->ecc_library->form('hidden','',"form_".$methodid,'subcon_out_id','');
										...
										<div class="row">
											<div class="col-xl-4">
												<?php 
													...
													$this->ecc_library->form('text','Subcon Out No',"form_".$methodid,'subcon_out_no','','','');
												?>
											</div>
											...
											<div class="col-xl-4">
												<?php 
													...
													$this->ecc_library->form('date','Subcon Out Date',"form_".$methodid,'subcon_out_date','','','');
												?>
											</div>
											...
											<div class="col-xl-3">
												<?php 
													...
													$this->ecc_library->form('text','Memo',"form_".$methodid,'subcon_out_memo','','','');														
												?>
											</div>
										</div>
									</form>
						...
						<div class="tab_custom_ecc tab-pane fade" id="content_<?php echo $methodid; ?>_detail" role="tabpanel" aria-labelledby="tab_<?php echo $methodid; ?>_detail">
												...
												<div class="row">
													<div class="col-xl-11">
														<?php
															...
															$this->ecc_library->form('hidden','',"form_".$methodid."_detail",'subcon_out_detail_id','','','');
													...
													<div class="col-xl-2">
														<?php
															$this->ecc_library->form('readonly','Saldo Report',"form_".$methodid."_detail",'saldo_report','','','');
														?>
													</div>
												</div>
											</div>
							...
							<div class="row panel_<?php echo $methodid ?>_panel_receiver mb-10" >
								<div class="col-xl-12">
									<?php 
										...
										$extra_field[] = array('field' => 'subcon_out_detail_id','form_id' => 'form_'. $methodid .'_detail_subcon_out_detail_id');
							...
							<div class="row">
								<div class="col-xl-12">
									<?php 
										$extra_param = array('methodid'=> $methodid,'extra_param' => array(0 => array('field' => 'subcon_out_id','form_id' => 'form_'. $methodid .'_detail_subcon_out_id')));
