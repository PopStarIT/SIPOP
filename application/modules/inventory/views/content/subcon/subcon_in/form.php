				...
				<div class="tab tab-border">
					...
					<div class="tab-content">
								...
								<div class="col-xl-12 mb-10 ml-10">
									<form class="ui grid ecc_form" id="form_<?php echo $methodid ?>" action="javascript:post_<?php echo $methodid ?>()">
										<?php 
											...
											$this->ecc_library->form('hidden','',"form_".$methodid,'subcon_in_id','');
											$this->ecc_library->form('hidden','',"form_".$methodid,'receiver','');
										?>
										...
										<div class="row">
											<div class="col-xl-4">
												<?php 
													...
													$this->ecc_library->form('text','Subcon In No',"form_".$methodid,'subcon_in_no','','','');
												?>
											</div>
											...
											<div class="col-xl-4">
												<?php 
													...
													$this->ecc_library->form('date','Subcon In Date',"form_".$methodid,'subcon_in_date','','','');
												?>
											</div>
											...
											<div class="col-xl-3">
												<?php 
													...
													$this->ecc_library->form('text','Memo',"form_".$methodid,'subcon_in_memo','','','');														
												?>
											</div>
										</div>
									</form>
						...
						<div class="tab_custom_ecc tab-pane fade" id="content_<?php echo $methodid; ?>_detail" role="tabpanel" aria-labelledby="tab_<?php echo $methodid; ?>_detail">
												...
												<div class="row">
													<div class="col-xl-11">
														<?php
															...
															$this->ecc_library->form('hidden','',"form_".$methodid."_detail",'subcon_in_id','','','');
															$this->ecc_library->form('hidden','',"form_".$methodid."_detail",'subcon_in_detail_id','','','');
															$this->ecc_library->form('hidden','',"form_".$methodid."_detail",'contract_subcon_id','','','');
															$this->ecc_library->form('hidden','',"form_".$methodid."_detail",'subcon_in_date','','','');
															$this->ecc_library->form('select','Item Code',"form_".$methodid."_detail",'item_id','','','item_cmt');
														?>
													</div>
							...
							<div class="row panel_<?php echo $methodid ?>_panel_receiver mb-10" >
								<div class="col-xl-12">
									<?php 
										$extra_field = array();
										$extra_field[] = array('field' => 'contract_subcon_id','form_id' => 'form_'. $methodid .'_detail_contract_subcon_id');
										$extra_field[] = array('field' => 'subcon_in_detail_id','form_id' => 'form_'. $methodid .'_detail_subcon_in_detail_id');
										$extra_field[] = array('field' => 'subcon_in_date','form_id' => 'form_'. $methodid .'_detail_subcon_in_date');
										$extra_param = array('methodid'=> $methodid,'beforeclick'=> 'beforeclick_'.$methodid."_receiver",'extra_param' => $extra_field);
										$this->ecc_library->jqgrid($methodid."_receiver", $dashboard_table['field_receiver'], $dashboard_table['field_receiver_loaddata'],$extra_param); 
									?>
								</div>
							</div> 
							...
							<div class="row">
								<div class="col-xl-12">
									<?php 
										$extra_param = array('methodid'=> $methodid,'extra_param' => array(0 => array('field' => 'subcon_in_id','form_id' => 'form_'. $methodid .'_detail_subcon_in_id')));
							...
							<div class="row panel_<?php echo $methodid ?>_panel_supply">
								<div class="col-xl-12">
									<div class="row">
										<div class="col-xl-6">
											<?php 
												$this->ecc_library->form('readonly','Subcon In No',"form_".$methodid."_supply",'subcon_in_no','','','');
												$this->ecc_library->form('readonly','Subcon In Date',"form_".$methodid."_supply",'subcon_in_date','','','');
											?>
										</div>
										
										<div class="col-xl-6">
											<?php 
												$this->ecc_library->form('readonly','Contract Subcon No',"form_".$methodid."_supply",'contract_subcon_no','','','');
											?>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-xl-12 mb-30">
											...
											<div class="row">
												<div class="col-xl-12">
													<?php 
														$extra_param = array('methodid'=> $methodid,'onclick'=> 'click_transfer_'.$methodid,'extra_param' => array(0 => array('field' => 'subcon_in_id','form_id' => 'form_'. $methodid .'_supply_subcon_in_id')));
										...
										<div class="col-xl-8 mb-30">
											...
											<div class="row">
												<div class="col-xl-12">
													<?php 
														$extra_field = array();
														$extra_field[] = array('field' => 'subcon_in_detail_id','form_id' => 'form_'. $methodid .'_supply_subcon_in_detail_id');
														$extra_field[] = array('field' => 'subcon_in_supply_id','form_id' => 'form_'. $methodid .'_supply_subcon_in_supply_id');
														$extra_field[] = array('field' => 'contract_subcon_id','form_id' => 'form_'. $methodid .'_supply_contract_subcon_id');
										...
										<div class="col-xl-4 mb-30">
											<form class="ui grid ecc_form" id="form_<?php echo $methodid ?>_supply" action="javascript:post_<?php echo $methodid ?>_supply()">
												<?php 
													...
													$this->ecc_library->form('hidden','',"form_".$methodid."_supply",'subcon_in_id','');
													$this->ecc_library->form('hidden','',"form_".$methodid."_supply",'contract_subcon_id','');
													$this->ecc_library->form('hidden','',"form_".$methodid."_supply",'stock_move_id','');
													$this->ecc_library->form('hidden','',"form_".$methodid."_supply",'subcon_in_detail_id','');
													$this->ecc_library->form('hidden','',"form_".$methodid."_supply",'subcon_in_supply_id','');
