								...
								<div class="col-xl-12 mb-10 ml-10">
									<form class="ui grid ecc_form" id="form_<?php echo $methodid ?>" action="javascript:post_<?php echo $methodid ?>()">
										<?php 
											...
											$this->ecc_library->form('hidden','',"form_".$methodid,'subcon_production_id','');
										?>
										
										<div class="row">
											<div class="col-xl-6">
												<?php 
													$this->ecc_library->form('text','Subcon Production No',"form_".$methodid,'subcon_production_no','','','');
													$this->ecc_library->form('date','Subcon Production Date',"form_".$methodid,'subcon_production_date','','','');
											...
											<div class="col-xl-5">
												<?php 
													$this->ecc_library->form('select','Contract Subcon',"form_".$methodid,'contract_subcon_id','','','contract_subcon_production');
													//$this->ecc_library->form('select','Production Plan',"form_".$methodid,'contract_subcon_id','','','get_work_order_plan_process',array('extra_param' => array(0 => array('field' => 'work_process_id' ))));
												?>
											</div>
						...
						<div class="tab_custom_ecc tab-pane fade" id="content_<?php echo $methodid; ?>_detail" role="tabpanel" aria-labelledby="tab_<?php echo $methodid; ?>_detail">
												...
												<div class="row">
													<div class="col-xl-12">
														<?php
															...
															$this->ecc_library->form('hidden','',"form_".$methodid."_detail",'subcon_production_id','','','');
															...
															$this->ecc_library->form('hidden','',"form_".$methodid."_detail",'subcon_production_date','','','');
															$this->ecc_library->form('hidden','',"form_".$methodid."_detail",'subcon_production_detail_id','','','');
															$this->ecc_library->form('select','Subcon',"form_".$methodid."_detail",'item_id','','','item_detail');
														?>
													</div>
													<div class="col-xl-12">
														<?php
															$this->ecc_library->form('text','Qty Subcon',"form_".$methodid."_detail",'quantity_subcon','','','');
														?>
													</div>
													<div class="col-xl-12">
							...
							<div class="row">
								<div class="col-xl-12">
									<h3>Subcon Detail</h3>
									<?php 
										$extra_param = array('methodid'=> $methodid,'extra_param' => array(0 => array('field' => 'subcon_production_id','form_id' => 'form_'. $methodid .'_detail_subcon_production_id')));
							...
							<div class="row panel_<?php echo $methodid ?>_panel_supply">
								<div class="col-xl-12">
									<div class="row">
										<div class="col-xl-6">
											<?php 
												$this->ecc_library->form('readonly','Subcon No',"form_".$methodid."_supply",'subcon_production_no','','','');
												$this->ecc_library->form('readonly','Subcon Date',"form_".$methodid."_supply",'subcon_production_date','','','');
											?>
										</div>
									...
									<div class="row">
										<div class="col-xl-12 mb-30">
											...
											<div class="row">
												<div class="col-xl-12">
													<?php 
														$extra_param = array('methodid'=> $methodid,'onclick'=> 'click_transfer_'.$methodid,'extra_param' => array(0 => array('field' => 'subcon_production_id','form_id' => 'form_'. $methodid .'_supply_subcon_production_id')));
										...
										<div class="col-xl-8 mb-30">
											...
											<div class="row">
												<div class="col-xl-12">
													<?php 
														$extra_field = array();
														$extra_field[] = array('field' => 'subcon_production_list_id','form_id' => 'form_'. $methodid .'_supply_subcon_production_list_id');
														$extra_field[] = array('field' => 'subcon_production_supply_id','form_id' => 'form_'. $methodid .'subcon_production_supply_id');
										...
										<div class="col-xl-4 mb-30">
											<form class="ui grid ecc_form" id="form_<?php echo $methodid ?>_supply" action="javascript:post_<?php echo $methodid ?>_supply()">
												<?php 
													...
													$this->ecc_library->form('hidden','',"form_".$methodid."_supply",'subcon_production_id','');
													$this->ecc_library->form('hidden','',"form_".$methodid."_supply",'stock_move_id','');
													$this->ecc_library->form('hidden','',"form_".$methodid."_supply",'subcon_production_list_id','');
													$this->ecc_library->form('hidden','',"form_".$methodid."_supply",'subcon_production_supply_id','');
