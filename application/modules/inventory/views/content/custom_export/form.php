										...
										<div class="row">
											<div class="col-xl-6">
												...
												<div class="row">
													<div class="col-xl-10">
														<?php 
															$this->ecc_library->form('text','No Surat Jalan',"form_".$methodid,'no_surat_jalan','','','');
											...
											<div class="col-xl-5">
												<?php $this->ecc_library->form('date','Tanggal Surat Jalan',"form_".$methodid,'tanggal_surat_jalan','','',''); ?>
