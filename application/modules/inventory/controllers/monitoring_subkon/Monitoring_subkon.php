...
Class Monitoring_subkon extends CI_Controller { 
	...
	function monitoring_subkon_table(){
		$field = array();
		...
		$field['r64'] = array('sc' => 'r64','ctype' => 'text', 'bypassvalue' => '', 'title' => 'PARTNER CODE');
		...
		$field['r75'] = array('sc' => 'r75','ctype' => 'text', 'bypassvalue' => '', 'title' => 'PRODUCTION SUBCON NO');
		$field['r76'] = array('sc' => 'r76','ctype' => 'text', 'bypassvalue' => '', 'title' => 'PRODUCTION SUBCON DATE');
		$field['r77'] = array('sc' => 'r77','ctype' => 'text', 'bypassvalue' => '', 'title' => 'FG / SFG NAME');
		$field['r78'] = array('sc' => 'r78','ctype' => 'text', 'bypassvalue' => '', 'title' => 'QTY PRODUCTION');
		$field['r79'] = array('sc' => 'r79','ctype' => 'text', 'bypassvalue' => '', 'title' => 'QTY MATERIAL IN');
		$field['r80'] = array('sc' => 'r80','ctype' => 'text', 'bypassvalue' => '', 'title' => 'OUTSTANDING');
		return $field;
	}
	...
	function index(){
		...
		$component['view_load'] = 'monitoring_subkon/view';
		$component['load_js'][] = 'monitoring_subkon/view';
		
		$component['page_title'] = "Monitoring Subcon";
		$dashboard_table = array();
	
		$field = $this->monitoring_subkon_table();
	...
	function loaddata(){
		...
		$sp = "dbo.sp_rpt_monitoring_subkon";		
		if($print == 1){
