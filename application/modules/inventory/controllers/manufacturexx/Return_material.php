...
Class Return_material extends CI_Controller { 
	...
	function loaddata_material(){
		...
		if($work_order_return_id){
			$this->rpc_service_portal->addField('work_order_return_id',$work_order_return_id);	
		}
		
		$this->rpc_service_portal->addField('work_order_plan_id',$work_order_plan_id);
		$this->rpc_service_portal->addField('work_process_id',$work_process_id);
		$this->rpc_service_portal->addField('work_order_return_date',$work_order_return_date);
