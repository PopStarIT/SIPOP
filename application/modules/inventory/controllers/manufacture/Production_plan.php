...
Class Production_plan extends CI_Controller { 
	...
	function work_order_monitor_request() {
	...
	function work_order_monitor_request_detail() {
		$view = 'view_work_order_monitoring_request_detail';
		$get_field = $this->ecc_library->get_field_pop($view);
	...
	function work_order_monitor_transfer() {
		$view = 'view_work_order_monitoring_transfer';
		$get_field = $this->ecc_library->get_field_pop($view);
	...
	function work_order_monitor_transfer_detail() {
		//$view = 'view_work_order_monitoring_transfer_detail';
	...
	function work_order_monitor_production() {
		//$view = 'view_work_order_monitoring_transfer_detail';
		$view = 'view_work_order_monitoring_production';
		$get_field = $this->ecc_library->get_field_pop($view);
	...
	function work_order_monitor_production_detail() {
		//$view = 'view_work_order_monitoring_transfer_detail';
		$view = 'view_work_order_monitoring_production_detail';
		$get_field = $this->ecc_library->get_field_pop($view);
	...
	function work_order_monitor_scrap() {
		//$view = 'view_work_order_monitoring_transfer_detail';
		$view = 'view_work_order_monitoring_scrap';
		$get_field = $this->ecc_library->get_field_pop($view);
	...
	function work_order_monitor_scrap_detail() {
		//$view = 'view_work_order_monitoring_transfer_detail';
		$view = 'view_work_order_monitoring_scrap_detail';
		$get_field = $this->ecc_library->get_field_pop($view);
	...
	function work_order_monitor_return() {
		//$view = 'view_work_order_monitoring_transfer_detail';
		$view = 'view_work_order_monitoring_return';
		$get_field = $this->ecc_library->get_field_pop($view);
	...
	function work_order_monitor_return_detail() {
		//$view = 'view_work_order_monitoring_transfer_detail';
		$view = 'view_work_order_monitoring_return_detail';
		$get_field = $this->ecc_library->get_field_pop($view);
	...
	function index(){
		...
		$component['view_load_form_monitoring']= 'manufacture/production_plan/form_monitoring';
		...
		$nav_button[] = array('method_id' => 7811194,'title' => 'Monitoring', 'icon' => 'fa fa-search', 'load' => 'manufacture/production_plan/function_monitoring');
	...
	function loaddata_monitoring_request() {
		$this->authentication->plainlayout();
		//var_dump($_POST['work_order_plan_id']);
		...
		$view = 'view_work_order_monitoring_request';
		$field = $this->work_order_monitor_request_detail();
    ...
    function loaddata_monitoring_request_detail() {
		$this->authentication->plainlayout();
		
		$view = 'view_work_order_monitoring_request_detail';
		$field = $this->work_order_monitor_request_detail();
		
		$sub_id = isset($_POST['row_id']) ? $_POST['row_id'] : '';
		$methodid = isset($_REQUEST['methodid']) ? is_numeric($_REQUEST['methodid']) ? $_REQUEST['methodid']  : -1 : -1;
		...
		$extra_param = array();
		$extra_param['where']['0']['field'] = 'r2';
		$extra_param['where']['0']['data'] = $sub_id;
		$extra_param['methodid'] = $methodid;
	...
	function loaddata_monitoring_transfer() {
		$this->authentication->plainlayout();
		//var_dump($_POST['work_order_plan_id']);
		$work_order_plan_id = isset($_POST['work_order_plan_id']) ? $_POST['work_order_plan_id'] :'';
		$methodid = isset($_REQUEST['methodid']) ? is_numeric($_REQUEST['methodid']) ? $_REQUEST['methodid']  : -1 : -1;
		...
		$view = 'view_work_order_monitoring_transfer';
		$field = $this->work_order_monitor_transfer();
	...
	function loaddata_monitoring_transfer_detail() {
		$this->authentication->plainlayout();
		...
		//$view = 'view_work_order_monitoring_transfer_detail';
		$view = 'view_work_order_request_list';
		$field = $this->work_order_monitor_transfer_detail();
	...
	function loaddata_monitoring_production() {
		$this->authentication->plainlayout();
		//var_dump($_POST['work_order_plan_id']);
		$work_order_plan_id = isset($_POST['work_order_plan_id']) ? $_POST['work_order_plan_id'] :'';
		$methodid = isset($_REQUEST['methodid']) ? is_numeric($_REQUEST['methodid']) ? $_REQUEST['methodid']  : -1 : -1;
		...
		$view = 'view_work_order_monitoring_production';
		$field = $this->work_order_monitor_production();
	...
	function loaddata_monitoring_production_detail() {
		$this->authentication->plainlayout();
		//var_dump($_POST['work_order_plan_id']);
		$sub_id = isset($_POST['row_id']) ? $_POST['row_id'] : '';
		$methodid = isset($_REQUEST['methodid']) ? is_numeric($_REQUEST['methodid']) ? $_REQUEST['methodid']  : -1 : -1;
		...
		//$view = 'view_work_order_monitoring_transfer_detail';
		$view = 'view_work_order_monitoring_production_detail';
		$field = $this->work_order_monitor_production_detail();
	...
	function loaddata_monitoring_scrap() {
		$this->authentication->plainlayout();
		//var_dump($_POST['work_order_plan_id']);
		$work_order_plan_id = isset($_POST['work_order_plan_id']) ? $_POST['work_order_plan_id'] :'';
		$methodid = isset($_REQUEST['methodid']) ? is_numeric($_REQUEST['methodid']) ? $_REQUEST['methodid']  : -1 : -1;
		...
		$view = 'view_work_order_monitoring_scrap';
		$field = $this->work_order_monitor_scrap();
		$return = array();
		$return['valid'] = false;
		$return['message'] = "Internal Server Error";
	...
	function loaddata_monitoring_scrap_detail() {
		$this->authentication->plainlayout();
		//var_dump($_POST['work_order_plan_id']);
		$sub_id = isset($_POST['row_id']) ? $_POST['row_id'] : '';
		$methodid = isset($_REQUEST['methodid']) ? is_numeric($_REQUEST['methodid']) ? $_REQUEST['methodid']  : -1 : -1;
		...
		//$view = 'view_work_order_monitoring_transfer_detail';
		$view = 'view_work_order_monitoring_scrap_detail';
		$field = $this->work_order_monitor_scrap_detail();
	...
	function loaddata_monitoring_return() {
		$this->authentication->plainlayout();
		//var_dump($_POST['work_order_plan_id']);
		$work_order_plan_id = isset($_POST['work_order_plan_id']) ? $_POST['work_order_plan_id'] :'';
		$methodid = isset($_REQUEST['methodid']) ? is_numeric($_REQUEST['methodid']) ? $_REQUEST['methodid']  : -1 : -1;
		...
		$view = 'view_work_order_monitoring_return';
		$field = $this->work_order_monitor_return();
		$return = array();
		$return['valid'] = false;
		$return['message'] = "Internal Server Error";
	...
	function loaddata_monitoring_return_detail() {
		$this->authentication->plainlayout();
		//var_dump($_POST['work_order_plan_id']);
		$sub_id = isset($_POST['row_id']) ? $_POST['row_id'] : '';
		$methodid = isset($_REQUEST['methodid']) ? is_numeric($_REQUEST['methodid']) ? $_REQUEST['methodid']  : -1 : -1;
		...
		//$view = 'view_work_order_monitoring_transfer_detail';
		$view = 'view_work_order_monitoring_return_detail';
		$field = $this->work_order_monitor_return_detail();
