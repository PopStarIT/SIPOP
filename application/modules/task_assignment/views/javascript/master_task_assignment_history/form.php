<script type="text/javascript">
    $(".form_tab_<?php echo $methodid ?>").on("click", "a", function(e) {
        ...
        setTimeout(function() {
            ...
            $("#table_<?php echo $methodid ?>_delete").trigger('reloadGrid');
            $("#table_<?php echo $methodid ?>_delete").setGridWidth($('.grid_container_<?php echo $methodid; ?>_delete').width() - 20, true).trigger('resize');
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data && data.length > 0) {
                    ...
                    $('#form_<?php echo $methodid ?>_status').val(data[0].status);
