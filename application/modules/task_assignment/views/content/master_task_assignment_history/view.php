                            ...
                            <div id="accordion">
                                <div class="card">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div id="panel_content_<?php echo $methodid ?>_delete">
                                                <h5>Data Delete</h5>
                                                <?php
                                                $extra_param = array(
                                                    'methodid' => $methodid,
                                                ...
                                                $this->ecc_library->jqgrid($methodid . "_delete", $dashboard_table['field_delete'], $dashboard_table['field_loaddata_delete'], $extra_param);
                                                ?>
                                            </div>
                                        </div>
