				...
				<div class="tab tab-border">
					...
					<div class="tab-content">
						<div class="tab_custom_ecc tab-pane fade active show" id="content_<?php echo $methodid; ?>_header" role="tabpanel" aria-labelledby="tab_<?php echo $methodid; ?>_header">
							...
							<div class="row panel_<?php echo $methodid ?>_form_proforma">
							   <div class="col-xl-12 mb-10 ml-10">
									<form class="ui grid ecc_form" id="form_<?php echo $methodid ?>_proforma" action="javascript:post_<?php echo $methodid ?>_proforma()">
									   <?php 
											$this->ecc_library->form('hidden','',"form_".$methodid."_proforma",$this->security->get_csrf_token_name(),$this->security->get_csrf_hash());
											$this->ecc_library->form('text','',"form_".$methodid."_proforma",'purchase_order_id2','');
											$this->ecc_library->form('hidden','',"form_".$methodid."_proforma",'purchase_type_id','');
											$this->ecc_library->form('hidden','',"form_".$methodid."_proforma",'this_memo','');
										
										?>
										<div class="row">
											<div class="col-xl-4">
												<?php 
													$this->ecc_library->form('text','Purchase Order No_proforma',"form_".$methodid."_proforma",'purchase_order_no','','','');
													$this->ecc_library->form('date','Purchase Order Date',"form_".$methodid."_proforma",'purchase_order_date','','','');
													//$this->ecc_library->form('text','Payment Term',"form_".$methodid."_proforma",'payment_term','','','');
												?>
											</div>
											...
											<div class="col-xl-4">
												<div class="row">
													<div class="col-xl-12">
														<?php 
															$this->ecc_library->form('select','Supplier',"form_".$methodid."_proforma",'partner_id','','','supplier');
														?>
													</div>
													...
													<div class="col-xl-12">
														<div class="row">
															<div class="col-xl-6">
																<?php 
															   $this->ecc_library->form('select','Currencies',"form_".$methodid."_proforma",'currencies_id','','','currencies');
                                                            //  $this->ecc_library->form('text','PPN',"form_".$methodid."_proforma",'ppn','','','');																	
																?>
															</div>
															<div class="col-xl-6">
																<?php 
																    $this->ecc_library->form('select','Proforma Invoice',"form_".$methodid."_proforma",'sales_performa_id','','','performa_invoice');
																//	$this->ecc_library->form('readonly','Rate',"form_".$methodid."_proforma",'rate','','','');						
																?>
															</div>
														</div>
													</div>
											...
											<div class="col-xl-3">
												<?php 
													$this->ecc_library->form('select','Order Type',"form_".$methodid."_proforma",'purchase_order_type_id','','','purchase_order_type_purchase');						                          // 	$this->ecc_library->form('text','Memo',"form_".$methodid."_proforma",'purchase_order_memo','','','');						
												?>
											</div>
										</div>
									</form>
									<div class="ui grid form">
										<div class="row field">
											<div class="twelve wide column">
												<button type="button" class="btn btn-success" onclick="save_<?php echo $methodid ?>_proforma()">
													<i class="fa fa-save"></i> Save Header
												</button>
						...
						<div class="tab_custom_ecc tab-pane fade" id="content_<?php echo $methodid; ?>_detail" role="tabpanel" aria-labelledby="tab_<?php echo $methodid; ?>_detail">
												...
												<div class="row">
													<div class="col-xl-5">
														<?php
															...
															$this->ecc_library->form('select','Item Code Detail',"form_".$methodid."_detail",'item_id','','','item_detail');
														?>
													</div>
													...
													<div class="col-xl-3">
														<?php
													$this->ecc_library->form('readonly','Item Base',"form_".$methodid."_detail",'item_base','','','');		  ?>
													</div>
							...
							<div class="row panel_<?php echo $methodid ?>_proforma_invoice mb-10" >
							    <?php
								$this->ecc_library->form('text','',"form_".$methodid."_proforma",'performa_id','');
								$this->ecc_library->form('text','',"form_".$methodid."_proforma",'performa_detail_id','','','');
								//$this->ecc_library->form('text','',"form_".$methodid."_proforma",'purchase_order_id','');
							   ...
							   ?>
								...
								<div class="col-xl-12">
							  	  <?php 
										$extra_field = array();
										$extra_field[] = array('field' => 'sales_performa_id','form_id' => 'form_'. $methodid .'_proforma_performa_id');
										//$extra_field[] = array('field' => 'sales_performa_detail_id','form_id' => 'form_'. $methodid .'_proforma_performa_detail_id');
										//$extra_field[] = array('field' => 'purchase_order_id','form_id' => 'form_'. $methodid .'_purchase_order_id');
										$extra_param = array('methodid'=> $methodid,'beforeclick'=> 'beforeclick_'.$methodid."_proforma",'extra_param' => $extra_field);
										$this->ecc_library->jqgrid($methodid."_proforma", $dashboard_table['field_proforma'], $dashboard_table['field_proforma_loaddata'],$extra_param); 
									?>
								</div>
							</div> 
