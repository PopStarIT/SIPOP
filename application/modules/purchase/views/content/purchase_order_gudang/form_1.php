											  ...
											  <div class="row">
											   ...
											   <?php
											     $this->ecc_library->form('hidden','',"form_".$methodid."_detail",$this->security->get_csrf_token_name(),$this->security->get_csrf_hash());
											      // $this->ecc_library->form('readonly','',"form_".$methodid."_detail",'fabric_code_header','','','');
												 //$this->ecc_library->form('hidden','',"form_".$methodid."_detail",'fabric_code_header_id','','','');
												 ...
												 $this->ecc_library->form('hidden','',"form_".$methodid."_detail",'purchase_order_warehouse_detail_id','','','');
												    $this->ecc_library->form2('select_pop','Fabric code :',"form_".$methodid."_detail",'fabric_code_detail','','','get_list_item_central','6');
												?>
											   </div>
											      <div class="col-xl-12">
										      <div class="form-group row">
										      <div class="col-xl-12">
												  <div class="form-group row" id="form_new_fabric_detail">
												      <div class="col-xl-4"> 
												       <?php 
												        $this->ecc_library->form('text','Fabric Code Detail',"form_".$methodid."_detail",'fabric_code_input_detail','','','');	
                                                        ?>
												      </div>
													  
												      <div class="col-xl-4"> 
												       <?php 
												        $this->ecc_library->form('text','Description Detail',"form_".$methodid."_detail",'fabric_description_detail','','','');	
                                                        ?>
												      </div>
													  
													   <div class="col-xl-3"> 
												       <?php 
												        $this->ecc_library->form('text','Content Detail',"form_".$methodid."_detail",'fabric_content_detail','','','');	
														?>
												      </div>
													 </div>
					                              </div>
