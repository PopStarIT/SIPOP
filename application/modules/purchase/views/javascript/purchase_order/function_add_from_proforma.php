<script type="text/javascript">  
	function nav_button_<?php echo $function ?>(){
		...
		$('#form_<?php echo $methodid ?>_proforma_performa_id').val('');
		getnexttransno(2, 'form_<?php echo $methodid ?>_proforma_purchase_order_no');
	...
	//	$('.button_<?php echo $methodid ?>_detail_new').show();
		...
		$('.panel_<?php echo $methodid ?>_form_proforma').show();
		$('.panel_<?php echo $methodid ?>_panel_header').hide();
