...
Class Purchase_order extends CI_Controller { 
   ...
   { 
	...
	function index() {
		...
		$nav_button[] = array('method_id' => 781110,'title' => 'Add From Proforma Invoice', 'icon' => 'fa fa-plus', 'load' => 'purchase_order/function_add_from_proforma');
	...
	function delete()
   {
		...
		if(count($_POST) > 0){
			...
			$result = $this->rpc_service_->resultJSON();
			// print_r($result);
