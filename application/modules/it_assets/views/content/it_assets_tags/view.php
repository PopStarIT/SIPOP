                                ...
                                <div class="card">
                                    <div class="card-header" id="headingOne">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h5 class="mb-0">
                                                <?php echo 'Master IT Assets Tags' ?>
                                            </h5>

                                        </div>
                                    </div>

                                    <div class="container col-md-12" id="panel_content_<?php echo $methodid ?>">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <!-- Konten Div Kiri -->
                                                <div class="row">
                                                        ...
                                                        <div class="col-md-9 mb-3">
                                                            <div id="panel_content_<?php echo $methodid ?>">
                                                                ...
                                                                $extra_param = array(
                                                                    ...
                                                                    'extra_param' => array(
                                                                        0 => array(
                                                                            'field' => 'ini_assets_tags_id',
                                                                            'form_id' => 'form_' . $methodid . "_assets_tags_id" //ambil dariinputan yang di tuju pada form detail
                                                                        )
                                                                    )
                                                                );
                                                                $this->ecc_library->jqgrid($methodid . "_detail", $dashboard_table['field_detail'], $dashboard_table['field_loaddata_detail'], $extra_param);
                                                                ?>
