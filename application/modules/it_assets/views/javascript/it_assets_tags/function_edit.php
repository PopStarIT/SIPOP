<script type="text/javascript">
    function nav_button_<?php echo $function ?>() {
        ...
        if (id) {
            ...
            $('#form_<?php echo $methodid ?>_assets_tags_id').val(row.r1);
            $('#form_<?php echo $methodid ?>_assets_tags_name').val(row.r2);
            $('#form_<?php echo $methodid ?>_assets_tags_desc').val(row.r3);
