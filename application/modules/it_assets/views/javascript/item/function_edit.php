<script type="text/javascript">
    function nav_button_<?php echo $function ?>() {
        ...
        if (id) {
            ...
            $('.form_<?php echo $methodid ?>').html('Edit <?php echo $page_title ?>');

            // Mengisi form dengan data dari row
            ...
            $('#form_<?php echo $methodid ?>_barcode').val(row.r6);

            $('#form_<?php echo $methodid ?>_tipe').val(row.r7);
            $('#form_<?php echo $methodid ?>_spesifikasi_lain').val(row.r8);
