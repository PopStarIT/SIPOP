									...
									<form class="ui grid ecc_form" id="form_<?php echo $methodid ?>" action="javascript:post_<?php echo $methodid ?>()">
										...
										<div class="row">
											<div class="card-body">
												...
												<?php
												$this->ecc_library->form('text', 'category uraian', "form_" . $methodid, 'spec_category_uraian', '', '', '');
												$this->ecc_library->form('text', 'category note', "form_" . $methodid, 'spec_category_note', '', '', '');
