										...
										<div class="row">
											...
											<div class="col-xl-4">
												<div class="row">
													<div class="col-xl-8">
														<?php
														$this->ecc_library->form('select', 'Style', "form_" . $methodid, 'item_id', '', '', 'item_detail');
														?>
													</div>
									...
									<div class="row" style="margin-top:8px;">
										...
										<div class="row" style="margin-top:8px;">
											<div class="col-xl-12 grid_container_<?php echo $methodid ?>_detail_spec">
												<table id="table_<?php echo $methodid ?>_detail_spec" max-width="3000"></table>
									...
									<div class="row">
										<div class="col-xl-4">
											<div class="row">
												<div class="col-xl-12">
													...
													$this->ecc_library->form('hidden', '', "form_" . $methodid . "_trims", 'style_spec_trims_id', '', '', '');
													$this->ecc_library->form('text', 'Trims', "form_" . $methodid . "_trims", 'style_spec_trims_description', '', '', '');
													$this->ecc_library->form('hidden', '', "form_" . $methodid . "_trims", 'style_spec_trims_note', '', '', '');
												?>
												</div>
											</div>
										</div>
										...
										<div class="col-xl-3">
											...
											<div class="input-group">
												<div class="button_<?php echo $methodid ?>_trims_new" style="display:none">
						...
						<div class="row panel_<?php echo $methodid ?>_panel_dokumen">
							<div class="col-xl-12">
									...
									<div class="row">
										...
										<div class="col-xl-12">
										<form class="ui grid ecc_form" id="form_<?php echo $methodid ?>_picture_1" action="javascript:add_spec_<?php echo $methodid ?>_gbr_1()">
										 <div class="row">
										  <div class="col-xl-8">
										  <div class="row">
										  <?php
										        $this->ecc_library->form('hidden', '', "form_" . $methodid . "_picture_1", $this->security->get_csrf_token_name(), $this->security->get_csrf_hash());
												$this->ecc_library->form('hidden', '', "form_" . $methodid . "_picture_1", 'style_spec_header_id', '', '', '');
												$this->ecc_library->form('hidden', '', "form_" . $methodid . "_picture_1", 'style_spec_picture_1_id', '', '', '');
												$this->ecc_library->form('hidden', '', "form_" . $methodid . "_picture_1", 'style_spec_nomor', '', '', '');
												$this->ecc_library->form('hidden', '', "form_" . $methodid . "_picture_1", 'style_spec_picture_info', 'pic_1', '', '');
											?>
										    ...
										    <div class="col-xl-6">
										     <img src="<?php echo base_url('assets/img/pattern/contoh.png'); ?>" alt="" class="rouded-circle img-thumbnail mt-2 gbrphoto1"  id="gambar1" style="width: auto;height:350px;">
											</div>	
											<div class="col-xl-3">
												<?php
													$this->ecc_library->form('photo_trims_1', 'Picture 1', "form_" . $methodid, 'lokasi_1', '', '', '');
													?>
													<div class="button_<?php echo $methodid ?>_picture_new" >
													 <button type="submit" class="btn btn-success">
														<i class="fa fa-plus"></i> ADD
													 </button>
											        </div>	
									      ...
									      <div class="col-xl-6">
										   <form class="ui grid ecc_form" id="form_<?php echo $methodid ?>_picture_2" action="javascript:add_spec_<?php echo $methodid ?>_gbr_2()">
										  <div class="row">
										      <?php
										        $this->ecc_library->form('hidden', '', "form_" . $methodid . "_picture_2", $this->security->get_csrf_token_name(), $this->security->get_csrf_hash());
												//$this->ecc_library->form('text', '', "form_" . $methodid . "_picture_2", 'style_spec_header_id', '', '', '');
												$this->ecc_library->form('hidden', '', "form_" . $methodid . "_picture_2", 'style_spec_picture_2_id', '', '', '');
												//$this->ecc_library->form('hidden', '', "form_" . $methodid . "_picture_2", 'style_spec_nomor', '', '', '');
												$this->ecc_library->form('hidden', '', "form_" . $methodid . "_picture_2", 'style_spec_picture_info', 'pic_2', '', '');
											  ?>
										  
										 	<!--<img src="<?php //echo base_url('assets/img/profile/default.jpeg'); ?>" alt="" height="170px" width="150px" class="rouded-circle img-thumbnail mt-2 gbrphoto"  id="gambar"> -->
										    <div class="col-xl-8">
										     <img src="<?php echo base_url('assets/img/pattern/contoh.png'); ?>" alt="" class="rouded-circle img-thumbnail mt-2 gbrphoto2"  id="gambar2" style="width: auto;height:350px;">
											</div>	
											<div class="col-xl-4">
											        <?php
													$this->ecc_library->form('photo_trims_2', 'Picture 2', "form_" . $methodid, 'lokasi_2', '', '', '');
													?>
