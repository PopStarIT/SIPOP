<script type="text/javascript">
	function nav_button_<?php echo $function ?>() {
		...
		if (id) {
			...
			// alert(row.r2);
			$('#form_<?php echo $methodid ?>_spec_category_id').val(row.r1);
			$('#form_<?php echo $methodid ?>_spec_category_uraian').val(row.r2);
			$('#form_<?php echo $methodid ?>_spec_category_note').val(row.r2);
