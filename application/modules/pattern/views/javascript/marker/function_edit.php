<script type="text/javascript">
    function nav_button_<?php echo $function ?>() {
        ...
        if (id) {
            ...
            $('.form_title_<?php echo $methodid ?>').html('Checklist Pattern & Marker <?php echo $page_title ?>');
            // alert(row.r2);
            $('#form_<?php echo $methodid ?>_checklist_id').val(row.r1);
            $('#form_<?php echo $methodid ?>_list').val(row.r2);
