                                ...
                                <div class="col-xl-12 mb-10 ml-10">
                                    <form class="ui grid ecc_form" id="form_<?php echo $methodid ?>" action="javascript:post_<?php echo $methodid ?>()">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-4">
                                                <?php
                                                $this->ecc_library->form('text', 'process Code', "form_" . $methodid, 'process_code', '', 'required');
                                                $this->ecc_library->form('text', 'Process Name', "form_" . $methodid, 'process_name', '', 'required');
                                                $this->ecc_library->form('number', 'RFID No', "form_" . $methodid, 'rfid_no', '', 'required');
                                                $this->ecc_library->form('number', 'Target Process Time', "form_" . $methodid, 'target_process_time', '', 'required');
