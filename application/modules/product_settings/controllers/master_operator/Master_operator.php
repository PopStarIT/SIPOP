...
class Master_operator extends CI_Controller
{
    ...
    function index()
    {
        ...
        $component['view_load'] = 'master_operator/view';
        $component['view_load_form'] = 'master_operator/form';
        $component['view_load_form_upload'] = 'master_operator/form_upload_excel';
        $component['load_js'][] = 'master_operator/view';
        $component['load_js'][] = 'master_operator/form';
        //var_dump($component);die();
        $component['page_title'] = "Master Operator";

        $dashboard_table = array();

        $nav_button = array();
        $nav_button[] = array('method_id' => 781017, 'title' => 'Add', 'icon' => 'fa fa-plus', 'load' => 'master_operator/function_add');
        $nav_button[] = array('method_id' => 781018, 'title' => 'Edit', 'icon' => 'fa fa-pencil', 'load' => 'master_operator/function_edit');
        $nav_button[] = array('method_id' => 781019, 'title' => 'Delete', 'icon' => 'fa fa-trash-o', 'load' => 'master_operator/function_delete');
        // $nav_button[] = array('method_id' => 781074, 'title' => 'Upload Excel', 'icon' => 'fa fa-upload', 'load' => 'master_operator/function_upload');
