                                ...
                                <div class="col-xl-12 mb-10 ml-10">
                                    <form class="ui grid ecc_form" id="form_<?php echo $methodid ?>" action="javascript:post_<?php echo $methodid ?>()">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-4">
                                                <?php
                                                $this->ecc_library->form('text', 'Defect Cause', "form_" . $methodid, 'defect_cause', '', 'required');
                                                $this->ecc_library->form('text', 'Defect Cause Related', "form_" . $methodid, 'defect_cause_related', '', 'required');
                                                $this->ecc_library->form('text', 'Color', "form_" . $methodid, 'color', '', 'required');
                                                ?>
                                            </div>
                                        </div>
                                    </form>
