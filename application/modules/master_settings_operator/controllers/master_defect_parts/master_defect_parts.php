...
class Master_defect_parts extends CI_Controller
{
    ...
    function index()
    {
        ...
        $component['view_load'] = 'master_defect_parts/view';
        $component['view_load_form'] = 'master_defect_parts/form';
        $component['load_js'][] = 'master_defect_parts/view';
        $component['load_js'][] = 'master_defect_parts/form';

        $component['page_title'] = "Master Defect Parts";

        $dashboard_table = array();

        $nav_button = array();
        $nav_button[] = array('method_id' => 7811170, 'title' => 'Add', 'icon' => 'fa fa-plus', 'load' => 'master_defect_parts/function_add');
        $nav_button[] = array('method_id' => 7811171, 'title' => 'Edit', 'icon' => 'fa fa-pencil', 'load' => 'master_defect_parts/function_edit');

        $nav_button[] = array('method_id' => 7811172, 'title' => 'Delete', 'icon' => 'fa fa-trash-o', 'load' => 'master_defect_parts/function_delete');
