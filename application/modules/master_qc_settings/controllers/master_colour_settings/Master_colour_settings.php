...
class Master_colour_settings extends CI_Controller
{
    ...
    function index()
    {
        ...
        $component['view_load'] = 'master_colour_settings/view';
        $component['view_load_form'] = 'master_colour_settings/form';
        $component['load_js'][] = 'master_colour_settings/view';
        $component['load_js'][] = 'master_colour_settings/form';

        $component['page_title'] = "Master Colour Settings";

        $dashboard_table = array();

        $nav_button = array();
        $nav_button[] = array('method_id' => 7811170, 'title' => 'Add', 'icon' => 'fa fa-plus', 'load' => 'master_colour_settings/function_add');
        $nav_button[] = array('method_id' => 7811171, 'title' => 'Edit', 'icon' => 'fa fa-pencil', 'load' => 'master_colour_settings/function_edit');

        $nav_button[] = array('method_id' => 7811172, 'title' => 'Delete', 'icon' => 'fa fa-trash-o', 'load' => 'master_colour_settings/function_delete');
